...
VlCoroutine Vip1_tb_ip1_tb___eval_initial__TOP__ip1_tb__Vtiming__0(Vip1_tb_ip1_tb* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vip1_tb_ip1_tb___eval_initial__TOP__ip1_tb__Vtiming__0\n"); );
    ...
    while (true) {
        co_await vlSymsp->TOP.__VdlySched.delay(0x0000000000002710ULL, 
                                                nullptr, 
                                                "/home/eneadim/github/flexsoc/workspace/runs/ip1/dev/tb/ip1_tb.sv", 
                                                37);
...
VlCoroutine Vip1_tb_ip1_tb___eval_initial__TOP__ip1_tb__Vtiming__1(Vip1_tb_ip1_tb* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vip1_tb_ip1_tb___eval_initial__TOP__ip1_tb__Vtiming__1\n"); );
    Vip1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    VlClassRef<Vip1_tb___024unit__03a__03atlul_utils> __PVT__tl_utils_inst;
    ...
    vlSymsp->TOP.__Vm_traceActivity[6U] = 1U;
    VL_WRITEF_NX("\nRunning...\n\n",0);
    __PVT__tl_utils_inst = VL_NEW(Vip1_tb___024unit__03a__03atlul_utils, vlSymsp, (&vlSymsp->TOP__ip1_tb__tl_if));
    co_await vlSymsp->TOP.__VdlySched.delay(0x0000000000030d40ULL, 
                                            nullptr, 
                                            "/home/eneadim/github/flexsoc/workspace/runs/ip1/dev/tb/ip1_tb.sv", 
                                            68);
    vlSymsp->TOP.__Vm_traceActivity[6U] = 1U;
    co_await VL_NULL_CHECK(__PVT__tl_utils_inst, "/home/eneadim/github/flexsoc/workspace/runs/ip1/dev/tb/ip1_tb.sv", 69)->__VnoInFunc_tlul_write(vlSymsp, 0U, 1U, 0U);
    vlSymsp->TOP.__Vm_traceActivity[6U] = 1U;
    co_await vlSymsp->TOP.__VdlySched.delay(0x0000000000030d40ULL, 
                                            nullptr, 
                                            "/home/eneadim/github/flexsoc/workspace/runs/ip1/dev/tb/ip1_tb.sv", 
                                            70);
    vlSymsp->TOP.__Vm_traceActivity[6U] = 1U;
    co_await VL_NULL_CHECK(__PVT__tl_utils_inst, "/home/eneadim/github/flexsoc/workspace/runs/ip1/dev/tb/ip1_tb.sv", 71)->__VnoInFunc_tlul_read(vlSymsp, 0U, __Vtask_tlul_read__2__data, 0U);
    vlSymsp->TOP.__Vm_traceActivity[6U] = 1U;
    ...
    VL_WRITEF_NX("\nEnd.\n\n",0);
    VL_FINISH_MT("/home/eneadim/github/flexsoc/workspace/runs/ip1/dev/tb/ip1_tb.sv", 77, "");
    vlSymsp->TOP.__Vm_traceActivity[6U] = 1U;
}

void Vip1_tb_ip1_tb___ico_comb__TOP__ip1_tb__0(Vip1_tb_ip1_tb* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vip1_tb_ip1_tb___ico_comb__TOP__ip1_tb__0\n"); );
    Vip1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
void Vip1_tb_ip1_tb___act_sequent__TOP__ip1_tb__0(Vip1_tb_ip1_tb* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vip1_tb_ip1_tb___act_sequent__TOP__ip1_tb__0\n"); );
    Vip1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
void Vip1_tb_ip1_tb___nba_comb__TOP__ip1_tb__0(Vip1_tb_ip1_tb* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vip1_tb_ip1_tb___nba_comb__TOP__ip1_tb__0\n"); );
    Vip1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ __Vfunc_tl_a_user_chk__6__Vfuncout;
...
void Vip1_tb_ip1_tb___nba_sequent__TOP__ip1_tb__1(Vip1_tb_ip1_tb* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vip1_tb_ip1_tb___nba_sequent__TOP__ip1_tb__1\n"); );
    Vip1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__wdata_qe 
        = ((IData)(vlSelfRef.__PVT__rst_ni) && (IData)(vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_wdata0_qe__DOT__d_i));
    if (vlSelfRef.__PVT__rst_ni) {
        if (vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_wdata0_qe__DOT__d_i) {
            vlSelfRef.u_ip1__DOT__u_ip1_reg__DOT____Vcellout__u_wdata__q 
                = ((IData)(vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_wdata0_qe__DOT__d_i)
                    ? (vlSymsp->TOP__ip1_tb__tl_if.h2d[0U] 
                       >> 0x00000018U) : 0U);
        }
        if (vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_ctrl_en__DOT__we) {
            if (vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_ctrl_en__DOT__we) {
                vlSelfRef.u_ip1__DOT__u_ip1_reg__DOT____Vcellout__u_ctrl_en__q 
                    = (1U & (vlSymsp->TOP__ip1_tb__tl_if.h2d[0U] 
                             >> 0x00000018U));
                vlSelfRef.u_ip1__DOT__u_ip1_reg__DOT____Vcellout__u_ctrl_rst__q 
                    = (1U & (vlSymsp->TOP__ip1_tb__tl_if.h2d[0U] 
                             >> 0x00000019U));
                vlSelfRef.u_ip1__DOT__u_ip1_reg__DOT____Vcellout__u_ctrl_setting__q 
                    = (0x0000ffffU & (vlSymsp->TOP__ip1_tb__tl_if.h2d[1U] 
                                      >> 8U));
            } else {
                vlSelfRef.u_ip1__DOT__u_ip1_reg__DOT____Vcellout__u_ctrl_en__q = 0U;
                vlSelfRef.u_ip1__DOT__u_ip1_reg__DOT____Vcellout__u_ctrl_rst__q = 0U;
                vlSelfRef.u_ip1__DOT__u_ip1_reg__DOT____Vcellout__u_ctrl_setting__q = 0U;
            }
        }
        if (vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__a_ack) {
            vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__reqid_q 
                = (0x000000ffU & ((vlSymsp->TOP__ip1_tb__tl_if.h2d[3U] 
                                   << 4U) | (vlSymsp->TOP__ip1_tb__tl_if.h2d[2U] 
                                             >> 0x0000001cU)));
            vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__reqsz_q 
                = (3U & (vlSymsp->TOP__ip1_tb__tl_if.h2d[3U] 
                         >> 4U));
            vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__rspop_q 
                = ((IData)(vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__rd_req)
                    ? 1U : 0U);
            vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__error_q 
                = ((IData)(vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__error_i) 
                   | (IData)(vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__err_internal));
            vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__rdata_q 
                = ((((IData)(vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__error_i) 
                     | (IData)(vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__err_internal)) 
                    | (IData)(vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__wr_req))
                    ? 0xffffffffU : vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__reg_rdata_next);
            vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__outstanding_q = 1U;
        } else if (vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__d_ack) {
            vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__outstanding_q = 0U;
        }
    } else {
        vlSelfRef.u_ip1__DOT__u_ip1_reg__DOT____Vcellout__u_wdata__q = 0U;
        vlSelfRef.u_ip1__DOT__u_ip1_reg__DOT____Vcellout__u_ctrl_en__q = 0U;
        vlSelfRef.u_ip1__DOT__u_ip1_reg__DOT____Vcellout__u_ctrl_rst__q = 0U;
        vlSelfRef.u_ip1__DOT__u_ip1_reg__DOT____Vcellout__u_ctrl_setting__q = 0U;
        vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__reqid_q = 0U;
        vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__reqsz_q = 0U;
        vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__rspop_q = 0U;
        vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__error_q = 0U;
        vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__rdata_q = 0U;
        vlSelfRef.__PVT__u_ip1__DOT__u_ip1_reg__DOT__u_reg_if__DOT__outstanding_q = 0U;
    }
    vlSelfRef.__PVT__port_o = ((IData)(vlSelfRef.__PVT__rst_ni) 
                               && (IData)(vlSelfRef.__PVT__u_ip1__DOT__u_ip1_core__DOT__u_sync_name__DOT__intq));
    vlSelfRef.__PVT__u_ip1__DOT__u_ip1_core__DOT__u_sync_name__DOT__intq 
...
void Vip1_tb_ip1_tb___nba_comb__TOP__ip1_tb__1(Vip1_tb_ip1_tb* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vip1_tb_ip1_tb___nba_comb__TOP__ip1_tb__1\n"); );
    Vip1_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ u_ip1__DOT__u_ip1_reg__DOT____VdfgRegularize_h31005394_0_7;
