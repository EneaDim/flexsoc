`ifdef VERILATOR
// Auto-generated register helper for uart.
//
// Config format:
...
function automatic logic [32:0] tb_lookup_reg_addr(input string reg_key);
  ...
  case (reg_key)
    ...
    "clk_i.RDATA": begin addr = 32'h00000008; found = 1'b1; end
    "RDATA": begin addr = 32'h00000008; found = 1'b1; end
    "clk_i.WDATA": begin addr = 32'h0000000c; found = 1'b1; end
    "WDATA": begin addr = 32'h0000000c; found = 1'b1; end
    "clk_i.FIFO_CTRL": begin addr = 32'h00000010; found = 1'b1; end
    "FIFO_CTRL": begin addr = 32'h00000010; found = 1'b1; end
    "clk_i.FIFO_STATUS": begin addr = 32'h00000014; found = 1'b1; end
    "FIFO_STATUS": begin addr = 32'h00000014; found = 1'b1; end
    default: begin end
  endcase
...
task automatic tb_reg_write_addr(
  ...
  axi_lite_write(addr[uart_reg_pkg::AW-1:0], data, mask[uart_reg_pkg::DBW-1:0]);
...
task automatic tb_reg_read_addr(
  ...
  axi_lite_read(addr[uart_reg_pkg::AW-1:0], data);
