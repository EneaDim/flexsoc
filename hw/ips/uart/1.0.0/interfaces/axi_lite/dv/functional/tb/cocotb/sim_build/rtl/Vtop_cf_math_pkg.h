...
#ifndef VERILATED_VTOP_CF_MATH_PKG_H_
#define VERILATED_VTOP_CF_MATH_PKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtop_cf_math_pkg final {
  public:
    ...
    void dtor();
    VL_UNCOPYABLE(Vtop_cf_math_pkg);
