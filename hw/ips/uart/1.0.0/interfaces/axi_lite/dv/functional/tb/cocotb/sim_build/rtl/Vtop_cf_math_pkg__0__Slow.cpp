...
VL_ATTR_COLD void Vtop_cf_math_pkg___configure_coverage(Vtop_cf_math_pkg* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(vlSymsp->__Vcoverage + 8177, first, false, "/home/eneadim/github/flexsoc/vendor/pulp/common_cells/src/cf_math_pkg.sv", 43, 9, "", "v_line/cf_math_pkg", "block", "43-44", "", "", "", "");
}
