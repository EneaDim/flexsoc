...
Vtop_cf_math_pkg::Vtop_cf_math_pkg() = default;
Vtop_cf_math_pkg::~Vtop_cf_math_pkg() = default;

void Vtop_cf_math_pkg::ctor(Vtop__Syms* symsp, const char* namep) {
    vlSymsp = symsp;
    vlNamep = strdup(Verilated::catName(vlSymsp->name(), namep));
    // Reset structure values
}

void Vtop_cf_math_pkg___configure_coverage(Vtop_cf_math_pkg* vlSelf, bool first);

void Vtop_cf_math_pkg::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    Vtop_cf_math_pkg___configure_coverage(this, first);
}

void Vtop_cf_math_pkg::dtor() {
    VL_DO_DANGLING(std::free(const_cast<char*>(vlNamep)), vlNamep);
}

// Coverage
void Vtop_cf_math_pkg::__vlCoverInsert(uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
...
// Toggle Coverage
void Vtop_cf_math_pkg::__vlCoverToggleInsert(int begin, int end, bool ranged, uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
