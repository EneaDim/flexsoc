module uart (clk_i,
 ...
 sky130_fd_sc_hd__clkinv_1 _0984_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_2_),
    .Y(_0674_));
 sky130_fd_sc_hd__inv_4 _0985_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_0_),
    .Y(_0675_));
 sky130_fd_sc_hd__nand2_4 _0986_ (.A(_0675_),
    .B(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_1_),
    .Y(_0676_));
 sky130_fd_sc_hd__inv_1 _0987_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_1_),
    .Y(_0677_));
 sky130_fd_sc_hd__nor2_1 _0988_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_1_),
    .B(_0677_),
    .Y(_0678_));
 sky130_fd_sc_hd__inv_4 _0989_ (.A(net252),
    .Y(_0679_));
 sky130_fd_sc_hd__nor2_1 _0990_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_1_),
    .B(_0679_),
    .Y(_0680_));
 sky130_fd_sc_hd__nor2_1 _0991_ (.A(_0678_),
    .B(_0680_),
    .Y(_0681_));
 sky130_fd_sc_hd__inv_4 _0992_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_2_),
    .Y(_0682_));
 sky130_fd_sc_hd__nor2_1 _0993_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_2_),
    .B(_0682_),
    .Y(_0683_));
 sky130_fd_sc_hd__nor2_1 _0994_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_2_),
    .B(_0674_),
    .Y(_0684_));
 sky130_fd_sc_hd__nor2_1 _0995_ (.A(_0683_),
    .B(_0684_),
    .Y(_0685_));
 sky130_fd_sc_hd__inv_1 _0996_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_0_),
    .Y(_0686_));
 sky130_fd_sc_hd__nor2_1 _0997_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_0_),
    .B(net251),
    .Y(_0687_));
 sky130_fd_sc_hd__nor2_1 _0998_ (.A(net253),
    .B(_0675_),
    .Y(_0688_));
 ...
 sky130_fd_sc_hd__nand2_1 _1004_ (.A(_0691_),
    .B(_0693_),
    .Y(_0694_));
 sky130_fd_sc_hd__inv_1 _1005_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_under_rst),
    .Y(_0695_));
 sky130_fd_sc_hd__nand3_1 _1006_ (.A(_0694_),
    .B(reg2hw_4_),
    .C(_0695_),
    .Y(_0696_));
 sky130_fd_sc_hd__nor3_4 _1007_ (.A(_0674_),
    .B(_0676_),
    .C(_0696_),
    .Y(_0019_));
 ...
 sky130_fd_sc_hd__nor2_1 _1019_ (.A(reg2hw_46_),
    ...
    .Y(_0708_));
 sky130_fd_sc_hd__xor2_1 _1020_ (.A(reg2hw_45_),
 ...
 sky130_fd_sc_hd__nor2_1 _1026_ (.A(_0713_),
    .B(_0714_),
    .Y(_0715_));
 sky130_fd_sc_hd__nand2_1 _1027_ (.A(reg2hw_41_),
 ...
 sky130_fd_sc_hd__nor2_1 _1032_ (.A(_0712_),
    .B(_0720_),
    .Y(_0721_));
 sky130_fd_sc_hd__nor2_1 _1033_ (.A(_0711_),
    .B(_0721_),
    .Y(_0722_));
 sky130_fd_sc_hd__nor2_1 _1034_ (.A(_0710_),
    .B(_0722_),
    .Y(_0723_));
 sky130_fd_sc_hd__a21oi_1 _1035_ (.A1(reg2hw_45_),
 ...
 sky130_fd_sc_hd__nor2_1 _1042_ (.A(_0729_),
    .B(_0730_),
    .Y(_0731_));
 sky130_fd_sc_hd__xor2_1 _1043_ (.A(reg2hw_47_),
 ...
 sky130_fd_sc_hd__nand3_1 _1044_ (.A(_0728_),
    ...
    .C(_0732_),
    .Y(_0733_));
 sky130_fd_sc_hd__nand2_1 _1045_ (.A(reg2hw_47_),
    .B(u_uart_core_nco_sum_q_6_),
    .Y(_0734_));
 ...
 sky130_fd_sc_hd__o41ai_1 _1067_ (.A1(_0707_),
    ...
    .B1(_0754_),
    .Y(_0755_));
 sky130_fd_sc_hd__maj3_1 _1068_ (.A(reg2hw_53_),
    .B(_0755_),
 ...
 sky130_fd_sc_hd__inv_2 _1073_ (.A(_0759_),
    .Y(_0760_));
 sky130_fd_sc_hd__nor2_4 _1074_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_2_),
    .B(_0760_),
    .Y(_0022_));
 ...
 sky130_fd_sc_hd__xor2_1 _1077_ (.A(_0731_),
    .B(_0762_),
    .X(_0015_));
 sky130_fd_sc_hd__xor2_1 _1078_ (.A(reg2hw_41_),
    .B(u_uart_core_nco_sum_q_0_),
    .X(_0002_));
 sky130_fd_sc_hd__nor3_4 _1079_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_2_),
    .B(_0676_),
    .C(_0696_),
    .Y(_0023_));
 sky130_fd_sc_hd__clkinv_1 _1080_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_0_),
    .Y(_0763_));
 ...
 sky130_fd_sc_hd__inv_1 _1082_ (.A(u_uart_core_uart_rx_sreg_q_10_),
    .Y(_0765_));
 sky130_fd_sc_hd__xnor2_1 _1083_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_2_),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .Y(_0766_));
 sky130_fd_sc_hd__inv_1 _1084_ (.A(_0766_),
    .Y(_0767_));
 sky130_fd_sc_hd__xnor2_1 _1085_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_1_),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .Y(_0768_));
 sky130_fd_sc_hd__inv_1 _1086_ (.A(_0768_),
    .Y(_0769_));
 sky130_fd_sc_hd__inv_4 _1087_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_3_),
    .Y(_0770_));
 sky130_fd_sc_hd__nor2_1 _1088_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_3_),
    .B(_0770_),
    .Y(_0771_));
 sky130_fd_sc_hd__inv_4 _1089_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_3_),
    .Y(_0772_));
 sky130_fd_sc_hd__nor2_1 _1090_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_3_),
    .B(_0772_),
    .Y(_0773_));
 ...
 sky130_fd_sc_hd__inv_1 _1092_ (.A(_0774_),
    .Y(_0775_));
 sky130_fd_sc_hd__inv_1 _1093_ (.A(net254),
    .Y(_0776_));
 sky130_fd_sc_hd__nor2_1 _1094_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_0_),
    .B(net250),
    .Y(_0777_));
 sky130_fd_sc_hd__nor2_1 _1095_ (.A(net254),
    .B(_0763_),
    .Y(_0778_));
 ...
 sky130_fd_sc_hd__nor2_1 _1105_ (.A(_0765_),
    .B(_0787_),
    .Y(_0788_));
 sky130_fd_sc_hd__xnor2_1 _1106_ (.A(u_uart_core_uart_rx_sreg_q_2_),
    .B(u_uart_core_uart_rx_sreg_q_1_),
    .Y(_0789_));
 sky130_fd_sc_hd__xnor2_1 _1107_ (.A(reg2hw_40_),
    .B(u_uart_core_uart_rx_sreg_q_3_),
    .Y(_0790_));
 sky130_fd_sc_hd__xnor2_1 _1108_ (.A(_0789_),
    .B(_0790_),
    .Y(_0791_));
 sky130_fd_sc_hd__xor2_1 _1109_ (.A(u_uart_core_uart_rx_sreg_q_8_),
    .B(u_uart_core_uart_rx_sreg_q_9_),
    .X(_0792_));
 sky130_fd_sc_hd__xnor2_1 _1110_ (.A(u_uart_core_uart_rx_sreg_q_5_),
    .B(u_uart_core_uart_rx_sreg_q_4_),
    .Y(_0793_));
 sky130_fd_sc_hd__xor2_1 _1111_ (.A(u_uart_core_uart_rx_sreg_q_7_),
 ...
 sky130_fd_sc_hd__xor2_1 _1113_ (.A(_0792_),
    .B(_0795_),
    .X(_0796_));
 sky130_fd_sc_hd__inv_1 _1114_ (.A(reg2hw_39_),
    .Y(_0797_));
 ...
 sky130_fd_sc_hd__clkinv_1 _1118_ (.A(_0800_),
    .Y(_0801_));
 sky130_fd_sc_hd__inv_1 _1119_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_2_),
    .Y(_0802_));
 sky130_fd_sc_hd__nand3_1 _1120_ (.A(_0801_),
    .B(_0770_),
    .C(_0802_),
    .Y(_0803_));
 sky130_fd_sc_hd__nor2_4 _1121_ (.A(_0764_),
    .B(_0803_),
    .Y(_0033_));
 sky130_fd_sc_hd__nor3_4 _1122_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_2_),
    .B(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_1_),
    .C(_0758_),
    .Y(_0024_));
 sky130_fd_sc_hd__inv_1 _1123_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_1_),
    .Y(_0804_));
 sky130_fd_sc_hd__nand2_1 _1124_ (.A(_0804_),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_0_),
    .Y(_0805_));
 sky130_fd_sc_hd__nor2_4 _1125_ (.A(_0805_),
    .B(_0803_),
    .Y(_0034_));
 sky130_fd_sc_hd__clkinv_1 _1126_ (.A(_0696_),
    .Y(_0806_));
 sky130_fd_sc_hd__nand2_4 _1127_ (.A(_0806_),
    .B(_0675_),
    .Y(_0807_));
 sky130_fd_sc_hd__nor3_4 _1128_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_2_),
    .B(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_1_),
    .C(_0807_),
    .Y(_0025_));
 ...
 sky130_fd_sc_hd__nand3_1 _1134_ (.A(_0801_),
    ...
    .C(_0802_),
    .Y(_0812_));
 sky130_fd_sc_hd__nor2_4 _1135_ (.A(_0805_),
    .B(_0812_),
    .Y(_0026_));
 sky130_fd_sc_hd__nand3_1 _1136_ (.A(_0801_),
    ...
    .Y(_0813_));
 sky130_fd_sc_hd__nor2_4 _1137_ (.A(_0764_),
    .B(_0813_),
    .Y(_0036_));
 sky130_fd_sc_hd__nor2_4 _1138_ (.A(_0805_),
    .B(_0813_),
    .Y(_0037_));
 sky130_fd_sc_hd__nand2_1 _1139_ (.A(_0804_),
    .B(_0763_),
    .Y(_0814_));
 sky130_fd_sc_hd__nor2_4 _1140_ (.A(_0814_),
    .B(_0812_),
    .Y(_0027_));
 sky130_fd_sc_hd__nor2_4 _1141_ (.A(_0814_),
    .B(_0813_),
    .Y(_0038_));
 sky130_fd_sc_hd__nor2_4 _1142_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_3_),
    .B(_0811_),
    .Y(_0028_));
 ...
 sky130_fd_sc_hd__nand3_1 _1144_ (.A(_0801_),
    ...
    .C(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_2_),
    .Y(_0815_));
 sky130_fd_sc_hd__nor2_4 _1145_ (.A(_0764_),
    .B(_0815_),
    .Y(_0029_));
 sky130_fd_sc_hd__nor2_4 _1146_ (.A(_0764_),
    .B(_0812_),
    .Y(_0040_));
 sky130_fd_sc_hd__nor2_1 _1147_ (.A(_0706_),
    .B(_0737_),
    .Y(_0816_));
 sky130_fd_sc_hd__nor3_1 _1148_ (.A(_0705_),
    .B(_0704_),
    .C(_0738_),
    .Y(_0817_));
 sky130_fd_sc_hd__nor2_1 _1149_ (.A(_0816_),
    .B(_0817_),
    .Y(_0016_));
 sky130_fd_sc_hd__nor2_4 _1150_ (.A(_0805_),
    .B(_0815_),
    .Y(_0030_));
 sky130_fd_sc_hd__nor2_4 _1151_ (.A(_0814_),
    .B(_0803_),
    .Y(_0041_));
 sky130_fd_sc_hd__nor3_4 _1152_ (.A(_0674_),
    .B(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_1_),
    .C(_0807_),
    .Y(_0021_));
 sky130_fd_sc_hd__nor2_4 _1153_ (.A(_0814_),
    .B(_0815_),
    .Y(_0031_));
 sky130_fd_sc_hd__nor3_4 _1154_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_3_),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_2_),
    .C(_0809_),
    .Y(_0032_));
 sky130_fd_sc_hd__nor3_4 _1155_ (.A(_0674_),
    .B(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_1_),
    .C(_0758_),
    .Y(_0020_));
 sky130_fd_sc_hd__nor2_4 _1156_ (.A(_0674_),
    .B(_0760_),
    .Y(_0018_));
 ...
 sky130_fd_sc_hd__nor2_1 _1162_ (.A(reg2hw_55_),
    ...
    .Y(_0823_));
 sky130_fd_sc_hd__xor2_1 _1163_ (.A(reg2hw_53_),
    .B(u_uart_core_nco_sum_q_12_),
    .X(_0824_));
 sky130_fd_sc_hd__a21oi_1 _1164_ (.A1(reg2hw_53_),
 ...
 sky130_fd_sc_hd__a31oi_1 _1166_ (.A1(_0755_),
    ...
    .B1(_0826_),
    .Y(_0827_));
 sky130_fd_sc_hd__nor3_1 _1167_ (.A(_0822_),
    .B(_0823_),
    .C(_0827_),
    .Y(_0828_));
 sky130_fd_sc_hd__nor2_1 _1168_ (.A(_0822_),
    .B(_0828_),
    .Y(_0829_));
 ...
 sky130_fd_sc_hd__xnor2_1 _1171_ (.A(_0830_),
    .B(_0724_),
    .Y(_0013_));
 sky130_fd_sc_hd__o21a_1 _1172_ (.A1(_0822_),
    .A2(_0823_),
    .B1(_0827_),
    .X(_0831_));
 ...
 sky130_fd_sc_hd__a21oi_1 _1174_ (.A1(_0829_),
    ...
    .B1(_0818_),
    .Y(_0001_));
 sky130_fd_sc_hd__clkinv_1 _1175_ (.A(u_uart_core_uart_rx_sreg_q_8_),
    .Y(_0832_));
 sky130_fd_sc_hd__nand2_1 _1176_ (.A(reg2hw_39_),
    .B(u_uart_core_uart_rx_sreg_q_7_),
    .Y(_0833_));
 sky130_fd_sc_hd__o21ai_2 _1177_ (.A1(reg2hw_39_),
    .A2(_0832_),
    .B1(_0833_),
 ...
 sky130_fd_sc_hd__xnor2_1 _1180_ (.A(_0716_),
    .B(_0835_),
    .Y(_0009_));
 sky130_fd_sc_hd__clkinv_1 _1181_ (.A(u_uart_core_uart_rx_sreg_q_7_),
    .Y(_0836_));
 sky130_fd_sc_hd__nand2_1 _1182_ (.A(reg2hw_39_),
    .B(u_uart_core_uart_rx_sreg_q_6_),
    .Y(_0837_));
 sky130_fd_sc_hd__o21ai_2 _1183_ (.A1(reg2hw_39_),
    .A2(_0836_),
    .B1(_0837_),
    .Y(u_uart_core_rx_fifo_data_5_));
 sky130_fd_sc_hd__clkinv_1 _1184_ (.A(u_uart_core_uart_rx_sreg_q_6_),
    .Y(_0838_));
 sky130_fd_sc_hd__nand2_1 _1185_ (.A(reg2hw_39_),
    .B(u_uart_core_uart_rx_sreg_q_5_),
    .Y(_0839_));
 sky130_fd_sc_hd__o21ai_2 _1186_ (.A1(reg2hw_39_),
    .A2(_0838_),
    .B1(_0839_),
    .Y(u_uart_core_rx_fifo_data_4_));
 sky130_fd_sc_hd__clkinv_1 _1187_ (.A(u_uart_core_uart_rx_sreg_q_5_),
    .Y(_0840_));
 sky130_fd_sc_hd__nand2_1 _1188_ (.A(reg2hw_39_),
    .B(u_uart_core_uart_rx_sreg_q_4_),
    .Y(_0841_));
 sky130_fd_sc_hd__o21ai_2 _1189_ (.A1(reg2hw_39_),
    .A2(_0840_),
    .B1(_0841_),
    .Y(u_uart_core_rx_fifo_data_3_));
 sky130_fd_sc_hd__clkinv_1 _1190_ (.A(u_uart_core_uart_rx_sreg_q_4_),
    .Y(_0842_));
 sky130_fd_sc_hd__nand2_1 _1191_ (.A(reg2hw_39_),
    .B(u_uart_core_uart_rx_sreg_q_3_),
    .Y(_0843_));
 sky130_fd_sc_hd__o21ai_2 _1192_ (.A1(reg2hw_39_),
    .A2(_0842_),
    .B1(_0843_),
    .Y(u_uart_core_rx_fifo_data_2_));
 sky130_fd_sc_hd__clkinv_1 _1193_ (.A(u_uart_core_uart_rx_sreg_q_3_),
    .Y(_0844_));
 sky130_fd_sc_hd__nand2_1 _1194_ (.A(reg2hw_39_),
    .B(u_uart_core_uart_rx_sreg_q_2_),
    .Y(_0845_));
 sky130_fd_sc_hd__o21ai_2 _1195_ (.A1(reg2hw_39_),
    .A2(_0844_),
    .B1(_0845_),
    .Y(u_uart_core_rx_fifo_data_1_));
 sky130_fd_sc_hd__clkinv_1 _1196_ (.A(u_uart_core_uart_rx_sreg_q_2_),
    .Y(_0846_));
 sky130_fd_sc_hd__nand2_1 _1197_ (.A(reg2hw_39_),
    .B(u_uart_core_uart_rx_sreg_q_1_),
    .Y(_0847_));
 sky130_fd_sc_hd__o21ai_2 _1198_ (.A1(reg2hw_39_),
    .A2(_0846_),
    .B1(_0847_),
 ...
 sky130_fd_sc_hd__xor2_1 _1199_ (.A(_0824_),
    .B(_0755_),
    .X(_0005_));
 sky130_fd_sc_hd__clkinv_2 _1200_ (.A(net180),
    .Y(_0848_));
 sky130_fd_sc_hd__nand2_1 _1201_ (.A(_0848_),
    .B(net179),
    .Y(_0849_));
 sky130_fd_sc_hd__nor2_1 _1202_ (.A(net176),
    .B(net177),
    .Y(_0850_));
 sky130_fd_sc_hd__inv_1 _1203_ (.A(_0850_),
    .Y(_0851_));
 sky130_fd_sc_hd__clkinv_2 _1204_ (.A(net234),
    .Y(net189));
 sky130_fd_sc_hd__nand2_8 _1205_ (.A(net189),
    .B(net147),
    .Y(_0852_));
 sky130_fd_sc_hd__nor2_1 _1206_ (.A(net145),
    .B(_0852_),
    .Y(_0853_));
 sky130_fd_sc_hd__inv_1 _1207_ (.A(net146),
    .Y(_0854_));
 ...
 sky130_fd_sc_hd__nand2_1 _1210_ (.A(_0856_),
    .B(net178),
    .Y(_0857_));
 sky130_fd_sc_hd__nor2_2 _1211_ (.A(net178),
    .B(net179),
    .Y(_0858_));
 ...
 sky130_fd_sc_hd__inv_8 _1214_ (.A(_0860_),
    .Y(_0861_));
 sky130_fd_sc_hd__inv_1 _1215_ (.A(net178),
    .Y(_0862_));
 sky130_fd_sc_hd__nor3_2 _1216_ (.A(net179),
    .B(_0848_),
    .C(_0862_),
    .Y(_0863_));
 sky130_fd_sc_hd__nand3_1 _1217_ (.A(net174),
    .B(net173),
    .C(net172),
    .Y(_0864_));
 sky130_fd_sc_hd__nor2_1 _1218_ (.A(net175),
    .B(_0860_),
    .Y(_0865_));
 sky130_fd_sc_hd__o22ai_1 _1219_ (.A1(_0863_),
    ...
    .B2(_0865_),
    .Y(_0866_));
 sky130_fd_sc_hd__o31ai_1 _1220_ (.A1(net172),
    .A2(_0859_),
    .A3(_0861_),
    .B1(_0866_),
    .Y(_0867_));
 sky130_fd_sc_hd__nor3_2 _1221_ (.A(_0849_),
    .B(_0857_),
    .C(_0867_),
    .Y(_0868_));
 sky130_fd_sc_hd__inv_1 _1223_ (.A(net154),
    .Y(_0869_));
 sky130_fd_sc_hd__nor2_1 _1224_ (.A(reg2hw_11_),
    .B(net243),
    .Y(_0870_));
 sky130_fd_sc_hd__a21oi_1 _1225_ (.A1(_0869_),
    ...
    .B1(_0870_),
    .Y(_0042_));
 sky130_fd_sc_hd__inv_1 _1226_ (.A(net153),
    .Y(_0871_));
 sky130_fd_sc_hd__nor2_1 _1227_ (.A(reg2hw_10_),
    .B(net243),
    .Y(_0872_));
 sky130_fd_sc_hd__a21oi_1 _1228_ (.A1(_0871_),
    ...
    .B1(_0872_),
    .Y(_0043_));
 sky130_fd_sc_hd__inv_1 _1229_ (.A(net152),
    .Y(_0873_));
 sky130_fd_sc_hd__nor2_1 _1230_ (.A(reg2hw_9_),
    .B(net243),
    .Y(_0874_));
 sky130_fd_sc_hd__a21oi_1 _1231_ (.A1(_0873_),
    ...
    .B1(_0874_),
    .Y(_0044_));
 sky130_fd_sc_hd__mux2_1 _1232_ (.A0(reg2hw_8_),
    .A1(net151),
    .S(net243),
    .X(_0045_));
 sky130_fd_sc_hd__inv_1 _1233_ (.A(net150),
    .Y(_0875_));
 sky130_fd_sc_hd__nor2_1 _1234_ (.A(reg2hw_7_),
    .B(net243),
    .Y(_0876_));
 sky130_fd_sc_hd__a21oi_1 _1235_ (.A1(_0875_),
    ...
    .B1(_0876_),
    .Y(_0046_));
 sky130_fd_sc_hd__inv_1 _1236_ (.A(net149),
    .Y(_0877_));
 sky130_fd_sc_hd__nor2_1 _1237_ (.A(reg2hw_6_),
    .B(net243),
    .Y(_0878_));
 sky130_fd_sc_hd__a21oi_1 _1238_ (.A1(_0877_),
    ...
    .B1(_0878_),
    .Y(_0047_));
 sky130_fd_sc_hd__inv_1 _1239_ (.A(net148),
    .Y(_0879_));
 sky130_fd_sc_hd__nor2_1 _1240_ (.A(reg2hw_5_),
    .B(net243),
    .Y(_0880_));
 ...
 sky130_fd_sc_hd__nand2_1 _1243_ (.A(_0856_),
    .B(_0881_),
    .Y(_0882_));
 sky130_fd_sc_hd__mux2_1 _1245_ (.A0(net170),
    .A1(reg2hw_55_),
    .S(net246),
    .X(_0049_));
 sky130_fd_sc_hd__mux2_1 _1246_ (.A0(net169),
    .A1(reg2hw_54_),
    .S(net246),
    .X(_0050_));
 sky130_fd_sc_hd__mux2_1 _1247_ (.A0(net168),
    .A1(reg2hw_53_),
    .S(net246),
    .X(_0051_));
 sky130_fd_sc_hd__mux2_1 _1248_ (.A0(net167),
    ...
    .S(net246),
    .X(_0052_));
 sky130_fd_sc_hd__mux2_1 _1249_ (.A0(net166),
    .A1(reg2hw_51_),
    .S(net246),
    .X(_0053_));
 sky130_fd_sc_hd__mux2_1 _1250_ (.A0(net165),
    .A1(reg2hw_50_),
    .S(net246),
    .X(_0054_));
 sky130_fd_sc_hd__mux2_1 _1251_ (.A0(net164),
    .A1(reg2hw_49_),
    .S(net246),
    .X(_0055_));
 sky130_fd_sc_hd__mux2_1 _1252_ (.A0(net163),
    .A1(reg2hw_48_),
    .S(net246),
    .X(_0056_));
 sky130_fd_sc_hd__mux2_1 _1253_ (.A0(net162),
    .A1(reg2hw_47_),
    .S(net246),
    .X(_0057_));
 sky130_fd_sc_hd__mux2_1 _1254_ (.A0(net161),
    .A1(reg2hw_46_),
    .S(net246),
    .X(_0058_));
 sky130_fd_sc_hd__mux2_1 _1255_ (.A0(net160),
    .A1(reg2hw_45_),
    .S(net246),
    .X(_0059_));
 sky130_fd_sc_hd__mux2_1 _1256_ (.A0(net159),
    .A1(reg2hw_44_),
    .S(net246),
    .X(_0060_));
 sky130_fd_sc_hd__mux2_1 _1257_ (.A0(net158),
    .A1(reg2hw_43_),
    .S(net246),
    .X(_0061_));
 sky130_fd_sc_hd__mux2_1 _1258_ (.A0(net157),
    .A1(reg2hw_42_),
    .S(net246),
    .X(_0062_));
 sky130_fd_sc_hd__mux2_1 _1259_ (.A0(net156),
    .A1(reg2hw_41_),
    .S(net246),
    .X(_0063_));
 sky130_fd_sc_hd__inv_4 _1260_ (.A(_0852_),
    .Y(_0884_));
 sky130_fd_sc_hd__nand2_1 _1262_ (.A(_0884_),
    .B(net142),
    .Y(_0886_));
 ...
 sky130_fd_sc_hd__nand2_1 _1264_ (.A(_0886_),
    .B(_0887_),
    .Y(_0064_));
 sky130_fd_sc_hd__nand2_1 _1265_ (.A(_0884_),
    .B(net187),
    .Y(_0888_));
 ...
 sky130_fd_sc_hd__nand2_1 _1267_ (.A(_0888_),
    .B(_0889_),
    .Y(_0065_));
 sky130_fd_sc_hd__nand2_1 _1268_ (.A(_0884_),
    .B(net186),
    .Y(_0890_));
 ...
 sky130_fd_sc_hd__nand2_1 _1270_ (.A(_0890_),
    .B(_0891_),
    .Y(_0066_));
 sky130_fd_sc_hd__nand2_1 _1271_ (.A(_0884_),
    .B(net185),
    .Y(_0892_));
 ...
 sky130_fd_sc_hd__nand2_1 _1273_ (.A(_0892_),
    .B(_0893_),
    .Y(_0067_));
 sky130_fd_sc_hd__nand2_1 _1274_ (.A(_0884_),
    .B(net184),
    .Y(_0894_));
 ...
 sky130_fd_sc_hd__nand2_1 _1276_ (.A(_0894_),
    .B(_0895_),
    .Y(_0068_));
 sky130_fd_sc_hd__nand2_1 _1277_ (.A(_0884_),
    .B(net183),
    .Y(_0896_));
 ...
 sky130_fd_sc_hd__nand2_1 _1279_ (.A(_0896_),
    .B(_0897_),
    .Y(_0069_));
 sky130_fd_sc_hd__nand2_1 _1280_ (.A(_0884_),
    .B(net182),
    .Y(_0898_));
 ...
 sky130_fd_sc_hd__nand2_1 _1282_ (.A(_0898_),
    .B(_0899_),
    .Y(_0070_));
 sky130_fd_sc_hd__nand2_1 _1283_ (.A(_0884_),
    .B(net181),
    .Y(_0900_));
 ...
 sky130_fd_sc_hd__nand2_1 _1285_ (.A(_0900_),
    .B(_0901_),
    .Y(_0071_));
 sky130_fd_sc_hd__inv_1 _1286_ (.A(net179),
    .Y(_0902_));
 ...
 sky130_fd_sc_hd__inv_1 _1288_ (.A(_0855_),
    .Y(_0904_));
 sky130_fd_sc_hd__nor3_2 _1289_ (.A(_0852_),
    .B(_0903_),
    .C(_0904_),
    .Y(_0905_));
 sky130_fd_sc_hd__nand2_1 _1291_ (.A(_0861_),
    .B(reg2hw_55_),
    .Y(_0907_));
 sky130_fd_sc_hd__nor2_1 _1292_ (.A(net221),
    .B(_0884_),
    .Y(_0908_));
 sky130_fd_sc_hd__a21oi_1 _1293_ (.A1(net245),
    .A2(_0907_),
    .B1(_0908_),
    .Y(_0072_));
 sky130_fd_sc_hd__nand2_1 _1294_ (.A(_0861_),
    .B(reg2hw_54_),
    .Y(_0909_));
 sky130_fd_sc_hd__nor2_1 _1295_ (.A(net220),
    .B(_0884_),
    .Y(_0910_));
 sky130_fd_sc_hd__a21oi_1 _1296_ (.A1(net245),
    .A2(_0909_),
    .B1(_0910_),
    .Y(_0073_));
 sky130_fd_sc_hd__nand2_1 _1297_ (.A(_0861_),
    .B(reg2hw_53_),
    .Y(_0911_));
 sky130_fd_sc_hd__nor2_1 _1298_ (.A(net219),
    .B(_0884_),
    .Y(_0912_));
 sky130_fd_sc_hd__a21oi_1 _1299_ (.A1(net245),
    .A2(_0911_),
    .B1(_0912_),
    .Y(_0074_));
 sky130_fd_sc_hd__nand2_1 _1300_ (.A(_0861_),
    .B(reg2hw_52_),
    .Y(_0913_));
 sky130_fd_sc_hd__nor2_1 _1301_ (.A(net218),
    .B(_0884_),
    .Y(_0914_));
 sky130_fd_sc_hd__a21oi_1 _1302_ (.A1(net245),
    .A2(_0913_),
    .B1(_0914_),
    .Y(_0075_));
 sky130_fd_sc_hd__nand2_1 _1303_ (.A(_0861_),
    .B(reg2hw_51_),
    .Y(_0915_));
 sky130_fd_sc_hd__nor2_1 _1304_ (.A(net217),
    .B(_0884_),
    .Y(_0916_));
 sky130_fd_sc_hd__a21oi_1 _1305_ (.A1(net245),
    .A2(_0915_),
    .B1(_0916_),
    .Y(_0076_));
 sky130_fd_sc_hd__nand2_1 _1306_ (.A(_0861_),
    .B(reg2hw_50_),
    .Y(_0917_));
 sky130_fd_sc_hd__nor2_1 _1307_ (.A(net216),
    .B(_0884_),
    .Y(_0918_));
 sky130_fd_sc_hd__a21oi_1 _1308_ (.A1(net245),
    .A2(_0917_),
    .B1(_0918_),
    .Y(_0077_));
 sky130_fd_sc_hd__nand2_1 _1309_ (.A(_0861_),
    .B(reg2hw_49_),
    .Y(_0919_));
 sky130_fd_sc_hd__nor2_1 _1310_ (.A(net215),
    .B(_0884_),
    .Y(_0920_));
 sky130_fd_sc_hd__a21oi_1 _1311_ (.A1(net245),
    .A2(_0919_),
    .B1(_0920_),
    .Y(_0078_));
 sky130_fd_sc_hd__nand2_1 _1312_ (.A(_0861_),
    .B(reg2hw_48_),
    .Y(_0921_));
 sky130_fd_sc_hd__nor2_1 _1313_ (.A(net214),
    .B(_0884_),
    .Y(_0922_));
 sky130_fd_sc_hd__a21oi_1 _1314_ (.A1(net245),
    .A2(_0921_),
    .B1(_0922_),
    .Y(_0079_));
 sky130_fd_sc_hd__nand2_1 _1315_ (.A(_0861_),
    .B(reg2hw_47_),
    .Y(_0923_));
 sky130_fd_sc_hd__nor2_1 _1316_ (.A(net213),
    .B(_0884_),
    .Y(_0924_));
 sky130_fd_sc_hd__a21oi_1 _1317_ (.A1(net245),
    .A2(_0923_),
    .B1(_0924_),
    .Y(_0080_));
 sky130_fd_sc_hd__nand2_1 _1318_ (.A(_0861_),
    .B(reg2hw_46_),
    .Y(_0925_));
 sky130_fd_sc_hd__nor2_1 _1319_ (.A(net212),
    .B(_0884_),
    .Y(_0926_));
 sky130_fd_sc_hd__a21oi_1 _1320_ (.A1(net245),
    .A2(_0925_),
    .B1(_0926_),
    .Y(_0081_));
 sky130_fd_sc_hd__clkinv_4 _1321_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .Y(_0927_));
 sky130_fd_sc_hd__inv_6 _1322_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .Y(_0928_));
 sky130_fd_sc_hd__nor2_1 _1323_ (.A(_0777_),
    .B(_0769_),
    .Y(_0929_));
 sky130_fd_sc_hd__a21oi_1 _1324_ (.A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_1_),
    .A2(_0928_),
    .B1(_0929_),
    .Y(_0930_));
 sky130_fd_sc_hd__nor2_1 _1325_ (.A(_0767_),
    .B(_0930_),
    .Y(_0931_));
 sky130_fd_sc_hd__a21oi_1 _1326_ (.A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_2_),
    .A2(_0927_),
    .B1(_0931_),
    .Y(_0932_));
 ...
 sky130_fd_sc_hd__o21ai_0 _1332_ (.A1(_0783_),
    ...
    .B1(_0937_),
    .Y(_0938_));
 sky130_fd_sc_hd__clkinv_2 _1333_ (.A(net245),
    .Y(_0939_));
 sky130_fd_sc_hd__a21oi_1 _1334_ (.A1(reg2hw_45_),
    .A2(_0861_),
    .B1(_0939_),
    .Y(_0940_));
 sky130_fd_sc_hd__nor2_1 _1335_ (.A(net211),
    .B(_0884_),
    .Y(_0941_));
 ...
 sky130_fd_sc_hd__nand2_1 _1337_ (.A(_0861_),
    .B(reg2hw_44_),
    .Y(_0942_));
 sky130_fd_sc_hd__nand2_1 _1338_ (.A(net245),
    .B(_0942_),
    .Y(_0943_));
 ...
 sky130_fd_sc_hd__a21oi_1 _1341_ (.A1(_0775_),
    ...
    .B1(_0945_),
    .Y(_0946_));
 sky130_fd_sc_hd__o22a_1 _1342_ (.A1(net210),
    .A2(_0884_),
    .B1(_0943_),
    .B2(_0946_),
    .X(_0083_));
 ...
 sky130_fd_sc_hd__a21oi_1 _1345_ (.A1(reg2hw_43_),
    ...
    .B1(_0939_),
    .Y(_0949_));
 sky130_fd_sc_hd__nor2_1 _1346_ (.A(net209),
    .B(_0884_),
    .Y(_0950_));
 ...
 sky130_fd_sc_hd__a21oi_1 _1350_ (.A1(reg2hw_42_),
    ...
    .B1(_0939_),
    .Y(_0953_));
 sky130_fd_sc_hd__nor2_1 _1351_ (.A(net208),
    .B(_0884_),
    .Y(_0954_));
 ...
 sky130_fd_sc_hd__nand2_1 _1354_ (.A(_0861_),
    .B(reg2hw_41_),
    .Y(_0956_));
 sky130_fd_sc_hd__nor2_1 _1355_ (.A(net207),
    .B(_0884_),
    .Y(_0957_));
 sky130_fd_sc_hd__a31oi_1 _1356_ (.A1(net245),
    .A2(_0955_),
    .A3(_0956_),
    .B1(_0957_),
    .Y(_0086_));
 sky130_fd_sc_hd__nor2_1 _1357_ (.A(net206),
    .B(_0884_),
    .Y(_0958_));
 sky130_fd_sc_hd__nor2_1 _1358_ (.A(_0958_),
    .B(net245),
    .Y(_0087_));
 sky130_fd_sc_hd__nor2_1 _1359_ (.A(net205),
    .B(_0884_),
    .Y(_0959_));
 sky130_fd_sc_hd__nor2_1 _1360_ (.A(_0959_),
    .B(net245),
    .Y(_0088_));
 sky130_fd_sc_hd__nor2_1 _1361_ (.A(net204),
    .B(_0884_),
    .Y(_0960_));
 sky130_fd_sc_hd__nor2_1 _1362_ (.A(_0960_),
    .B(net245),
    .Y(_0089_));
 sky130_fd_sc_hd__nor2_1 _1363_ (.A(net203),
    .B(_0884_),
    .Y(_0961_));
 sky130_fd_sc_hd__nor2_1 _1364_ (.A(_0961_),
    .B(net245),
    .Y(_0090_));
 sky130_fd_sc_hd__nor2_1 _1365_ (.A(net202),
    .B(_0884_),
    .Y(_0962_));
 sky130_fd_sc_hd__nor2_1 _1366_ (.A(_0962_),
    .B(net245),
    .Y(_0091_));
 sky130_fd_sc_hd__nor2_1 _1367_ (.A(net201),
    .B(_0884_),
    .Y(_0963_));
 sky130_fd_sc_hd__nor2_1 _1368_ (.A(_0963_),
    .B(net245),
    .Y(_0092_));
 sky130_fd_sc_hd__nor2_1 _1369_ (.A(net200),
    .B(_0884_),
    .Y(_0964_));
 sky130_fd_sc_hd__nor2_1 _1370_ (.A(_0964_),
    .B(net245),
    .Y(_0093_));
 sky130_fd_sc_hd__nor2_1 _1371_ (.A(net199),
    .B(_0884_),
    .Y(_0965_));
 ...
 sky130_fd_sc_hd__a211oi_1 _1373_ (.A1(_0781_),
    ...
    .C1(_0849_),
    .Y(_0966_));
 sky130_fd_sc_hd__o21ai_0 _1374_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1377_ (.A(_0967_),
    .B(_0969_),
    .Y(_0970_));
 sky130_fd_sc_hd__nor2_2 _1378_ (.A(net254),
    .B(_0928_),
    .Y(_0971_));
 sky130_fd_sc_hd__nor2_2 _1380_ (.A(_0928_),
    .B(net249),
    .Y(_0973_));
 sky130_fd_sc_hd__a22o_1 _1381_ (.A1(net248),
 ...
 sky130_fd_sc_hd__o21ai_0 _1382_ (.A1(_0970_),
    ...
    .B1(_0927_),
    .Y(_0975_));
 sky130_fd_sc_hd__nand2_1 _1383_ (.A(net250),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_39_),
    .Y(_0976_));
 sky130_fd_sc_hd__nand2_1 _1384_ (.A(net254),
 ...
 sky130_fd_sc_hd__a21oi_1 _1385_ (.A1(_0976_),
    ...
    .Y(_0978_));
 sky130_fd_sc_hd__a22o_1 _1386_ (.A1(net248),
 ...
 sky130_fd_sc_hd__nand3_1 _1388_ (.A(_0975_),
    ...
    .C(_0772_),
    .Y(_0177_));
 sky130_fd_sc_hd__o21ai_0 _1389_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1391_ (.A(_0178_),
    .B(_0179_),
    .Y(_0180_));
 sky130_fd_sc_hd__nand2_1 _1392_ (.A(net248),
 ...
 sky130_fd_sc_hd__inv_1 _1394_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_95_),
    .Y(_0183_));
 sky130_fd_sc_hd__inv_2 _1395_ (.A(net247),
    .Y(_0184_));
 sky130_fd_sc_hd__nor2_1 _1396_ (.A(_0183_),
    .B(_0184_),
    .Y(_0185_));
 sky130_fd_sc_hd__o21ai_0 _1397_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1399_ (.A(_0186_),
    .B(_0187_),
    .Y(_0188_));
 sky130_fd_sc_hd__a22oi_1 _1400_ (.A1(net248),
 ...
 sky130_fd_sc_hd__nand2_1 _1403_ (.A(_0191_),
    ...
    .Y(_0192_));
 sky130_fd_sc_hd__nand3_1 _1404_ (.A(net244),
    .B(_0177_),
    .C(_0192_),
    .Y(_0193_));
 sky130_fd_sc_hd__a21oi_1 _1405_ (.A1(reg2hw_40_),
    .A2(_0861_),
    .B1(_0939_),
    .Y(_0194_));
 sky130_fd_sc_hd__nor2_1 _1406_ (.A(net198),
    .B(_0884_),
    .Y(_0195_));
 sky130_fd_sc_hd__a21oi_1 _1407_ (.A1(_0193_),
    ...
    .B1(_0195_),
    .Y(_0095_));
 sky130_fd_sc_hd__nand2_1 _1408_ (.A(net250),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_38_),
    .Y(_0196_));
 sky130_fd_sc_hd__nand2_1 _1409_ (.A(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1412_ (.A(_0927_),
    .B(_0199_),
    .Y(_0200_));
 sky130_fd_sc_hd__o21ai_0 _1413_ (.A1(net254),
 ...
 sky130_fd_sc_hd__a221oi_1 _1416_ (.A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_22_),
    ...
    .C1(_0203_),
    .Y(_0204_));
 sky130_fd_sc_hd__o21ai_0 _1417_ (.A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .A2(_0204_),
    .B1(_0772_),
    .Y(_0205_));
 sky130_fd_sc_hd__o21ai_0 _1418_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1420_ (.A(_0206_),
    .B(_0207_),
    .Y(_0208_));
 sky130_fd_sc_hd__a22o_1 _1421_ (.A1(net248),
 ...
 sky130_fd_sc_hd__o21ai_0 _1422_ (.A1(_0208_),
    ...
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .Y(_0210_));
 sky130_fd_sc_hd__nand2_1 _1423_ (.A(net249),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_70_),
    .Y(_0211_));
 sky130_fd_sc_hd__nand2_1 _1424_ (.A(net254),
 ...
 sky130_fd_sc_hd__a21oi_1 _1425_ (.A1(_0211_),
    ...
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .Y(_0213_));
 sky130_fd_sc_hd__a22o_1 _1426_ (.A1(net248),
 ...
 sky130_fd_sc_hd__o211ai_1 _1429_ (.A1(_0200_),
    ...
    .C1(net244),
    .Y(_0217_));
 sky130_fd_sc_hd__a21oi_1 _1430_ (.A1(reg2hw_39_),
    .A2(_0861_),
    .B1(_0939_),
    .Y(_0218_));
 sky130_fd_sc_hd__nor2_1 _1431_ (.A(net197),
    .B(_0884_),
    .Y(_0219_));
 sky130_fd_sc_hd__a21oi_1 _1432_ (.A1(_0217_),
    ...
    .B1(_0219_),
    .Y(_0096_));
 sky130_fd_sc_hd__o21ai_0 _1433_ (.A1(net254),
 ...
 sky130_fd_sc_hd__a221oi_1 _1436_ (.A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_21_),
    ...
    .C1(_0222_),
    .Y(_0223_));
 sky130_fd_sc_hd__nor2_1 _1437_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .B(_0223_),
    .Y(_0224_));
 sky130_fd_sc_hd__o21ai_0 _1438_ (.A1(net254),
 ...
 sky130_fd_sc_hd__o21ai_0 _1442_ (.A1(_0927_),
    ...
    .B1(_0772_),
    .Y(_0229_));
 sky130_fd_sc_hd__o21ai_0 _1443_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1445_ (.A(_0230_),
    .B(_0231_),
    .Y(_0232_));
 sky130_fd_sc_hd__nand2_1 _1446_ (.A(net248),
 ...
 sky130_fd_sc_hd__nor2_1 _1449_ (.A(_0235_),
    .B(_0184_),
    .Y(_0236_));
 sky130_fd_sc_hd__o21ai_0 _1450_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1452_ (.A(_0237_),
    .B(_0238_),
    .Y(_0239_));
 sky130_fd_sc_hd__a22oi_1 _1453_ (.A1(net248),
 ...
 sky130_fd_sc_hd__nand2_1 _1460_ (.A(_0245_),
    .B(_0246_),
    .Y(_0247_));
 sky130_fd_sc_hd__nor3_1 _1461_ (.A(net180),
    .B(net179),
    .C(_0862_),
    .Y(_0248_));
 sky130_fd_sc_hd__a22oi_1 _1462_ (.A1(reg2hw_38_),
    .A2(_0861_),
    .B1(_0247_),
    .B2(_0248_),
    .Y(_0249_));
 sky130_fd_sc_hd__nor2_1 _1463_ (.A(net196),
    .B(_0884_),
    .Y(_0250_));
 sky130_fd_sc_hd__a31oi_1 _1464_ (.A1(_0244_),
    ...
    .B1(_0250_),
    .Y(_0097_));
 sky130_fd_sc_hd__o21ai_0 _1465_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1467_ (.A(_0251_),
    .B(_0252_),
    .Y(_0253_));
 sky130_fd_sc_hd__a22o_1 _1468_ (.A1(net248),
 ...
 sky130_fd_sc_hd__o21ai_0 _1469_ (.A1(_0253_),
    ...
    .B1(_0927_),
    .Y(_0255_));
 sky130_fd_sc_hd__nand2_1 _1470_ (.A(net250),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_36_),
    .Y(_0256_));
 sky130_fd_sc_hd__nand2_1 _1471_ (.A(net254),
 ...
 sky130_fd_sc_hd__a21oi_1 _1472_ (.A1(_0256_),
    ...
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .Y(_0258_));
 sky130_fd_sc_hd__a22o_1 _1473_ (.A1(net248),
 ...
 sky130_fd_sc_hd__nand3_1 _1475_ (.A(_0255_),
    ...
    .C(_0772_),
    .Y(_0261_));
 sky130_fd_sc_hd__o21ai_0 _1476_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1478_ (.A(_0262_),
    .B(_0263_),
    .Y(_0264_));
 sky130_fd_sc_hd__a22o_1 _1479_ (.A1(net248),
 ...
 sky130_fd_sc_hd__o21ai_0 _1480_ (.A1(_0264_),
    ...
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .Y(_0266_));
 sky130_fd_sc_hd__nand2_1 _1481_ (.A(net249),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_68_),
    .Y(_0267_));
 sky130_fd_sc_hd__nand2_1 _1482_ (.A(net254),
 ...
 sky130_fd_sc_hd__a21oi_1 _1483_ (.A1(_0267_),
    ...
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .Y(_0269_));
 sky130_fd_sc_hd__a22o_1 _1484_ (.A1(net248),
 ...
 sky130_fd_sc_hd__nand3_1 _1486_ (.A(_0266_),
    ...
    .C(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_3_),
    .Y(_0272_));
 sky130_fd_sc_hd__nand3_1 _1487_ (.A(net244),
    .B(_0261_),
    .C(_0272_),
    .Y(_0273_));
 sky130_fd_sc_hd__a22oi_1 _1488_ (.A1(hw2reg_28_),
    .A2(_0248_),
    .B1(_0861_),
    .B2(reg2hw_37_),
    .Y(_0274_));
 sky130_fd_sc_hd__nor2_1 _1489_ (.A(net195),
    .B(_0884_),
    .Y(_0275_));
 ...
 sky130_fd_sc_hd__o31ai_1 _1496_ (.A1(_0691_),
    ...
    .B1(_0280_),
    .Y(_0281_));
 sky130_fd_sc_hd__o21ai_0 _1497_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1499_ (.A(_0282_),
    .B(_0283_),
    .Y(_0284_));
 sky130_fd_sc_hd__a22o_1 _1500_ (.A1(net248),
 ...
 sky130_fd_sc_hd__o21ai_0 _1501_ (.A1(_0284_),
    ...
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .Y(_0286_));
 sky130_fd_sc_hd__nand2_1 _1502_ (.A(net250),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_3_),
    .Y(_0287_));
 sky130_fd_sc_hd__nand2_1 _1503_ (.A(net254),
 ...
 sky130_fd_sc_hd__a21oi_1 _1504_ (.A1(_0287_),
    ...
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .Y(_0289_));
 sky130_fd_sc_hd__a22o_1 _1505_ (.A1(net248),
 ...
 sky130_fd_sc_hd__nand3_1 _1507_ (.A(_0286_),
    ...
    .C(_0772_),
    .Y(_0292_));
 sky130_fd_sc_hd__o21ai_0 _1508_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1510_ (.A(_0293_),
    .B(_0294_),
    .Y(_0295_));
 sky130_fd_sc_hd__a22o_1 _1511_ (.A1(_0971_),
 ...
 sky130_fd_sc_hd__o21ai_0 _1512_ (.A1(_0295_),
    ...
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .Y(_0297_));
 sky130_fd_sc_hd__nand2_1 _1513_ (.A(net249),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_67_),
    .Y(_0298_));
 sky130_fd_sc_hd__nand2_1 _1514_ (.A(net254),
 ...
 sky130_fd_sc_hd__a21oi_1 _1515_ (.A1(_0298_),
    ...
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .Y(_0300_));
 sky130_fd_sc_hd__a22o_1 _1516_ (.A1(_0971_),
 ...
 sky130_fd_sc_hd__nand3_1 _1518_ (.A(_0297_),
    ...
    .C(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_3_),
    .Y(_0303_));
 sky130_fd_sc_hd__nand3_1 _1519_ (.A(net244),
    .B(_0292_),
    .C(_0303_),
    .Y(_0304_));
 ...
 sky130_fd_sc_hd__a21oi_1 _1523_ (.A1(_0306_),
    ...
    .B1(_0307_),
    .Y(_0308_));
 sky130_fd_sc_hd__lpflow_clkinvkapwr_1 _1524_ (.A(reg2hw_34_),
    .Y(_0309_));
 ...
 sky130_fd_sc_hd__nor2_1 _1528_ (.A(u_uart_core_uart_tx_bit_cnt_q_3_),
    .B(_0312_),
    .Y(_0313_));
 sky130_fd_sc_hd__nor2_2 _1529_ (.A(_0309_),
    .B(_0313_),
    .Y(_0314_));
 sky130_fd_sc_hd__nand2_1 _1530_ (.A(net245),
    .B(_0314_),
    .Y(_0315_));
 sky130_fd_sc_hd__o21ai_0 _1531_ (.A1(_0939_),
    ...
    .B1(_0315_),
    .Y(_0316_));
 sky130_fd_sc_hd__nor2_1 _1532_ (.A(net193),
    .B(_0884_),
    .Y(_0317_));
 ...
 sky130_fd_sc_hd__nand2_1 _1536_ (.A(_0319_),
    .B(_0863_),
    .Y(_0320_));
 sky130_fd_sc_hd__nor2_1 _1537_ (.A(net254),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_2_),
    .Y(_0321_));
 sky130_fd_sc_hd__nor2_1 _1538_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .B(_0321_),
    .Y(_0322_));
 sky130_fd_sc_hd__o21ai_0 _1539_ (.A1(net250),
    .A2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_10_),
    .B1(_0322_),
    .Y(_0323_));
 sky130_fd_sc_hd__nand2_1 _1540_ (.A(net248),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_18_),
    .Y(_0324_));
 sky130_fd_sc_hd__a21oi_1 _1541_ (.A1(net247),
    .A2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_26_),
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .Y(_0325_));
 sky130_fd_sc_hd__a221oi_1 _1542_ (.A1(net248),
    .A2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_50_),
    .B1(net247),
    .B2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_58_),
    .C1(_0927_),
    .Y(_0326_));
 sky130_fd_sc_hd__nor2_1 _1543_ (.A(net254),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_34_),
    .Y(_0327_));
 sky130_fd_sc_hd__nor2_1 _1544_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .B(_0327_),
    .Y(_0328_));
 sky130_fd_sc_hd__o21ai_0 _1545_ (.A1(net250),
 ...
 sky130_fd_sc_hd__a32oi_1 _1546_ (.A1(_0323_),
    ...
    .B2(_0329_),
    .Y(_0330_));
 sky130_fd_sc_hd__o21ai_0 _1547_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1549_ (.A(_0331_),
    .B(_0332_),
    .Y(_0333_));
 sky130_fd_sc_hd__nand2_1 _1550_ (.A(_0971_),
 ...
 sky130_fd_sc_hd__nor2_1 _1553_ (.A(_0336_),
    .B(_0184_),
    .Y(_0337_));
 sky130_fd_sc_hd__o21ai_0 _1554_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1556_ (.A(_0338_),
    .B(_0339_),
    .Y(_0340_));
 sky130_fd_sc_hd__a22oi_1 _1557_ (.A1(_0971_),
 ...
 sky130_fd_sc_hd__nand2_1 _1560_ (.A(_0343_),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_3_),
    .Y(_0344_));
 sky130_fd_sc_hd__o211ai_1 _1561_ (.A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_3_),
    .A2(_0330_),
    .B1(_0344_),
    .C1(net244),
    .Y(_0345_));
 sky130_fd_sc_hd__a211oi_1 _1562_ (.A1(reg2hw_36_),
    ...
    .C1(_0308_),
    .Y(_0346_));
 sky130_fd_sc_hd__nor2_1 _1563_ (.A(net192),
    .B(_0884_),
    .Y(_0347_));
 ...
 sky130_fd_sc_hd__a221oi_1 _1568_ (.A1(reg2hw_35_),
    ...
    .C1(_0350_),
    .Y(_0351_));
 sky130_fd_sc_hd__nor2_1 _1569_ (.A(net254),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_65_),
    .Y(_0352_));
 sky130_fd_sc_hd__nor2_1 _1570_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .B(_0352_),
    .Y(_0353_));
 sky130_fd_sc_hd__o21ai_0 _1571_ (.A1(net249),
    .A2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_73_),
    .B1(_0353_),
    .Y(_0354_));
 sky130_fd_sc_hd__nand2_1 _1572_ (.A(net247),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_89_),
    .Y(_0355_));
 sky130_fd_sc_hd__a21oi_1 _1573_ (.A1(net248),
    .A2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_81_),
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .Y(_0356_));
 sky130_fd_sc_hd__a221oi_1 _1574_ (.A1(net248),
    .A2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_113_),
    .B1(net247),
    .B2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_121_),
    .C1(_0927_),
    .Y(_0357_));
 sky130_fd_sc_hd__nor2_1 _1575_ (.A(net254),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_97_),
    .Y(_0358_));
 sky130_fd_sc_hd__nor2_1 _1576_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .B(_0358_),
    .Y(_0359_));
 sky130_fd_sc_hd__o21ai_0 _1577_ (.A1(net249),
 ...
 sky130_fd_sc_hd__a32oi_1 _1578_ (.A1(_0354_),
    ...
    .B2(_0360_),
    .Y(_0361_));
 sky130_fd_sc_hd__o21ai_0 _1579_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1581_ (.A(_0362_),
    .B(_0363_),
    .Y(_0364_));
 sky130_fd_sc_hd__nand2_1 _1582_ (.A(net248),
 ...
 sky130_fd_sc_hd__nor2_1 _1585_ (.A(_0367_),
    .B(_0184_),
    .Y(_0368_));
 sky130_fd_sc_hd__o21ai_0 _1586_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1588_ (.A(_0369_),
    .B(_0370_),
    .Y(_0371_));
 sky130_fd_sc_hd__a22oi_1 _1589_ (.A1(net248),
 ...
 sky130_fd_sc_hd__o211ai_1 _1593_ (.A1(_0772_),
    ...
    .C1(net244),
    .Y(_0376_));
 sky130_fd_sc_hd__nor2_1 _1594_ (.A(net191),
    .B(_0884_),
    .Y(_0377_));
 sky130_fd_sc_hd__a21oi_1 _1595_ (.A1(_0351_),
    ...
    .B1(_0377_),
    .Y(_0101_));
 sky130_fd_sc_hd__o21ai_0 _1596_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1600_ (.A(_0927_),
    .B(_0381_),
    .Y(_0382_));
 sky130_fd_sc_hd__nand2_1 _1601_ (.A(net249),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_64_),
    .Y(_0383_));
 sky130_fd_sc_hd__nand2_1 _1602_ (.A(net254),
 ...
 sky130_fd_sc_hd__a221oi_1 _1604_ (.A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_80_),
    ...
    .C1(_0385_),
    .Y(_0386_));
 sky130_fd_sc_hd__o21ai_0 _1605_ (.A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .A2(_0386_),
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_3_),
    .Y(_0387_));
 sky130_fd_sc_hd__o21ai_0 _1606_ (.A1(net254),
 ...
 sky130_fd_sc_hd__nor2_1 _1608_ (.A(_0388_),
    .B(_0389_),
    .Y(_0390_));
 sky130_fd_sc_hd__a22o_1 _1609_ (.A1(net248),
 ...
 sky130_fd_sc_hd__o21ai_0 _1610_ (.A1(_0390_),
    ...
    .B1(_0927_),
    .Y(_0392_));
 sky130_fd_sc_hd__nand2_1 _1611_ (.A(net250),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_32_),
    .Y(_0393_));
 sky130_fd_sc_hd__nand2_1 _1612_ (.A(net254),
 ...
 sky130_fd_sc_hd__a21oi_1 _1613_ (.A1(_0393_),
    ...
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .Y(_0395_));
 sky130_fd_sc_hd__a22o_1 _1614_ (.A1(net248),
 ...
 sky130_fd_sc_hd__o211ai_1 _1617_ (.A1(_0382_),
    ...
    .C1(net244),
    .Y(_0399_));
 sky130_fd_sc_hd__o22ai_1 _1618_ (.A1(_0309_),
    .A2(_0860_),
    .B1(_0689_),
    .B2(_0936_),
    .Y(_0400_));
 ...
 sky130_fd_sc_hd__nor3_1 _1620_ (.A(_0939_),
    ...
    .C(_0401_),
    .Y(_0402_));
 sky130_fd_sc_hd__nor2_1 _1621_ (.A(net190),
    .B(_0884_),
    .Y(_0403_));
 sky130_fd_sc_hd__a21oi_1 _1622_ (.A1(_0399_),
    ...
    .B1(_0403_),
    .Y(_0102_));
 sky130_fd_sc_hd__nor3_4 _1623_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_under_rst),
    .B(_0314_),
    .C(_0305_),
    .Y(_0404_));
 ...
 sky130_fd_sc_hd__inv_2 _1626_ (.A(_0406_),
    .Y(_0407_));
 sky130_fd_sc_hd__nor2_1 _1627_ (.A(_0309_),
    .B(_0407_),
    .Y(_0408_));
 ...
 sky130_fd_sc_hd__nor2_2 _1629_ (.A(_0409_),
    .B(_0404_),
    .Y(_0410_));
 sky130_fd_sc_hd__nor2_2 _1630_ (.A(_0309_),
    .B(_0410_),
    .Y(_0411_));
 ...
 sky130_fd_sc_hd__inv_2 _1637_ (.A(_0404_),
    .Y(_0416_));
 sky130_fd_sc_hd__nor2_1 _1638_ (.A(_0309_),
    .B(_0416_),
    .Y(_0417_));
 ...
 sky130_fd_sc_hd__xor2_1 _1648_ (.A(u_uart_core_uart_tx_baud_div_q_0_),
    ...
    .X(_0108_));
 sky130_fd_sc_hd__inv_1 _1649_ (.A(reg2hw_37_),
    .Y(_0424_));
 ...
 sky130_fd_sc_hd__a21oi_1 _1651_ (.A1(reg2hw_36_),
    ...
    .Y(_0426_));
 sky130_fd_sc_hd__nor2_1 _1652_ (.A(reg2hw_38_),
    .B(reg2hw_37_),
    .Y(_0427_));
 ...
 sky130_fd_sc_hd__clkinv_2 _1657_ (.A(_0431_),
    .Y(_0432_));
 sky130_fd_sc_hd__inv_1 _1658_ (.A(u_uart_core_uart_rx_bit_cnt_q_1_),
    .Y(_0433_));
 sky130_fd_sc_hd__inv_1 _1659_ (.A(u_uart_core_uart_rx_bit_cnt_q_3_),
    .Y(_0434_));
 sky130_fd_sc_hd__xor2_1 _1660_ (.A(u_uart_core_uart_rx_bit_cnt_q_0_),
    .B(reg2hw_39_),
    .X(_0435_));
 ...
 sky130_fd_sc_hd__inv_1 _1663_ (.A(u_uart_core_rx_tick_baud),
    .Y(_0438_));
 sky130_fd_sc_hd__nor2_2 _1664_ (.A(hw2reg_28_),
    .B(_0438_),
    .Y(_0439_));
 ...
 sky130_fd_sc_hd__inv_1 _1667_ (.A(_0437_),
    .Y(_0442_));
 sky130_fd_sc_hd__inv_1 _1668_ (.A(hw2reg_28_),
    .Y(_0443_));
 ...
 sky130_fd_sc_hd__inv_1 _1684_ (.A(_0449_),
    .Y(_0450_));
 sky130_fd_sc_hd__inv_1 _1685_ (.A(u_uart_core_uart_rx_bit_cnt_q_0_),
    .Y(_0451_));
 ...
 sky130_fd_sc_hd__nand2_1 _1688_ (.A(_0450_),
    .B(_0453_),
    .Y(_0118_));
 sky130_fd_sc_hd__nor2_1 _1689_ (.A(u_uart_core_uart_rx_bit_cnt_q_1_),
    .B(_0451_),
    .Y(_0454_));
 sky130_fd_sc_hd__nor2_1 _1690_ (.A(u_uart_core_uart_rx_bit_cnt_q_0_),
    .B(_0433_),
    .Y(_0455_));
 sky130_fd_sc_hd__nor2_1 _1691_ (.A(u_uart_core_uart_rx_bit_cnt_q_1_),
    .B(_0444_),
    .Y(_0456_));
 ...
 sky130_fd_sc_hd__nand2_1 _1694_ (.A(_0445_),
    .B(u_uart_core_uart_rx_bit_cnt_q_0_),
    .Y(_0458_));
 sky130_fd_sc_hd__o221ai_1 _1695_ (.A1(u_uart_core_uart_rx_bit_cnt_q_0_),
    .A2(_0440_),
    .B1(_0797_),
    .B2(_0457_),
    .C1(_0458_),
 ...
 sky130_fd_sc_hd__nor3_1 _1705_ (.A(_0460_),
    ...
    .C(_0444_),
    .Y(_0123_));
 sky130_fd_sc_hd__nor2_1 _1706_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_2_),
    .B(_0759_),
    .Y(_0466_));
 ...
 sky130_fd_sc_hd__nor3_1 _1710_ (.A(_0466_),
    ...
    .C(_0018_),
    .Y(_0124_));
 sky130_fd_sc_hd__nor2_1 _1711_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_1_),
    .B(_0757_),
    .Y(_0470_));
 sky130_fd_sc_hd__nor3_1 _1712_ (.A(_0469_),
    ...
    .C(_0759_),
    .Y(_0125_));
 sky130_fd_sc_hd__nor2_1 _1713_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_0_),
    .B(_0806_),
    .Y(_0471_));
 ...
 sky130_fd_sc_hd__inv_1 _1719_ (.A(_0474_),
    .Y(_0476_));
 sky130_fd_sc_hd__nor2_1 _1720_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_2_),
    .B(_0476_),
    .Y(_0477_));
 sky130_fd_sc_hd__nor3_1 _1721_ (.A(_0469_),
    ...
    .C(_0477_),
    .Y(_0127_));
 sky130_fd_sc_hd__nor2_1 _1722_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_1_),
    .B(_0473_),
    .Y(_0478_));
 sky130_fd_sc_hd__nor3_1 _1723_ (.A(_0469_),
    ...
    .C(_0476_),
    .Y(_0128_));
 sky130_fd_sc_hd__nor2_1 _1724_ (.A(net253),
    .B(_0417_),
    .Y(_0479_));
 sky130_fd_sc_hd__nor3_1 _1725_ (.A(_0469_),
    ...
    .C(_0473_),
    .Y(_0129_));
 sky130_fd_sc_hd__nor2_1 _1726_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_3_),
    .B(_0810_),
    .Y(_0480_));
 ...
 sky130_fd_sc_hd__inv_1 _1730_ (.A(_0809_),
    .Y(_0483_));
 sky130_fd_sc_hd__nor2_1 _1731_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_2_),
    .B(_0483_),
    .Y(_0484_));
 sky130_fd_sc_hd__nor3_1 _1732_ (.A(_0810_),
    ...
    .C(_0484_),
    .Y(_0131_));
 sky130_fd_sc_hd__nor2_1 _1733_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_1_),
    .B(_0808_),
    .Y(_0485_));
 sky130_fd_sc_hd__nor3_1 _1734_ (.A(_0482_),
    .B(_0485_),
    .C(_0483_),
    .Y(_0132_));
 sky130_fd_sc_hd__nor2_1 _1735_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_0_),
    .B(_0801_),
    .Y(_0486_));
 ...
 sky130_fd_sc_hd__inv_1 _1738_ (.A(_0487_),
    .Y(_0488_));
 sky130_fd_sc_hd__nor4_1 _1739_ (.A(net178),
    .B(_0849_),
    .C(_0488_),
    .D(_0247_),
    .Y(_0489_));
 ...
 sky130_fd_sc_hd__nor3_1 _1742_ (.A(_0927_),
    ...
    .C(_0490_),
    .Y(_0492_));
 sky130_fd_sc_hd__nor2_1 _1743_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_3_),
    .B(_0492_),
    .Y(_0493_));
 sky130_fd_sc_hd__nor3_1 _1744_ (.A(_0482_),
    .B(_0491_),
    .C(_0493_),
    .Y(_0134_));
 sky130_fd_sc_hd__a21oi_1 _1745_ (.A1(_0489_),
    ...
    .B1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .Y(_0494_));
 sky130_fd_sc_hd__nor3_1 _1746_ (.A(_0482_),
    .B(_0494_),
    .C(_0492_),
    .Y(_0135_));
 ...
 sky130_fd_sc_hd__o31ai_1 _1750_ (.A1(_0928_),
    ...
    .B1(_0497_),
    .Y(_0136_));
 sky130_fd_sc_hd__nor2_1 _1751_ (.A(net254),
    .B(_0495_),
    .Y(_0498_));
 sky130_fd_sc_hd__a211oi_1 _1752_ (.A1(net254),
    .A2(_0489_),
    .B1(_0482_),
    .C1(_0498_),
    .Y(_0137_));
 ...
 sky130_fd_sc_hd__nor2_1 _1759_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_15_),
    .B(net251),
    .Y(_0502_));
 sky130_fd_sc_hd__nor2_1 _1760_ (.A(net252),
    .B(_0502_),
    .Y(_0503_));
 sky130_fd_sc_hd__o21ai_0 _1761_ (.A1(net253),
    .A2(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_7_),
    .B1(_0503_),
    .Y(_0504_));
 sky130_fd_sc_hd__nor2_1 _1762_ (.A(net253),
    .B(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_23_),
    .Y(_0505_));
 sky130_fd_sc_hd__nor2_1 _1763_ (.A(_0679_),
    .B(_0505_),
    .Y(_0506_));
 sky130_fd_sc_hd__o21ai_0 _1764_ (.A1(net251),
 ...
 sky130_fd_sc_hd__nor2_1 _1765_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_47_),
    .B(net251),
    .Y(_0508_));
 sky130_fd_sc_hd__nor2_1 _1766_ (.A(net252),
    .B(_0508_),
    .Y(_0509_));
 sky130_fd_sc_hd__o21ai_0 _1767_ (.A1(net253),
    .A2(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_39_),
    .B1(_0509_),
    .Y(_0510_));
 sky130_fd_sc_hd__o21ai_0 _1768_ (.A1(net253),
 ...
 sky130_fd_sc_hd__nor2_1 _1783_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_46_),
    .B(net251),
    .Y(_0525_));
 sky130_fd_sc_hd__nor2_1 _1784_ (.A(net252),
    .B(_0525_),
    .Y(_0526_));
 sky130_fd_sc_hd__o21ai_0 _1785_ (.A1(net253),
    .A2(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_38_),
    .B1(_0526_),
    .Y(_0527_));
 sky130_fd_sc_hd__o21ai_0 _1786_ (.A1(net253),
 ...
 sky130_fd_sc_hd__nor2_1 _1802_ (.A(_0682_),
    .B(_0542_),
    .Y(_0543_));
 sky130_fd_sc_hd__nor2_1 _1803_ (.A(net253),
    .B(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_37_),
    .Y(_0544_));
 sky130_fd_sc_hd__nor2_1 _1804_ (.A(net252),
    .B(_0544_),
    .Y(_0545_));
 sky130_fd_sc_hd__o21ai_0 _1805_ (.A1(net251),
 ...
 sky130_fd_sc_hd__a31oi_1 _1809_ (.A1(_0411_),
    ...
    .B1(_0549_),
    .Y(_0140_));
 sky130_fd_sc_hd__nor2_1 _1810_ (.A(net253),
 ...
 sky130_fd_sc_hd__o21ai_0 _1811_ (.A1(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_12_),
    ...
    .B1(_0679_),
    .Y(_0551_));
 sky130_fd_sc_hd__nor2_1 _1812_ (.A(net253),
 ...
 sky130_fd_sc_hd__o221ai_1 _1814_ (.A1(_0550_),
    ...
    .C1(_0682_),
    .Y(_0554_));
 sky130_fd_sc_hd__nor2_1 _1815_ (.A(net253),
 ...
 sky130_fd_sc_hd__o21ai_0 _1816_ (.A1(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_44_),
    ...
    .B1(_0679_),
    .Y(_0556_));
 sky130_fd_sc_hd__nor2_1 _1817_ (.A(net253),
 ...
 sky130_fd_sc_hd__o221ai_1 _1823_ (.A1(_0416_),
    ...
    .C1(_0562_),
    .Y(_0141_));
 sky130_fd_sc_hd__o21ai_0 _1824_ (.A1(net253),
 ...
 sky130_fd_sc_hd__nor2_1 _1825_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_27_),
    .B(net251),
    .Y(_0564_));
 sky130_fd_sc_hd__o21ai_0 _1826_ (.A1(net253),
 ...
 sky130_fd_sc_hd__o221ai_1 _1828_ (.A1(_0563_),
    ...
    .C1(_0682_),
    .Y(_0567_));
 sky130_fd_sc_hd__o21ai_0 _1829_ (.A1(net253),
 ...
 sky130_fd_sc_hd__nor2_1 _1830_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_59_),
    .B(net251),
    .Y(_0569_));
 sky130_fd_sc_hd__o21ai_0 _1831_ (.A1(net253),
 ...
 sky130_fd_sc_hd__nor2_1 _1847_ (.A(_0682_),
    .B(_0584_),
    .Y(_0585_));
 sky130_fd_sc_hd__nor2_1 _1848_ (.A(net253),
    .B(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_34_),
    .Y(_0586_));
 sky130_fd_sc_hd__nor2_1 _1849_ (.A(net252),
    .B(_0586_),
    .Y(_0587_));
 sky130_fd_sc_hd__o21ai_0 _1850_ (.A1(net251),
 ...
 sky130_fd_sc_hd__o21ai_0 _1853_ (.A1(_0409_),
    ...
    .B1(_0590_),
    .Y(_0143_));
 sky130_fd_sc_hd__o21ai_0 _1854_ (.A1(net253),
 ...
 sky130_fd_sc_hd__nor2_1 _1855_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_57_),
    .B(net251),
    .Y(_0592_));
 sky130_fd_sc_hd__o21ai_0 _1856_ (.A1(net253),
 ...
 sky130_fd_sc_hd__nor2_1 _1859_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_9_),
    .B(net251),
    .Y(_0596_));
 sky130_fd_sc_hd__nor2_1 _1860_ (.A(net252),
    .B(_0596_),
    .Y(_0597_));
 sky130_fd_sc_hd__o21ai_0 _1861_ (.A1(net253),
 ...
 sky130_fd_sc_hd__nor2_1 _1863_ (.A(_0679_),
    .B(_0599_),
    .Y(_0600_));
 sky130_fd_sc_hd__o21ai_0 _1864_ (.A1(net253),
 ...
 sky130_fd_sc_hd__a31oi_1 _1868_ (.A1(_0411_),
    ...
    .B1(_0604_),
    .Y(_0144_));
 sky130_fd_sc_hd__o21ai_0 _1869_ (.A1(net253),
 ...
 sky130_fd_sc_hd__nor2_1 _1870_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_56_),
    .B(net251),
    .Y(_0606_));
 sky130_fd_sc_hd__o21ai_0 _1871_ (.A1(net253),
 ...
 sky130_fd_sc_hd__nor2_1 _1874_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_8_),
    .B(net251),
    .Y(_0610_));
 sky130_fd_sc_hd__nor2_1 _1875_ (.A(net252),
    .B(_0610_),
    .Y(_0611_));
 sky130_fd_sc_hd__o21ai_0 _1876_ (.A1(net253),
 ...
 sky130_fd_sc_hd__nor2_1 _1878_ (.A(_0679_),
    .B(_0613_),
    .Y(_0614_));
 sky130_fd_sc_hd__o21ai_0 _1879_ (.A1(net253),
 ...
 sky130_fd_sc_hd__o21ai_0 _1897_ (.A1(_0629_),
    ...
    .B1(_0630_),
    .Y(_0631_));
 sky130_fd_sc_hd__xnor2_1 _1898_ (.A(reg2hw_40_),
    .B(_0631_),
    .Y(_0632_));
 ...
 sky130_fd_sc_hd__nand2_1 _1903_ (.A(_0488_),
    .B(_0635_),
    .Y(_0148_));
 sky130_fd_sc_hd__nand2_1 _1904_ (.A(reg2hw_39_),
    .B(u_uart_core_uart_rx_sreg_q_8_),
    .Y(_0636_));
 sky130_fd_sc_hd__o21ai_2 _1905_ (.A1(reg2hw_39_),
    .A2(_0441_),
    .B1(_0636_),
 ...
 sky130_fd_sc_hd__inv_1 _1919_ (.A(_0643_),
    .Y(_0644_));
 sky130_fd_sc_hd__o22ai_1 _1920_ (.A1(hw2reg_28_),
    .A2(_0644_),
 ...
 sky130_fd_sc_hd__nor3_1 _1924_ (.A(u_uart_core_uart_rx_bit_cnt_q_2_),
    ...
    .C(_0647_),
    .Y(_0000_));
 sky130_fd_sc_hd__nor2_1 _1925_ (.A(hw2reg_28_),
    .B(_0000_),
    .Y(_0648_));
 ...
 sky130_fd_sc_hd__inv_1 _1932_ (.A(u_uart_core_uart_tx_bit_cnt_q_3_),
    .Y(_0651_));
 sky130_fd_sc_hd__a21oi_1 _1933_ (.A1(reg2hw_34_),
    .A2(_0312_),
    .B1(_0410_),
    .Y(_0652_));
 ...
 sky130_fd_sc_hd__a21oi_1 _1939_ (.A1(_0904_),
    ...
    .B1(_0852_),
    .Y(_0656_));
 sky130_fd_sc_hd__nor2_1 _1940_ (.A(net194),
    .B(_0884_),
    .Y(_0657_));
 sky130_fd_sc_hd__a31oi_1 _1941_ (.A1(_0654_),
    ...
    .B1(_0657_),
    .Y(_0160_));
 sky130_fd_sc_hd__o21ai_0 _1942_ (.A1(net189),
    .A2(net141),
    .B1(_0852_),
    .Y(_0161_));
 sky130_fd_sc_hd__nand2_1 _1943_ (.A(_0861_),
    .B(reg2hw_56_),
    .Y(_0658_));
 sky130_fd_sc_hd__nor2_1 _1944_ (.A(net222),
    .B(_0884_),
    .Y(_0659_));
 sky130_fd_sc_hd__a21oi_1 _1945_ (.A1(net245),
    .A2(_0658_),
    .B1(_0659_),
    .Y(_0162_));
 sky130_fd_sc_hd__nand2_1 _1946_ (.A(_0884_),
    .B(net188),
    .Y(_0660_));
 ...
 sky130_fd_sc_hd__nand2_1 _1948_ (.A(_0660_),
    .B(_0661_),
    .Y(_0163_));
 sky130_fd_sc_hd__nand2_1 _1949_ (.A(_0884_),
    .B(net143),
    .Y(_0662_));
 ...
 sky130_fd_sc_hd__nand2_1 _1951_ (.A(_0662_),
    .B(_0663_),
    .Y(_0164_));
 sky130_fd_sc_hd__nand2_1 _1952_ (.A(_0882_),
    .B(reg2hw_38_),
    .Y(_0664_));
 sky130_fd_sc_hd__o21ai_0 _1953_ (.A1(_0871_),
    ...
    .B1(_0664_),
    .Y(_0165_));
 sky130_fd_sc_hd__mux2_1 _1954_ (.A0(net171),
    .A1(reg2hw_56_),
    .S(net246),
    .X(_0166_));
 sky130_fd_sc_hd__nand2_1 _1955_ (.A(_0882_),
    .B(reg2hw_36_),
    .Y(_0665_));
 sky130_fd_sc_hd__o21ai_0 _1956_ (.A1(_0875_),
    ...
    .B1(_0665_),
    .Y(_0167_));
 sky130_fd_sc_hd__nand2_1 _1957_ (.A(net246),
    .B(reg2hw_39_),
    .Y(_0666_));
 sky130_fd_sc_hd__o21ai_0 _1958_ (.A1(_0869_),
    ...
    .B1(_0666_),
    .Y(_0168_));
 sky130_fd_sc_hd__mux2_1 _1959_ (.A0(net155),
    .A1(reg2hw_40_),
    .S(_0882_),
    .X(_0169_));
 sky130_fd_sc_hd__nand2_1 _1960_ (.A(_0882_),
    .B(reg2hw_35_),
    .Y(_0667_));
 sky130_fd_sc_hd__o21ai_0 _1961_ (.A1(_0877_),
    ...
    .B1(_0667_),
    .Y(_0170_));
 sky130_fd_sc_hd__nand2_1 _1962_ (.A(_0882_),
    .B(reg2hw_37_),
    .Y(_0668_));
 sky130_fd_sc_hd__o21ai_0 _1963_ (.A1(_0873_),
    ...
    .B1(_0668_),
    .Y(_0171_));
 sky130_fd_sc_hd__nand2_1 _1964_ (.A(_0882_),
    .B(reg2hw_34_),
    .Y(_0669_));
 ...
 sky130_fd_sc_hd__o21ai_0 _1971_ (.A1(_0468_),
    ...
    .B1(_0672_),
    .Y(_0174_));
 sky130_fd_sc_hd__mux2_1 _1972_ (.A0(reg2hw_12_),
    .A1(net155),
    .S(net243),
    .X(_0175_));
 ...
 sky130_fd_sc_hd__xor2_1 _1976_ (.A(_0732_),
    .B(_0728_),
    .X(_0014_));
 sky130_fd_sc_hd__nor2_1 _1977_ (.A(_0705_),
    .B(_0817_),
    .Y(_0673_));
 ...
 sky130_fd_sc_hd__dfrtp_1 _2086_ (.D(_0175_),
    ...
    .RESET_B(reg_rst_ni),
    .CLK(clknet_leaf_31_clk_i));
 sky130_fd_sc_hd__dfrtp_1 _2087_ (.D(net243),
    .Q(reg2hw_4_),
    .RESET_B(reg_rst_ni),
    .CLK(clknet_leaf_29_clk_i));
 ...
 sky130_fd_sc_hd__dfrtp_1 _2091_ (.D(_0000_),
    ...
    .RESET_B(net255),
    .CLK(clknet_leaf_15_clk_i));
 sky130_fd_sc_hd__dfstp_1 _2092_ (.D(net113),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_under_rst),
    .SET_B(net256),
    .CLK(clknet_leaf_15_clk_i));
 sky130_fd_sc_hd__conb_1 _2092__2 (.LO(net113));
 sky130_fd_sc_hd__dfstp_1 _2093_ (.D(net),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_under_rst),
    .SET_B(net255),
    .CLK(clknet_leaf_5_clk_i));
 sky130_fd_sc_hd__conb_1 _2093__3 (.LO(net));
 sky130_fd_sc_hd__dfrtp_1 _2094_ (.D(net134),
    .Q(u_uart_core_tx_rst_ni),
    .RESET_B(net288),
    .CLK(clknet_leaf_5_clk_i));
 sky130_fd_sc_hd__conb_1 _2094__24 (.HI(net134));
 sky130_fd_sc_hd__dfrtp_1 _2095_ (.D(net135),
    .Q(u_uart_core_timing_rst_ni),
    .RESET_B(net288),
    .CLK(clknet_leaf_6_clk_i));
 sky130_fd_sc_hd__conb_1 _2095__25 (.HI(net135));
 sky130_fd_sc_hd__dfrtp_1 _2096_ (.D(net136),
    .Q(u_uart_core_rx_rst_ni),
    .RESET_B(net288),
    .CLK(clknet_leaf_5_clk_i));
 sky130_fd_sc_hd__conb_1 _2096__26 (.HI(net136));
 ...
 sky130_fd_sc_hd__dfstp_1 _2098_ (.D(u_uart_core_sync_rx_intq),
    ...
    .SET_B(net255),
    .CLK(clknet_leaf_18_clk_i));
 sky130_fd_sc_hd__dfstp_1 _2099_ (.D(net140),
 ...
 sky130_fd_sc_hd__dfrtp_1 _2340_ (.D(_0126_),
    ...
    .RESET_B(net256),
    .CLK(clknet_leaf_27_clk_i));
 sky130_fd_sc_hd__conb_1 _2345__4 (.LO(tl_o[2]));
 sky130_fd_sc_hd__conb_1 _2346__5 (.LO(tl_o[3]));
 sky130_fd_sc_hd__conb_1 _2347__6 (.LO(tl_o[4]));
 sky130_fd_sc_hd__conb_1 _2348__7 (.LO(tl_o[5]));
 sky130_fd_sc_hd__conb_1 _2349__8 (.LO(tl_o[6]));
 sky130_fd_sc_hd__conb_1 _2350__9 (.LO(tl_o[7]));
 sky130_fd_sc_hd__conb_1 _2351__10 (.LO(tl_o[8]));
 sky130_fd_sc_hd__conb_1 _2352__11 (.LO(tl_o[9]));
 sky130_fd_sc_hd__conb_1 _2353__12 (.LO(tl_o[10]));
 sky130_fd_sc_hd__conb_1 _2354__13 (.LO(tl_o[11]));
 sky130_fd_sc_hd__conb_1 _2355__14 (.LO(tl_o[12]));
 sky130_fd_sc_hd__conb_1 _2356__15 (.LO(tl_o[13]));
 sky130_fd_sc_hd__conb_1 _2357__16 (.LO(tl_o[14]));
 sky130_fd_sc_hd__conb_1 _2358__17 (.LO(tl_o[15]));
 sky130_fd_sc_hd__conb_1 _2391__18 (.LO(tl_o[48]));
 sky130_fd_sc_hd__conb_1 _2402__19 (.LO(tl_o[59]));
 sky130_fd_sc_hd__conb_1 _2403__20 (.LO(tl_o[60]));
 sky130_fd_sc_hd__conb_1 _2404__21 (.LO(tl_o[61]));
 sky130_fd_sc_hd__conb_1 _2406__22 (.LO(tl_o[63]));
 sky130_fd_sc_hd__conb_1 _2407__23 (.LO(tl_o[64]));
 ...
 sky130_fd_sc_hd__clkbuf_16 clkbuf_leaf_28_clk_i (.A(clknet_2_3__leaf_clk_i),
    .X(clknet_leaf_28_clk_i));
 sky130_fd_sc_hd__clkbuf_16 clkbuf_leaf_29_clk_i (.A(clknet_2_3__leaf_clk_i),
 ...
 sky130_fd_sc_hd__clkbuf_16 clkbuf_leaf_36_clk_i (.A(clknet_2_1__leaf_clk_i),
    .X(clknet_leaf_36_clk_i));
 sky130_fd_sc_hd__clkbuf_16 clkbuf_leaf_37_clk_i (.A(clknet_2_1__leaf_clk_i),
    .X(clknet_leaf_37_clk_i));
 sky130_fd_sc_hd__clkbuf_16 clkbuf_leaf_38_clk_i (.A(clknet_2_0__leaf_clk_i),
    .X(clknet_leaf_38_clk_i));
 sky130_fd_sc_hd__clkbuf_16 clkbuf_leaf_39_clk_i (.A(clknet_2_1__leaf_clk_i),
    .X(clknet_leaf_39_clk_i));
 sky130_fd_sc_hd__clkbuf_16 clkbuf_leaf_3_clk_i (.A(clknet_2_0__leaf_clk_i),
    .X(clknet_leaf_3_clk_i));
 sky130_fd_sc_hd__clkbuf_16 clkbuf_leaf_40_clk_i (.A(clknet_2_1__leaf_clk_i),
 ...
 sky130_fd_sc_hd__clkbuf_16 clkbuf_leaf_45_clk_i (.A(clknet_2_0__leaf_clk_i),
 ...
 sky130_fd_sc_hd__clkbuf_16 clkbuf_leaf_7_clk_i (.A(clknet_2_0__leaf_clk_i),
 ...
 sky130_fd_sc_hd__clkbuf_1 clkload10 (.A(clknet_leaf_42_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload11 (.A(clknet_leaf_43_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload12 (.A(clknet_leaf_44_clk_i));
 sky130_fd_sc_hd__clkinv_4 clkload13 (.A(clknet_leaf_45_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload14 (.A(clknet_leaf_30_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload15 (.A(clknet_leaf_31_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload16 (.A(clknet_leaf_32_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload17 (.A(clknet_leaf_33_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload18 (.A(clknet_leaf_34_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload19 (.A(clknet_leaf_35_clk_i));
 sky130_fd_sc_hd__inv_16 clkload2 (.A(clknet_2_2__leaf_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload20 (.A(clknet_leaf_36_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload21 (.A(clknet_leaf_39_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload22 (.A(clknet_leaf_40_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload23 (.A(clknet_leaf_5_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload24 (.A(clknet_leaf_6_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload25 (.A(clknet_leaf_8_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload26 (.A(clknet_leaf_9_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload27 (.A(clknet_leaf_10_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload28 (.A(clknet_leaf_15_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload29 (.A(clknet_leaf_16_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload3 (.A(clknet_leaf_0_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload30 (.A(clknet_leaf_17_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload31 (.A(clknet_leaf_18_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload32 (.A(clknet_leaf_19_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload33 (.A(clknet_leaf_20_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload34 (.A(clknet_leaf_21_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload35 (.A(clknet_leaf_22_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload36 (.A(clknet_leaf_23_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload37 (.A(clknet_leaf_24_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload38 (.A(clknet_leaf_25_clk_i));
 ...
 sky130_fd_sc_hd__clkbuf_1 clkload41 (.A(clknet_leaf_28_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload5 (.A(clknet_leaf_2_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload6 (.A(clknet_leaf_3_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload7 (.A(clknet_leaf_7_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload8 (.A(clknet_leaf_38_clk_i));
 sky130_fd_sc_hd__clkbuf_1 clkload9 (.A(clknet_leaf_41_clk_i));
 sky130_fd_sc_hd__dlygate4sd3_1 hold147 (.A(rst_ni),
    .X(net257));
 sky130_fd_sc_hd__dlygate4sd3_1 hold148 (.A(rx_i),
    .X(net258));
 sky130_fd_sc_hd__dlygate4sd3_1 hold149 (.A(tl_i[99]),
    .X(net259));
 sky130_fd_sc_hd__dlygate4sd3_1 hold150 (.A(tl_i[97]),
    .X(net260));
 sky130_fd_sc_hd__dlygate4sd3_1 hold151 (.A(tl_i[95]),
    .X(net261));
 sky130_fd_sc_hd__dlygate4sd3_1 hold152 (.A(tl_i[96]),
    .X(net262));
 sky130_fd_sc_hd__dlygate4sd3_1 hold153 (.A(tl_i[98]),
    .X(net263));
 sky130_fd_sc_hd__dlygate4sd3_1 hold154 (.A(tl_i[92]),
    .X(net264));
 sky130_fd_sc_hd__dlygate4sd3_1 hold155 (.A(tl_i[94]),
    .X(net265));
 sky130_fd_sc_hd__dlygate4sd3_1 hold156 (.A(tl_i[101]),
    .X(net266));
 sky130_fd_sc_hd__dlygate4sd3_1 hold157 (.A(tl_i[0]),
    .X(net267));
 sky130_fd_sc_hd__dlygate4sd3_1 hold158 (.A(tl_i[100]),
    .X(net268));
 sky130_fd_sc_hd__dlygate4sd3_1 hold159 (.A(tl_i[93]),
    .X(net269));
 sky130_fd_sc_hd__dlygate4sd3_1 hold160 (.A(tl_i[29]),
    .X(net270));
 sky130_fd_sc_hd__dlygate4sd3_1 hold161 (.A(tl_i[28]),
    .X(net271));
 sky130_fd_sc_hd__dlygate4sd3_1 hold162 (.A(tl_i[27]),
    .X(net272));
 sky130_fd_sc_hd__dlygate4sd3_1 hold163 (.A(tl_i[49]),
    .X(net273));
 sky130_fd_sc_hd__dlygate4sd3_1 hold164 (.A(tl_i[50]),
    .X(net274));
 sky130_fd_sc_hd__dlygate4sd3_1 hold165 (.A(tl_i[48]),
    .X(net275));
 sky130_fd_sc_hd__dlygate4sd3_1 hold166 (.A(tl_i[44]),
    .X(net276));
 sky130_fd_sc_hd__dlygate4sd3_1 hold167 (.A(tl_i[41]),
    .X(net277));
 sky130_fd_sc_hd__dlygate4sd3_1 hold168 (.A(tl_i[45]),
    .X(net278));
 sky130_fd_sc_hd__dlygate4sd3_1 hold169 (.A(tl_i[53]),
    .X(net279));
 sky130_fd_sc_hd__dlygate4sd3_1 hold170 (.A(tl_i[51]),
    .X(net280));
 sky130_fd_sc_hd__dlygate4sd3_1 hold171 (.A(tl_i[52]),
    .X(net281));
 sky130_fd_sc_hd__dlygate4sd3_1 hold172 (.A(tl_i[55]),
    .X(net282));
 sky130_fd_sc_hd__dlygate4sd3_1 hold173 (.A(tl_i[54]),
    .X(net283));
 sky130_fd_sc_hd__dlygate4sd3_1 hold174 (.A(tl_i[46]),
    .X(net284));
 sky130_fd_sc_hd__dlygate4sd3_1 hold175 (.A(tl_i[40]),
    .X(net285));
 sky130_fd_sc_hd__dlygate4sd3_1 hold176 (.A(tl_i[47]),
    .X(net286));
 sky130_fd_sc_hd__dlygate4sd3_1 hold177 (.A(tl_i[42]),
    .X(net287));
 sky130_fd_sc_hd__dlygate4sd3_1 hold178 (.A(core_rst_ni),
    .X(net288));
 sky130_fd_sc_hd__dlygate4sd3_1 hold179 (.A(tl_i[43]),
    .X(net289));
 sky130_fd_sc_hd__dlygate4sd3_1 hold180 (.A(tl_i[26]),
    .X(net290));
 sky130_fd_sc_hd__dlygate4sd3_1 hold181 (.A(tl_i[25]),
    .X(net291));
 sky130_fd_sc_hd__dlygate4sd3_1 hold182 (.A(tl_i[24]),
    .X(net292));
 sky130_fd_sc_hd__dlygate4sd3_1 hold183 (.A(tl_i[64]),
    .X(net293));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input29 (.A(net257),
    .X(net139));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input30 (.A(net258),
    .X(net140));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input31 (.A(net267),
    .X(net141));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input32 (.A(net268),
    .X(net142));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input33 (.A(net266),
    .X(net143));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input34 (.A(tl_i[105]),
    .X(net144));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input35 (.A(tl_i[106]),
    .X(net145));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input36 (.A(tl_i[107]),
    .X(net146));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input37 (.A(tl_i[108]),
    .X(net147));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input38 (.A(net292),
    .X(net148));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input39 (.A(net291),
    .X(net149));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input40 (.A(net290),
    .X(net150));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input41 (.A(net272),
    .X(net151));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input42 (.A(net271),
    .X(net152));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input43 (.A(net270),
    .X(net153));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input44 (.A(tl_i[30]),
    .X(net154));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input45 (.A(tl_i[31]),
    .X(net155));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input46 (.A(net285),
    .X(net156));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input47 (.A(net277),
    .X(net157));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input48 (.A(net287),
    .X(net158));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input49 (.A(net289),
    .X(net159));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input50 (.A(net276),
    .X(net160));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input51 (.A(net278),
    .X(net161));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input52 (.A(net284),
    .X(net162));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input53 (.A(net286),
    .X(net163));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input54 (.A(net275),
    .X(net164));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input55 (.A(net273),
    .X(net165));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input56 (.A(net274),
    .X(net166));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input57 (.A(net280),
    .X(net167));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input58 (.A(net281),
    .X(net168));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input59 (.A(net279),
    .X(net169));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input60 (.A(net283),
    .X(net170));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input61 (.A(net282),
    .X(net171));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input62 (.A(tl_i[56]),
    .X(net172));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input63 (.A(tl_i[57]),
    .X(net173));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input64 (.A(tl_i[58]),
    .X(net174));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input65 (.A(tl_i[59]),
    .X(net175));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input66 (.A(tl_i[60]),
    .X(net176));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input67 (.A(tl_i[61]),
    .X(net177));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input68 (.A(tl_i[62]),
    .X(net178));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input69 (.A(tl_i[63]),
    .X(net179));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input70 (.A(net293),
    .X(net180));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input71 (.A(net264),
    .X(net181));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input72 (.A(net269),
    .X(net182));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input73 (.A(net265),
    .X(net183));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input74 (.A(net261),
    .X(net184));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input75 (.A(net262),
    .X(net185));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input76 (.A(net260),
    .X(net186));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input77 (.A(net263),
    .X(net187));
 sky130_fd_sc_hd__clkdlybuf4s50_1 input78 (.A(net259),
    .X(net188));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output100 (.A(net210),
    .X(tl_o[35]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output101 (.A(net211),
    .X(tl_o[36]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output102 (.A(net212),
    .X(tl_o[37]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output103 (.A(net213),
    .X(tl_o[38]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output104 (.A(net214),
    .X(tl_o[39]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output105 (.A(net215),
    .X(tl_o[40]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output106 (.A(net216),
    .X(tl_o[41]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output107 (.A(net217),
    .X(tl_o[42]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output108 (.A(net218),
    .X(tl_o[43]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output109 (.A(net219),
    .X(tl_o[44]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output110 (.A(net220),
    .X(tl_o[45]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output111 (.A(net221),
    .X(tl_o[46]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output112 (.A(net222),
    .X(tl_o[47]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output113 (.A(net223),
    .X(tl_o[49]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output114 (.A(net224),
    .X(tl_o[50]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output115 (.A(net225),
    .X(tl_o[51]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output116 (.A(net226),
    .X(tl_o[52]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output117 (.A(net227),
    .X(tl_o[53]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output118 (.A(net228),
    .X(tl_o[54]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output119 (.A(net229),
    .X(tl_o[55]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output120 (.A(net230),
    .X(tl_o[56]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output121 (.A(net231),
    .X(tl_o[57]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output122 (.A(net232),
    .X(tl_o[58]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output123 (.A(net233),
    .X(tl_o[62]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output124 (.A(net234),
    .X(tl_o[65]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output125 (.A(net235),
    .X(tx_o));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output79 (.A(net189),
    .X(tl_o[0]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output80 (.A(net190),
    .X(tl_o[16]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output81 (.A(net191),
    .X(tl_o[17]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output82 (.A(net192),
    .X(tl_o[18]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output83 (.A(net193),
    .X(tl_o[19]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output84 (.A(net194),
    .X(tl_o[1]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output85 (.A(net195),
    .X(tl_o[20]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output86 (.A(net196),
    .X(tl_o[21]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output87 (.A(net197),
    .X(tl_o[22]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output88 (.A(net198),
    .X(tl_o[23]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output89 (.A(net199),
    .X(tl_o[24]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output90 (.A(net200),
    .X(tl_o[25]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output91 (.A(net201),
    .X(tl_o[26]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output92 (.A(net202),
    .X(tl_o[27]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output93 (.A(net203),
    .X(tl_o[28]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output94 (.A(net204),
    .X(tl_o[29]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output95 (.A(net205),
    .X(tl_o[30]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output96 (.A(net206),
    .X(tl_o[31]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output97 (.A(net207),
    .X(tl_o[32]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output98 (.A(net208),
    .X(tl_o[33]));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output99 (.A(net209),
    .X(tl_o[34]));
 sky130_fd_sc_hd__buf_4 place133 (.A(_0868_),
    .X(net243));
 sky130_fd_sc_hd__buf_4 place134 (.A(_0966_),
    .X(net244));
 sky130_fd_sc_hd__buf_4 place135 (.A(_0905_),
    .X(net245));
 sky130_fd_sc_hd__buf_4 place136 (.A(_0882_),
    .X(net246));
 sky130_fd_sc_hd__buf_4 place137 (.A(_0973_),
    .X(net247));
 sky130_fd_sc_hd__buf_4 place138 (.A(_0971_),
    .X(net248));
 sky130_fd_sc_hd__buf_4 place139 (.A(_0776_),
    .X(net249));
 sky130_fd_sc_hd__buf_4 place140 (.A(_0776_),
    .X(net250));
 sky130_fd_sc_hd__buf_4 place141 (.A(_0686_),
    .X(net251));
 sky130_fd_sc_hd__buf_4 place142 (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_1_),
    .X(net252));
 sky130_fd_sc_hd__buf_4 place143 (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_0_),
    .X(net253));
 sky130_fd_sc_hd__buf_4 place144 (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_0_),
    .X(net254));
 sky130_fd_sc_hd__buf_4 place145 (.A(u_uart_core_rx_rst_ni),
    .X(net255));
 sky130_fd_sc_hd__buf_4 place146 (.A(u_uart_core_tx_rst_ni),
    .X(net256));
endmodule
