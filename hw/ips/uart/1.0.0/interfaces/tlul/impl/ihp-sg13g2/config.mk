...
export SYNTH_NETLIST_FILES := /tmp/flexsoc-ip-release/uart-tlul/runs/uart/release/syn/ihp-sg13g2/uart_synth.v
export SDC_FILE             := /tmp/flexsoc-ip-release/uart-tlul/runs/uart/release/constraints/uart.sdc
