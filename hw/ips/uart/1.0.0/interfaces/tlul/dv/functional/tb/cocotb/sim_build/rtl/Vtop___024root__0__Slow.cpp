...
#endif
            VL_FATAL_MT("/tmp/flexsoc-uart-interface-contract-20260914/tlul/runs/uart/contract/dv/functional/tb/cocotb/uart_tb.sv", 2, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
