...
class alignas(VL_CACHE_LINE_BYTES) Vtop__Syms final : public VerilatedSyms {
  public:
    ...
    VerilatedScope* __Vscopep_uart_tb__u_uart__u_uart_reg__u_flexsoc_tlul_to_reg;
    VerilatedScope* __Vscopep_uart_tb__u_uart__u_uart_reg__u_flexsoc_tlul_to_reg__u_err;
    VerilatedScope* __Vscopep_uart_tb__u_uart__u_uart_reg__u_flexsoc_tlul_to_reg__u_rsp_intg_gen;
