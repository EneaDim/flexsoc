...
bool Vtop___024root___eval_phase__inact(Vtop___024root* vlSelf) {
    ...
    if (__VinactExecute) {
        VL_FATAL_MT("/tmp/flexsoc-uart-interface-contract-20260914/reg_iface/runs/uart/contract/dv/functional/tb/cocotb/uart_tb.sv", 2, "", "ZERODLY: Design Verilated with '--no-sched-zero-delay', but #0 delay executed at runtime");
    }
...
#endif
            VL_FATAL_MT("/tmp/flexsoc-uart-interface-contract-20260914/reg_iface/runs/uart/contract/dv/functional/tb/cocotb/uart_tb.sv", 2, "", "DIDNOTCONVERGE: Input combinational region did not converge after '--converge-limit' of 10000 tries");
        }
...
#endif
            VL_FATAL_MT("/tmp/flexsoc-uart-interface-contract-20260914/reg_iface/runs/uart/contract/dv/functional/tb/cocotb/uart_tb.sv", 2, "", "DIDNOTCONVERGE: NBA region did not converge after '--converge-limit' of 10000 tries");
        }
        __VnbaIterCount = ((IData)(1U) + __VnbaIterCount);
        vlSelfRef.__VinactIterCount = 0U;
        do {
            if (VL_UNLIKELY(((0x00002710U < vlSelfRef.__VinactIterCount)))) {
                VL_FATAL_MT("/tmp/flexsoc-uart-interface-contract-20260914/reg_iface/runs/uart/contract/dv/functional/tb/cocotb/uart_tb.sv", 2, "", "DIDNOTCONVERGE: Inactive region did not converge after '--converge-limit' of 10000 tries");
            }
            ...
            do {
                if (VL_UNLIKELY(((0x00002710U < vlSelfRef.__VactIterCount)))) {
                    ...
                    Vtop___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                    VL_FATAL_MT("/tmp/flexsoc-uart-interface-contract-20260914/reg_iface/runs/uart/contract/dv/functional/tb/cocotb/uart_tb.sv", 2, "", "DIDNOTCONVERGE: Active region did not converge after '--converge-limit' of 10000 tries");
                }
