module uart (clk_i,
 ...
 sg13g2_nand2_1 _1361_ (.Y(_1090_),
    .A(_1088_),
    .B(_1089_));
 sg13g2_nor3_1 _1362_ (.A(net613),
    .B(net610),
    .C(_1090_),
    .Y(_1091_));
 sg13g2_inv_4 _1364_ (.A(_1091_),
    .Y(_1093_));
 ...
 sg13g2_inv_1 _1371_ (.Y(_1099_),
    .A(net624));
 sg13g2_o21ai_1 _1372_ (.B1(net1033),
    .Y(net641),
    .A1(_0018_),
    .A2(net1057));
 sg13g2_inv_2 _1373_ (.Y(_1100_),
    .A(reg2hw_54_));
 sg13g2_o21ai_1 _1374_ (.B1(net1033),
    .Y(net640),
    .A1(_1100_),
    .A2(net1057));
 sg13g2_inv_1 _1375_ (.Y(_1101_),
    .A(reg2hw_53_));
 sg13g2_o21ai_1 _1376_ (.B1(net1033),
    .Y(net639),
    .A1(_1101_),
    .A2(net1057));
 ...
 sg13g2_nor2b_1 _1449_ (.A(_0018_),
 ...
 sg13g2_xnor2_1 _1451_ (.Y(_0008_),
    .A(_1104_),
    .B(_1175_));
 sg13g2_o21ai_1 _1452_ (.B1(net1033),
    .Y(net637),
    .A1(_0019_),
    .A2(net1057));
 sg13g2_nor2b_1 _1453_ (.A(_1169_),
    .B_N(_1109_),
    .Y(_1176_));
 ...
 sg13g2_xor2_1 _1456_ (.B(_1172_),
    .A(_1173_),
    .X(_0007_));
 sg13g2_o21ai_1 _1457_ (.B1(net1033),
    .Y(net636),
    .A1(_1166_),
    .A2(net1057));
 ...
 sg13g2_xnor2_1 _1462_ (.Y(_0005_),
    .A(_1109_),
    .B(_1169_));
 sg13g2_o21ai_1 _1463_ (.B1(net1033),
    .Y(net635),
    .A1(_0020_),
    .A2(net1057));
 ...
 sg13g2_xnor2_1 _1467_ (.Y(_0003_),
    .A(_1151_),
    .B(_1178_));
 sg13g2_o21ai_1 _1468_ (.B1(net1033),
    .Y(net634),
    .A1(_0021_),
    .A2(net1058));
 ...
 sg13g2_xor2_1 _1477_ (.B(_1134_),
    .A(_1139_),
    .X(_0014_));
 sg13g2_o21ai_1 _1478_ (.B1(net1034),
    .Y(net632),
    .A1(_0022_),
    .A2(net1058));
 ...
 sg13g2_xnor2_1 _1480_ (.Y(_0010_),
    .A(_1123_),
    .B(_1122_));
 sg13g2_o21ai_1 _1481_ (.B1(net1034),
    .Y(net631),
    .A1(_0023_),
    .A2(net1058));
 sg13g2_inv_1 _1482_ (.Y(_1186_),
    .A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_3_));
 sg13g2_nor2_1 _1483_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_3_),
    .B(_1186_),
    .Y(_1187_));
 ...
 sg13g2_a21oi_1 _1500_ (.A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_0_),
    .A2(_1203_),
    .Y(_1204_),
    .B1(_1190_));
 sg13g2_a21oi_1 _1501_ (.A1(net1070),
 ...
 sg13g2_nor2_1 _1502_ (.A(_1192_),
    .B(_1205_),
    .Y(_1206_));
 sg13g2_a21oi_1 _1503_ (.A1(_1200_),
 ...
 sg13g2_nor2_1 _1507_ (.A(_1187_),
    .B(_1208_),
    .Y(_1211_));
 sg13g2_nand3_1 _1508_ (.B(net613),
    .C(net610),
    .A(_1094_),
    .Y(_1212_));
 ...
 sg13g2_o21ai_1 _1510_ (.B1(_1213_),
    ...
    .A1(_1210_),
    .A2(_1211_));
 sg13g2_a21oi_1 _1511_ (.A1(_1091_),
    .A2(_1113_),
    .Y(_1215_),
    .B1(net1056));
 ...
 sg13g2_inv_1 _1516_ (.Y(_1219_),
    .A(_0025_));
 sg13g2_a21oi_1 _1517_ (.A1(_1091_),
    .A2(_1219_),
    .Y(_1220_),
    .B1(net1056));
 ...
 sg13g2_xnor2_1 _1519_ (.Y(_1221_),
    .A(_1192_),
    .B(_1205_));
 sg13g2_a21oi_1 _1520_ (.A1(_1091_),
    .A2(_1114_),
    .Y(_1222_),
    .B1(net1056));
 ...
 sg13g2_nor3_1 _1525_ (.A(_1204_),
    ...
    .C(_1217_),
    .Y(_1226_));
 sg13g2_nor2_1 _1526_ (.A(net1056),
    .B(_1226_),
    .Y(_1227_));
 sg13g2_o21ai_1 _1527_ (.B1(_1227_),
    ...
    .A1(_0027_),
    .A2(net1058));
 sg13g2_a21oi_1 _1528_ (.A1(_1091_),
    .A2(_1119_),
    .Y(_1228_),
    .B1(net1056));
 ...
 sg13g2_o21ai_1 _1531_ (.B1(net1071),
    .Y(_1230_),
    .A1(net1099),
    .A2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_70_));
 sg13g2_a21oi_1 _1532_ (.A1(net1099),
    .A2(_1229_),
    .Y(_1231_),
    .B1(_1230_));
 sg13g2_nor2_1 _1533_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_0_),
    .B(net1070),
    .Y(_1232_));
 sg13g2_inv_1 _1535_ (.Y(_1234_),
    .A(_1232_));
 sg13g2_nor2b_1 _1536_ (.A(net1054),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_86_),
    .Y(_1235_));
 sg13g2_nor2_1 _1537_ (.A(_1201_),
    .B(_1223_),
    .Y(_1236_));
 sg13g2_inv_2 _1539_ (.Y(_1238_),
    .A(_1236_));
 sg13g2_nor2b_1 _1540_ (.A(_1238_),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_94_),
    .Y(_1239_));
 sg13g2_nor4_1 _1541_ (.A(net1095),
    .B(_1231_),
    .C(_1235_),
    .D(_1239_),
    .Y(_1240_));
 ...
 sg13g2_o21ai_1 _1543_ (.B1(net1071),
    .Y(_1242_),
    .A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_110_),
    .A2(net1069));
 sg13g2_a21oi_1 _1544_ (.A1(net1069),
    .A2(_1241_),
    .Y(_1243_),
    .B1(_1242_));
 sg13g2_nor2b_1 _1545_ (.A(_1238_),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_126_),
    .Y(_1244_));
 sg13g2_nor2b_1 _1546_ (.A(net1054),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_118_),
    .Y(_1245_));
 sg13g2_nor4_1 _1547_ (.A(net1074),
    .B(_1243_),
    .C(_1244_),
    .D(_1245_),
    .Y(_1246_));
 sg13g2_o21ai_1 _1548_ (.B1(net1093),
    .Y(_1247_),
    .A1(_1240_),
    .A2(_1246_));
 ...
 sg13g2_o21ai_1 _1555_ (.B1(_1201_),
    .Y(_1254_),
    .A1(net1101),
    .A2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_6_));
 sg13g2_a21oi_1 _1556_ (.A1(net1101),
    .A2(_1253_),
    .Y(_1255_),
    .B1(_1254_));
 sg13g2_nor2b_1 _1557_ (.A(net1054),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_22_),
    .Y(_1256_));
 sg13g2_nor2b_1 _1558_ (.A(net1052),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_30_),
    .Y(_1257_));
 sg13g2_nor4_1 _1559_ (.A(net1094),
    .B(_1255_),
    .C(_1256_),
    .D(_1257_),
    .Y(_1258_));
 sg13g2_o21ai_1 _1560_ (.B1(net1075),
    .Y(_1259_),
    .A1(_1252_),
    .A2(_1258_));
 ...
 sg13g2_nand3_1 _1564_ (.B(_1259_),
    ...
    .A(_1247_),
    .Y(_1263_));
 sg13g2_a21oi_1 _1565_ (.A1(_1091_),
    .A2(reg2hw_39_),
    .Y(_1264_),
    .B1(net1056));
 sg13g2_nand2_1 _1566_ (.Y(net648),
    .A(_1263_),
    .B(_1264_));
 sg13g2_inv_1 _1567_ (.Y(_1265_),
    .A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_2_));
 sg13g2_nor2_1 _1568_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_2_),
    .B(_1265_),
    .Y(_1266_));
 sg13g2_inv_2 _1569_ (.Y(_1267_),
    .A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_2_));
 sg13g2_nor2_1 _1570_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_2_),
    .B(_1267_),
    .Y(_1268_));
 ...
 sg13g2_o21ai_1 _1603_ (.B1(net1072),
    .Y(_1301_),
    .A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_8_),
    .A2(net1068));
 sg13g2_a21oi_1 _1604_ (.A1(net1068),
    .A2(_1300_),
    .Y(_1302_),
    .B1(_1301_));
 sg13g2_nor2b_1 _1605_ (.A(net1053),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_16_),
    .Y(_1303_));
 sg13g2_nor2b_1 _1606_ (.A(net1051),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_24_),
    .Y(_1304_));
 sg13g2_nor4_1 _1607_ (.A(net1094),
    .B(_1302_),
    .C(_1303_),
    .D(_1304_),
    .Y(_1305_));
 sg13g2_o21ai_1 _1608_ (.B1(net1075),
    .Y(_1306_),
    .A1(_1299_),
    .A2(_1305_));
 sg13g2_nand3_1 _1609_ (.B(_1306_),
    ...
    .A(_1293_),
    .Y(_1307_));
 sg13g2_nand2_1 _1610_ (.Y(net638),
    .A(_1280_),
    .B(_1307_));
 ...
 sg13g2_o21ai_1 _1628_ (.B1(net1072),
    .Y(_1325_),
    .A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_12_),
    .A2(net1068));
 sg13g2_a21oi_1 _1629_ (.A1(net1068),
    .A2(_1324_),
    .Y(_1326_),
    .B1(_1325_));
 sg13g2_nor2b_1 _1630_ (.A(net1051),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_28_),
    .Y(_1327_));
 sg13g2_nor2b_1 _1631_ (.A(net1053),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_20_),
    .Y(_1328_));
 sg13g2_nor4_1 _1632_ (.A(net1094),
    .B(_1326_),
    .C(_1327_),
    .D(_1328_),
    .Y(_1329_));
 sg13g2_o21ai_1 _1633_ (.B1(net1075),
    .Y(_1330_),
    .A1(_1323_),
    .A2(_1329_));
 ...
 sg13g2_a22oi_1 _1636_ (.Y(_1333_),
    ...
    .A2(reg2hw_37_),
    .A1(net1063));
 sg13g2_nand3_1 _1637_ (.B(net1034),
    .C(_1333_),
    .A(_1331_),
    .Y(net646));
 ...
 sg13g2_nor2_1 _1639_ (.A(_1097_),
    .B(_1278_),
    .Y(_1335_));
 sg13g2_nand3_1 _1640_ (.B(net613),
    .C(_1260_),
    .A(_1094_),
    .Y(_1336_));
 sg13g2_a21oi_1 _1641_ (.A1(_1335_),
    ...
    .Y(_1337_),
    .B1(net587));
 sg13g2_nand3_1 _1642_ (.B(net590),
    .C(net587),
    .A(net601),
    .Y(_1338_));
 ...
 sg13g2_o21ai_1 _1644_ (.B1(_1339_),
    ...
    .A1(net612),
    .A2(_1093_));
 sg13g2_o21ai_1 _1645_ (.B1(net614),
    .Y(_1341_),
    .A1(_1337_),
    .A2(_1340_));
 ...
 sg13g2_nor4_1 _1647_ (.A(_1260_),
    ...
    .D(_1342_),
    .Y(_1343_));
 sg13g2_mux2_1 _1649_ (.A0(reg2hw_11_),
    .A1(net588),
    .S(net1030),
    .X(_0053_));
 sg13g2_mux2_1 _1650_ (.A0(reg2hw_10_),
    .A1(net621),
    .S(net1030),
    .X(_0054_));
 sg13g2_mux2_1 _1651_ (.A0(reg2hw_9_),
    .A1(net620),
    .S(net1030),
    .X(_0055_));
 sg13g2_mux2_1 _1652_ (.A0(reg2hw_8_),
    .A1(net619),
    .S(net1030),
    .X(_0056_));
 sg13g2_mux2_1 _1653_ (.A0(reg2hw_7_),
    .A1(net618),
    .S(net1030),
    .X(_0057_));
 sg13g2_mux2_1 _1654_ (.A0(reg2hw_6_),
    .A1(net617),
    .S(net1171),
    .X(_0058_));
 sg13g2_mux2_1 _1655_ (.A0(reg2hw_5_),
    .A1(net616),
    .S(net1030),
    .X(_0059_));
 sg13g2_inv_1 _1656_ (.Y(_1344_),
    .A(_0018_));
 sg13g2_nor3_1 _1657_ (.A(net1058),
    .B(_1334_),
    .C(_1342_),
    .Y(_1345_));
 ...
 sg13g2_inv_2 _1692_ (.Y(_0349_),
    .A(reg2hw_34_));
 sg13g2_nor2_2 _1693_ (.A(u_uart_core_uart_tx_bit_cnt_q_0_),
 ...
 sg13g2_xnor2_1 _1709_ (.Y(_0366_),
    .A(_0348_),
    .B(_0350_));
 sg13g2_nand3_1 _1710_ (.B(_0360_),
    .C(_0366_),
    .A(net1013),
    .Y(_0367_));
 ...
 sg13g2_a21oi_1 _1713_ (.A1(u_uart_core_uart_tx_bit_cnt_q_0_),
    .A2(reg2hw_34_),
    .Y(_0369_),
    .B1(_0363_));
 ...
 sg13g2_xnor2_1 _1728_ (.Y(_0079_),
    ...
    .B(_0379_));
 sg13g2_xor2_1 _1729_ (.B(u_uart_core_nco_sum_q_16_),
    .A(u_uart_core_uart_tx_baud_div_q_0_),
    .X(_0080_));
 ...
 sg13g2_xor2_1 _1746_ (.B(reg2hw_39_),
 ...
 sg13g2_a21oi_1 _1784_ (.A1(_0395_),
    ...
    .Y(_0426_),
    .B1(_0422_));
 sg13g2_o21ai_1 _1785_ (.B1(_0403_),
    .Y(_0427_),
    .A1(_0424_),
    .A2(_0426_));
 sg13g2_o21ai_1 _1786_ (.B1(_0427_),
    ...
    .A1(_0422_),
    .A2(_0423_));
 sg13g2_nor2_1 _1787_ (.A(u_uart_core_uart_rx_bit_cnt_q_1_),
    .B(_0425_),
    .Y(_0428_));
 ...
 sg13g2_nand3_1 _1790_ (.B(_0429_),
    ...
    .A(_0403_),
    .Y(_0431_));
 sg13g2_a21oi_1 _1791_ (.A1(u_uart_core_uart_rx_bit_cnt_q_1_),
    .A2(_0402_),
    .Y(_0432_),
    .B1(_0393_));
 ...
 sg13g2_nor2_1 _1810_ (.A(_0443_),
    .B(_0445_),
    .Y(_0446_));
 sg13g2_nor2_1 _1811_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_2_),
    .B(_0446_),
    .Y(_0447_));
 ...
 sg13g2_inv_1 _1819_ (.Y(_0454_),
    .A(_0445_));
 sg13g2_nor2_1 _1820_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_1_),
    .B(_0454_),
    .Y(_0455_));
 sg13g2_nor3_1 _1821_ (.A(_0446_),
    ...
    .C(_0455_),
    .Y(_0097_));
 sg13g2_nor2_1 _1822_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_0_),
    .B(_0444_),
    .Y(_0456_));
 sg13g2_nor3_1 _1823_ (.A(_0450_),
    .B(_0456_),
    .C(_0454_),
    .Y(_0098_));
 sg13g2_inv_1 _1824_ (.Y(_0457_),
    .A(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_62_));
 sg13g2_nor2_1 _1825_ (.A(net1119),
    .B(net1012),
    .Y(_0458_));
 ...
 sg13g2_nor2_1 _1828_ (.A(net1120),
    .B(net1011),
    .Y(_0460_));
 ...
 sg13g2_nor2_1 _1831_ (.A(net1121),
    .B(net1011),
    .Y(_0462_));
 ...
 sg13g2_nor2_1 _1834_ (.A(net1122),
    .B(net1011),
    .Y(_0464_));
 ...
 sg13g2_nor2_1 _1837_ (.A(net1123),
    .B(net1011),
    .Y(_0466_));
 ...
 sg13g2_nor2_1 _1840_ (.A(net1124),
    .B(_0451_),
    .Y(_0468_));
 ...
 sg13g2_nor2_1 _1843_ (.A(net1125),
    .B(_0451_),
    .Y(_0470_));
 ...
 sg13g2_nand2_1 _1956_ (.Y(_0533_),
    .A(_0532_),
    .B(net1080));
 sg13g2_nor2_1 _1957_ (.A(_1265_),
    .B(_0533_),
    .Y(_0534_));
 sg13g2_inv_1 _1958_ (.Y(_0535_),
    .A(_0533_));
 sg13g2_nor2_1 _1959_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_2_),
    .B(_0535_),
    .Y(_0536_));
 sg13g2_nor3_1 _1960_ (.A(_0450_),
    .B(_0534_),
    .C(_0536_),
    .Y(_0155_));
 sg13g2_nor2_1 _1961_ (.A(net1080),
    .B(_0532_),
    .Y(_0537_));
 sg13g2_nor3_1 _1962_ (.A(_0450_),
    .B(_0537_),
    .C(_0535_),
    .Y(_0156_));
 sg13g2_nor2_1 _1963_ (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_0_),
    .B(_0373_),
    .Y(_0538_));
 sg13g2_nor3_1 _1964_ (.A(_0450_),
    .B(_0538_),
    .C(_0532_),
    .Y(_0157_));
 ...
 sg13g2_xnor2_1 _1967_ (.Y(_0541_),
    .A(u_uart_core_uart_rx_sreg_q_1_),
    .B(reg2hw_40_));
 sg13g2_xor2_1 _1968_ (.B(u_uart_core_uart_rx_sreg_q_2_),
    .A(u_uart_core_uart_rx_sreg_q_3_),
    .X(_0542_));
 sg13g2_xor2_1 _1969_ (.B(_0542_),
    .A(_0541_),
    .X(_0543_));
 sg13g2_xor2_1 _1970_ (.B(u_uart_core_uart_rx_sreg_q_9_),
    .A(u_uart_core_uart_rx_sreg_q_8_),
    .X(_0544_));
 ...
 sg13g2_inv_1 _1986_ (.Y(_0560_),
    .A(_0555_));
 sg13g2_nor2_1 _1987_ (.A(net1091),
    .B(_0560_),
    .Y(_0561_));
 sg13g2_nor3_1 _1988_ (.A(_0556_),
    .B(_0559_),
    .C(_0561_),
    .Y(_0158_));
 ...
 sg13g2_nor2_1 _1991_ (.A(_0563_),
    .B(_0560_),
    .Y(_0159_));
 sg13g2_nor2_1 _1992_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_1_),
    .B(_0552_),
    .Y(_0564_));
 ...
 sg13g2_a21oi_1 _1995_ (.A1(_1203_),
    ...
    .Y(_0161_),
    .B1(_0565_));
 sg13g2_nor2_1 _1996_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_1_),
    .B(_0553_),
    .Y(_0566_));
 sg13g2_inv_4 _1997_ (.A(net1092),
    .Y(_0567_));
 sg13g2_nand3_1 _1998_ (.B(net1091),
    .C(_0567_),
    .A(_0566_),
    .Y(_0568_));
 ...
 sg13g2_o21ai_1 _2034_ (.B1(_0597_),
    ...
    .A1(_0568_),
    .A2(net1038));
 sg13g2_nor3_1 _2035_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_0_),
    .B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_1_),
    .C(_0551_),
    .Y(_0598_));
 sg13g2_nand3_1 _2036_ (.B(net1091),
    .C(_0567_),
    .A(_0598_),
    .Y(_0599_));
 ...
 sg13g2_o21ai_1 _2067_ (.B1(_0616_),
    ...
    .A1(net1037),
    .A2(net978));
 sg13g2_nor3_1 _2068_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_0_),
    .B(_0539_),
    .C(_0551_),
    .Y(_0617_));
 sg13g2_nand3_1 _2069_ (.B(net1076),
    .C(net1092),
    .A(_0617_),
    .Y(_0618_));
 ...
 sg13g2_o21ai_1 _2084_ (.B1(_0626_),
    ...
    .A1(net1037),
    .A2(net1006));
 sg13g2_nand3_1 _2085_ (.B(net1076),
    .C(net1092),
    .A(_0566_),
    .Y(_0627_));
 ...
 sg13g2_o21ai_1 _2100_ (.B1(_0635_),
    ...
    .A1(net1037),
    .A2(net990));
 sg13g2_nand3_1 _2101_ (.B(net1076),
    .C(net1092),
    .A(_0598_),
    .Y(_0636_));
 ...
 sg13g2_o21ai_1 _2116_ (.B1(_0644_),
    ...
    .A1(net1037),
    .A2(net1004));
 sg13g2_nand3_1 _2117_ (.B(net1076),
    .C(_0567_),
    .A(_0554_),
    .Y(_0645_));
 ...
 sg13g2_o21ai_1 _2132_ (.B1(_0653_),
    ...
    .A1(net1037),
    .A2(net988));
 sg13g2_nand3_1 _2133_ (.B(net1076),
    .C(_0567_),
    .A(_0617_),
    .Y(_0654_));
 ...
 sg13g2_o21ai_1 _2148_ (.B1(_0662_),
    ...
    .A1(net1037),
    .A2(net1002));
 sg13g2_nand3_1 _2149_ (.B(net1076),
    .C(_0567_),
    .A(_0566_),
    .Y(_0663_));
 ...
 sg13g2_nor2_1 _2165_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_126_),
    .B(net980),
    .Y(_0672_));
 sg13g2_a21oi_1 _2166_ (.A1(net980),
    .A2(net1049),
    .Y(_0225_),
    .B1(_0672_));
 sg13g2_nor2_1 _2167_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_125_),
    .B(net979),
    .Y(_0673_));
 sg13g2_a21oi_1 _2168_ (.A1(net979),
    .A2(net1048),
    .Y(_0226_),
    .B1(_0673_));
 sg13g2_nor2_1 _2169_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_124_),
    .B(net980),
    .Y(_0674_));
 sg13g2_a21oi_1 _2170_ (.A1(net980),
    .A2(net1045),
    .Y(_0227_),
    .B1(_0674_));
 sg13g2_nor2_1 _2171_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_123_),
    .B(net979),
    .Y(_0675_));
 sg13g2_a21oi_1 _2172_ (.A1(net979),
    .A2(net1044),
    .Y(_0228_),
    .B1(_0675_));
 sg13g2_nor2_1 _2173_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_122_),
    .B(net980),
    .Y(_0676_));
 sg13g2_a21oi_1 _2174_ (.A1(net980),
    .A2(_0587_),
    .Y(_0229_),
    .B1(_0676_));
 sg13g2_nor2_1 _2175_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_121_),
    .B(net979),
    .Y(_0677_));
 sg13g2_a21oi_1 _2176_ (.A1(net979),
    .A2(net1040),
    .Y(_0230_),
    .B1(_0677_));
 sg13g2_nor2_1 _2177_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_120_),
    .B(_0556_),
    .Y(_0678_));
 sg13g2_a21oi_1 _2178_ (.A1(net980),
    .A2(net1038),
    .Y(_0231_),
    .B1(_0678_));
 sg13g2_nand3_1 _2179_ (.B(net1091),
    .C(net1092),
    .A(_0617_),
    .Y(_0679_));
 ...
 sg13g2_o21ai_1 _2194_ (.B1(_0687_),
    ...
    .A1(net1038),
    .A2(_0679_));
 sg13g2_nand3_1 _2195_ (.B(net1091),
    .C(net1092),
    .A(_0566_),
    .Y(_0688_));
 ...
 sg13g2_o21ai_1 _2210_ (.B1(_0696_),
    ...
    .A1(net1038),
    .A2(_0688_));
 sg13g2_nand3_1 _2211_ (.B(net1091),
    .C(net1092),
    .A(_0598_),
    .Y(_0697_));
 ...
 sg13g2_o21ai_1 _2226_ (.B1(_0705_),
    ...
    .A1(net1038),
    .A2(net997));
 sg13g2_nand3_1 _2227_ (.B(net1091),
    .C(_0567_),
    .A(_0554_),
    .Y(_0706_));
 ...
 sg13g2_o21ai_1 _2242_ (.B1(_0714_),
    ...
    .A1(net1038),
    .A2(_0706_));
 sg13g2_nand3_1 _2243_ (.B(net1091),
    .C(_0567_),
    .A(_0617_),
    .Y(_0715_));
 ...
 sg13g2_o21ai_1 _2258_ (.B1(_0723_),
    ...
    .A1(net1038),
    .A2(net995));
 sg13g2_nand3_1 _2259_ (.B(net1076),
    .C(_0567_),
    .A(_0598_),
    .Y(_0724_));
 ...
 sg13g2_inv_1 _2279_ (.Y(_0737_),
    .A(_0736_));
 sg13g2_nor2_1 _2280_ (.A(net1052),
    .B(_0737_),
    .Y(_0738_));
 sg13g2_nand2_1 _2281_ (.Y(_0739_),
    .A(_0738_),
    .B(net1094));
 sg13g2_nor2_1 _2282_ (.A(net1075),
    .B(_0739_),
    .Y(_0740_));
 sg13g2_inv_1 _2283_ (.Y(_0741_),
    .A(_0739_));
 sg13g2_nor2_1 _2284_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_3_),
    .B(_0741_),
    .Y(_0742_));
 sg13g2_nor3_1 _2285_ (.A(_0559_),
    ...
    .C(_0742_),
    .Y(_0274_));
 sg13g2_nor2_1 _2286_ (.A(net1094),
    .B(_0738_),
    .Y(_0743_));
 ...
 sg13g2_o21ai_1 _2290_ (.B1(_0736_),
    ...
    .A1(net1075),
    .A2(_0739_));
 sg13g2_nand3_1 _2291_ (.B(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .C(_0562_),
    .A(_0737_),
    .Y(_0747_));
 ...
 sg13g2_nor2_1 _2316_ (.A(_0768_),
    .B(net1032),
    .Y(_0769_));
 sg13g2_o21ai_1 _2317_ (.B1(net1013),
    .Y(_0770_),
    .A1(_0751_),
    .A2(_0769_));
 ...
 sg13g2_nand2_1 _2346_ (.Y(_0797_),
    .A(_0791_),
    .B(_0796_));
 sg13g2_nor2b_1 _2347_ (.A(net1032),
    .B_N(_0797_),
    .Y(_0798_));
 sg13g2_o21ai_1 _2348_ (.B1(net1013),
    .Y(_0799_),
    .A1(_0786_),
    .A2(_0798_));
 ...
 sg13g2_nand2_1 _2362_ (.Y(_0812_),
    .A(_0806_),
    .B(_0811_));
 sg13g2_nor2b_1 _2363_ (.A(net1032),
    .B_N(_0812_),
    .Y(_0813_));
 sg13g2_o21ai_1 _2364_ (.B1(net1013),
    .Y(_0814_),
    .A1(_0801_),
    .A2(_0813_));
 ...
 sg13g2_nand2_1 _2378_ (.Y(_0827_),
    .A(_0821_),
    .B(_0826_));
 sg13g2_nor2b_1 _2379_ (.A(net1032),
    .B_N(_0827_),
    .Y(_0828_));
 sg13g2_o21ai_1 _2380_ (.B1(net1013),
    .Y(_0829_),
    .A1(_0816_),
    .A2(_0828_));
 ...
 sg13g2_nor2b_1 _2401_ (.A(net1066),
    .B_N(_0847_),
    .Y(_0848_));
 ...
 sg13g2_nor2b_1 _2408_ (.A(net1077),
    .B_N(_0854_),
    .Y(_0855_));
 ...
 sg13g2_nor2_1 _2410_ (.A(_0856_),
    .B(_0360_),
    .Y(_0857_));
 sg13g2_o21ai_1 _2411_ (.B1(net1013),
    .Y(_0858_),
    .A1(_0845_),
    .A2(_0857_));
 ...
 sg13g2_inv_1 _2428_ (.Y(_0873_),
    .A(_0037_));
 sg13g2_o21ai_1 _2429_ (.B1(net1013),
    .Y(_0874_),
    .A1(_0036_),
    .A2(_0362_));
 ...
 sg13g2_nor4_1 _2448_ (.A(u_uart_core_uart_rx_bit_cnt_q_2_),
    ...
    .D(_0429_),
    .Y(_0000_));
 sg13g2_nor3_2 _2449_ (.A(net1165),
    .B(net1149),
    .C(_1342_),
 ...
 sg13g2_nor2_1 _2469_ (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_127_),
    .B(net979),
    .Y(_0902_));
 sg13g2_a21oi_1 _2470_ (.A1(net979),
    .A2(net1035),
    .Y(_0295_),
    .B1(_0902_));
 ...
 sg13g2_o21ai_1 _2510_ (.B1(_0923_),
    ...
    .A1(_0915_),
    .A2(net1012));
 sg13g2_nor2b_1 _2511_ (.A(_0451_),
 ...
 sg13g2_nand2_1 _2549_ (.Y(_0945_),
    ...
    .B(net616));
 sg13g2_o21ai_1 _2550_ (.B1(net1162),
    .Y(_0331_),
    .A1(_0558_),
 ...
 sg13g2_nand2_1 _2551_ (.Y(_0946_),
    .A(u_uart_reg_u_reg_core_fifo_ctrl_flds_we_0_),
    .B(net617));
 sg13g2_o21ai_1 _2552_ (.B1(net1157),
    .Y(_0332_),
    .A1(_0448_),
    .A2(u_uart_reg_u_reg_core_fifo_ctrl_flds_we_0_));
 ...
 sg13g2_a21oi_1 _2555_ (.A1(_1341_),
    ...
    .Y(net627),
    .B1(_0733_));
 sg13g2_o21ai_1 _2556_ (.B1(net1033),
    .Y(net642),
    .A1(_0938_),
    .A2(net1058));
 sg13g2_nor2b_1 _2557_ (.A(_0933_),
    ...
    .Y(_1350_));
 sg13g2_o21ai_1 _2558_ (.B1(net1034),
    .Y(net633),
    .A1(_1136_),
    .A2(net1058));
 ...
 sg13g2_a21oi_1 _2568_ (.A1(_0953_),
    ...
    .Y(_0957_),
    .B1(net1095));
 sg13g2_nor3_1 _2569_ (.A(net1093),
    .B(_0952_),
    .C(_0957_),
    .Y(_0958_));
 ...
 sg13g2_o21ai_1 _2576_ (.B1(net1071),
    .Y(_0965_),
    .A1(net1099),
    .A2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_71_));
 sg13g2_a21oi_1 _2577_ (.A1(net1099),
    .A2(_0964_),
    .Y(_0966_),
    .B1(_0965_));
 sg13g2_nor2b_1 _2578_ (.A(net1054),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_87_),
    .Y(_0967_));
 sg13g2_nor2b_1 _2579_ (.A(_1238_),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_95_),
    .Y(_0968_));
 sg13g2_nor4_1 _2580_ (.A(net1095),
    .B(_0966_),
    .C(_0967_),
    .D(_0968_),
    .Y(_0969_));
 sg13g2_o21ai_1 _2581_ (.B1(net1093),
    .Y(_0970_),
    .A1(_0963_),
    .A2(_0969_));
 sg13g2_nand2_1 _2582_ (.Y(_0971_),
    .A(_0970_),
    .B(_1262_));
 sg13g2_a21oi_1 _2583_ (.A1(net1063),
    .A2(reg2hw_40_),
    .Y(_0972_),
    .B1(net624));
 ...
 sg13g2_nor3_1 _2606_ (.A(_1195_),
    ...
    .C(_0993_),
    .Y(_0994_));
 sg13g2_o21ai_1 _2607_ (.B1(_1262_),
    .Y(_0995_),
    .A1(_0983_),
    .A2(_0994_));
 ...
 sg13g2_o21ai_1 _2623_ (.B1(net1072),
    .Y(_1010_),
    .A1(net1101),
    .A2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_2_));
 sg13g2_a21oi_1 _2624_ (.A1(net1101),
    .A2(_1009_),
    .Y(_1011_),
    .B1(_1010_));
 sg13g2_nor2b_1 _2625_ (.A(net1053),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_18_),
    .Y(_1012_));
 sg13g2_nor2b_1 _2626_ (.A(net1051),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_26_),
    .Y(_1013_));
 sg13g2_nor4_1 _2627_ (.A(net1094),
    .B(_1011_),
    .C(_1012_),
    .D(_1013_),
    .Y(_1014_));
 sg13g2_o21ai_1 _2628_ (.B1(net1075),
    .Y(_1015_),
    .A1(_1008_),
    .A2(_1014_));
 ...
 sg13g2_o21ai_1 _2635_ (.B1(net1071),
    .Y(_1022_),
    .A1(net1099),
    .A2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_66_));
 sg13g2_a21oi_1 _2636_ (.A1(net1099),
    .A2(_1021_),
    .Y(_1023_),
    .B1(_1022_));
 sg13g2_nor2b_1 _2637_ (.A(net1054),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_82_),
    .Y(_1024_));
 sg13g2_nor2b_1 _2638_ (.A(_1238_),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_90_),
    .Y(_1025_));
 sg13g2_nor4_1 _2639_ (.A(net1095),
    .B(_1023_),
    .C(_1024_),
    .D(_1025_),
    .Y(_1026_));
 sg13g2_o21ai_1 _2640_ (.B1(net1093),
    .Y(_1027_),
    .A1(_1020_),
    .A2(_1026_));
 ...
 sg13g2_nand3_1 _2644_ (.B(_1213_),
    ...
    .A(_1030_),
    .Y(_1031_));
 sg13g2_a21oi_1 _2645_ (.A1(net1063),
    .A2(reg2hw_36_),
    .Y(_1032_),
    .B1(net624));
 ...
 sg13g2_o21ai_1 _2653_ (.B1(_1201_),
    .Y(_1039_),
    .A1(net1101),
    .A2(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_33_));
 sg13g2_a21oi_1 _2654_ (.A1(net1101),
    .A2(_1038_),
    .Y(_1040_),
    .B1(_1039_));
 sg13g2_nor2b_1 _2655_ (.A(net1054),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_49_),
    .Y(_1041_));
 sg13g2_nor2b_1 _2656_ (.A(net1052),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_57_),
    .Y(_1042_));
 sg13g2_nor4_1 _2657_ (.A(net1073),
    .B(_1040_),
    .C(_1041_),
    .D(_1042_),
    .Y(_1043_));
 sg13g2_o21ai_1 _2658_ (.B1(net1075),
    .Y(_1044_),
    .A1(_1037_),
    .A2(_1043_));
 ...
 sg13g2_a221oi_1 _2668_ (.B2(_1052_),
    ...
    .Y(_1054_),
    .A2(net1059));
 sg13g2_o21ai_1 _2669_ (.B1(net1093),
    .Y(_1055_),
    .A1(_1049_),
    .A2(_1054_));
 ...
 sg13g2_a21o_1 _2671_ (.A2(_0044_),
    ...
    .B1(_1277_),
    .X(_1057_));
 sg13g2_nor2b_1 _2672_ (.A(_1212_),
    .B_N(_0997_),
    .Y(_1058_));
 sg13g2_o21ai_1 _2673_ (.B1(_1058_),
    ...
    .A1(_1270_),
    .A2(_0996_));
 sg13g2_a21oi_1 _2674_ (.A1(net1063),
    .A2(reg2hw_35_),
    .Y(_1060_),
    .B1(net624));
 ...
 sg13g2_o21ai_1 _2695_ (.B1(net1072),
    .Y(_1080_),
    .A1(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_13_),
    .A2(net1068));
 sg13g2_a21oi_1 _2696_ (.A1(net1068),
    .A2(_1079_),
    .Y(_1081_),
    .B1(_1080_));
 sg13g2_nor2b_1 _2697_ (.A(net1053),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_21_),
    .Y(_1082_));
 sg13g2_nor2b_1 _2698_ (.A(net1051),
    .B_N(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_29_),
    .Y(_1083_));
 sg13g2_nor4_1 _2699_ (.A(net1094),
    .B(_1081_),
    .C(_1082_),
    .D(_1083_),
    .Y(_1084_));
 sg13g2_o21ai_1 _2700_ (.B1(net1075),
    .Y(_1085_),
    .A1(_1078_),
    .A2(_1084_));
 sg13g2_nand3b_1 _2701_ (.B(_1085_),
    ...
    .Y(_1086_),
    .A_N(_1072_));
 sg13g2_nand3_1 _2702_ (.B(net1034),
    .C(_1086_),
    .A(_1061_),
    .Y(net647));
 sg13g2_dfrbpq_1 _2703_ (.RESET_B(net1117),
    .D(_0322_),
    .Q(_0047_),
    .CLK(clknet_leaf_19_clk_i));
 sg13g2_dfrbpq_1 _2704_ (.RESET_B(net1104),
    .D(_0323_),
    .Q(reg2hw_38_),
    .CLK(clknet_leaf_15_clk_i));
 sg13g2_dfrbpq_1 _2705_ (.RESET_B(net1107),
    .D(_0074_),
    .Q(_0028_),
    .CLK(clknet_leaf_12_clk_i));
 sg13g2_dfrbpq_1 _2706_ (.RESET_B(net1107),
    .D(_0073_),
    .Q(_0027_),
    .CLK(clknet_leaf_11_clk_i));
 sg13g2_dfrbpq_1 _2707_ (.RESET_B(reg_rst_ni),
    .D(_0072_),
    .Q(_0026_),
    .CLK(clknet_leaf_11_clk_i));
 sg13g2_dfrbpq_1 _2708_ (.RESET_B(reg_rst_ni),
    .D(_0071_),
    .Q(_0025_),
    .CLK(clknet_leaf_11_clk_i));
 sg13g2_dfrbpq_1 _2709_ (.RESET_B(reg_rst_ni),
    .D(_0070_),
    .Q(_0024_),
    .CLK(clknet_leaf_11_clk_i));
 sg13g2_dfrbpq_1 _2710_ (.RESET_B(net1107),
    .D(_0069_),
    .Q(_0023_),
    .CLK(clknet_leaf_11_clk_i));
 sg13g2_dfrbpq_1 _2711_ (.RESET_B(net1107),
    .D(_0068_),
    .Q(_0022_),
    .CLK(clknet_leaf_15_clk_i));
 sg13g2_dfrbpq_1 _2712_ (.RESET_B(net1107),
    .D(_0067_),
    .Q(reg2hw_48_),
    .CLK(clknet_leaf_16_clk_i));
 sg13g2_dfrbpq_1 _2713_ (.RESET_B(net1103),
    .D(net1139),
    .Q(_0021_),
    .CLK(clknet_leaf_16_clk_i));
 sg13g2_dfrbpq_1 _2714_ (.RESET_B(net1103),
    .D(net1142),
    .Q(_0020_),
    .CLK(clknet_leaf_16_clk_i));
 sg13g2_dfrbpq_1 _2715_ (.RESET_B(net1103),
    .D(_0064_),
    .Q(reg2hw_51_),
    .CLK(clknet_leaf_17_clk_i));
 sg13g2_dfrbpq_2 _2716_ (.RESET_B(net1103),
    .D(_0063_),
    .Q(_0019_),
    .CLK(clknet_leaf_17_clk_i));
 sg13g2_dfrbpq_1 _2717_ (.RESET_B(net1103),
    .D(_0062_),
    .Q(reg2hw_53_),
    .CLK(clknet_leaf_18_clk_i));
 sg13g2_dfrbpq_1 _2718_ (.RESET_B(net1103),
    .D(_0061_),
    .Q(reg2hw_54_),
    .CLK(clknet_leaf_18_clk_i));
 sg13g2_dfrbpq_1 _2719_ (.RESET_B(net1103),
    .D(_0060_),
    .Q(_0018_),
    .CLK(clknet_leaf_17_clk_i));
 sg13g2_dfrbpq_1 _2720_ (.RESET_B(net1103),
    .D(net1136),
    .Q(reg2hw_56_),
    .CLK(clknet_leaf_16_clk_i));
 sg13g2_dfrbpq_1 _2721_ (.RESET_B(net1104),
    .D(_0325_),
    .Q(reg2hw_36_),
    .CLK(clknet_leaf_20_clk_i));
 sg13g2_dfrbpq_1 _2722_ (.RESET_B(net1106),
    .D(_0326_),
    .Q(reg2hw_39_),
    .CLK(clknet_leaf_23_clk_i));
 sg13g2_dfrbpq_1 _2723_ (.RESET_B(net1106),
    .D(_0327_),
    .Q(reg2hw_40_),
    .CLK(clknet_leaf_22_clk_i));
 sg13g2_dfrbpq_1 _2724_ (.RESET_B(net1104),
    .D(_0328_),
    .Q(reg2hw_35_),
    .CLK(clknet_leaf_22_clk_i));
 sg13g2_dfrbpq_1 _2725_ (.RESET_B(net1104),
    .D(_0329_),
    .Q(reg2hw_37_),
    .CLK(clknet_leaf_20_clk_i));
 sg13g2_dfrbpq_1 _2726_ (.RESET_B(net1104),
    .D(_0330_),
    .Q(reg2hw_34_),
    .CLK(clknet_leaf_20_clk_i));
 sg13g2_dfrbpq_1 _2727_ (.RESET_B(net1104),
    .D(net1163),
    .Q(reg2hw_1_),
    .CLK(clknet_leaf_23_clk_i));
 sg13g2_dfrbpq_1 _2728_ (.RESET_B(net1106),
    .D(net1158),
    .Q(reg2hw_3_),
    .CLK(clknet_leaf_23_clk_i));
 sg13g2_dfrbpq_1 _2729_ (.RESET_B(net1105),
    .D(_0059_),
    .Q(reg2hw_5_),
    .CLK(clknet_leaf_25_clk_i));
 sg13g2_dfrbpq_1 _2730_ (.RESET_B(net1105),
    .D(_0058_),
    .Q(reg2hw_6_),
    .CLK(clknet_leaf_23_clk_i));
 sg13g2_dfrbpq_1 _2731_ (.RESET_B(net1105),
    .D(_0057_),
    .Q(reg2hw_7_),
    .CLK(clknet_leaf_26_clk_i));
 sg13g2_dfrbpq_1 _2732_ (.RESET_B(net1105),
    .D(_0056_),
    .Q(reg2hw_8_),
    .CLK(clknet_leaf_27_clk_i));
 sg13g2_dfrbpq_1 _2733_ (.RESET_B(net1105),
    .D(_0055_),
    .Q(reg2hw_9_),
    .CLK(clknet_leaf_21_clk_i));
 sg13g2_dfrbpq_1 _2734_ (.RESET_B(net1105),
    .D(_0054_),
    .Q(reg2hw_10_),
    .CLK(clknet_leaf_26_clk_i));
 sg13g2_dfrbpq_1 _2735_ (.RESET_B(net1105),
    .D(_0053_),
    .Q(reg2hw_11_),
    .CLK(clknet_leaf_22_clk_i));
 sg13g2_dfrbpq_1 _2736_ (.RESET_B(net1105),
    .D(_0333_),
    .Q(reg2hw_12_),
    .CLK(clknet_leaf_24_clk_i));
 sg13g2_dfrbpq_1 _2737_ (.RESET_B(net1106),
    .D(net1171),
    .Q(reg2hw_4_),
    .CLK(clknet_leaf_14_clk_i));
 sg13g2_dfrbpq_1 _2738_ (.RESET_B(net1106),
    .D(net1166),
    .Q(reg2hw_0_),
    .CLK(clknet_leaf_23_clk_i));
 sg13g2_dfrbpq_1 _2739_ (.RESET_B(net1118),
    .D(_1350_),
    .Q(u_uart_core_uart_tx_tick_baud_q),
    .CLK(clknet_leaf_19_clk_i));
 sg13g2_dfrbpq_1 _2740_ (.RESET_B(net1108),
    .D(u_uart_core_uart_rx_tick_baud_d),
    .Q(u_uart_core_rx_tick_baud),
    .CLK(clknet_leaf_20_clk_i));
 sg13g2_dfrbpq_1 _2741_ (.RESET_B(net1111),
    .D(_0000_),
    .Q(u_uart_core_rx_valid),
    .CLK(clknet_leaf_13_clk_i));
 sg13g2_dfrbpq_1 _2742_ (.RESET_B(u_uart_core_tx_rst_ni),
    .D(net388),
    .Q(_0045_),
    .CLK(clknet_leaf_22_clk_i));
 sg13g2_tiehi _2742__2 (.L_HI(net388));
 sg13g2_dfrbpq_1 _2743_ (.RESET_B(net1111),
    .D(net),
    .Q(_0044_),
    .CLK(clknet_leaf_13_clk_i));
 sg13g2_tiehi _2743__3 (.L_HI(net));
 sg13g2_dfrbpq_1 _2744_ (.RESET_B(core_rst_ni),
    .D(net389),
    .Q(u_uart_core_tx_rst_ni),
    .CLK(clknet_leaf_16_clk_i));
 sg13g2_tiehi _2744__4 (.L_HI(net389));
 sg13g2_dfrbpq_1 _2745_ (.RESET_B(core_rst_ni),
    .D(net390),
    .Q(u_uart_core_timing_rst_ni),
    .CLK(clknet_leaf_12_clk_i));
 sg13g2_tiehi _2745__5 (.L_HI(net390));
 sg13g2_dfrbpq_1 _2746_ (.RESET_B(core_rst_ni),
    .D(net391),
    .Q(u_uart_core_rx_rst_ni),
    .CLK(clknet_leaf_16_clk_i));
 sg13g2_tiehi _2746__6 (.L_HI(net391));
 sg13g2_dfrbpq_1 _2747_ (.RESET_B(net1118),
    .D(_0052_),
    .Q(_0043_),
    .CLK(clknet_leaf_17_clk_i));
 sg13g2_dfrbpq_1 _2748_ (.RESET_B(net1108),
    .D(_0041_),
    .Q(_0042_),
    .CLK(clknet_leaf_14_clk_i));
 sg13g2_dfrbpq_1 _2749_ (.RESET_B(net1109),
    .D(_0050_),
    .Q(_0041_),
    .CLK(clknet_leaf_15_clk_i));
 sg13g2_dfrbpq_1 _2750_ (.RESET_B(net1108),
    .D(_0039_),
    .Q(_0040_),
    .CLK(clknet_leaf_17_clk_i));
 sg13g2_dfrbpq_1 _2751_ (.RESET_B(net1108),
    .D(_0042_),
    .Q(_0039_),
    .CLK(clknet_leaf_17_clk_i));
 sg13g2_dfrbpq_1 _2752_ (.RESET_B(net1114),
    .D(_0002_),
    .Q(u_uart_core_nco_sum_q_0_),
    .CLK(clknet_leaf_12_clk_i));
 sg13g2_dfrbpq_1 _2753_ (.RESET_B(net1114),
    .D(_0009_),
    .Q(u_uart_core_nco_sum_q_1_),
    .CLK(clknet_leaf_11_clk_i));
 sg13g2_dfrbpq_1 _2754_ (.RESET_B(u_uart_core_timing_rst_ni),
    .D(_0010_),
    .Q(u_uart_core_nco_sum_q_2_),
    .CLK(clknet_leaf_12_clk_i));
 sg13g2_dfrbpq_1 _2755_ (.RESET_B(u_uart_core_timing_rst_ni),
    .D(_0011_),
    .Q(u_uart_core_nco_sum_q_3_),
    .CLK(clknet_leaf_12_clk_i));
 sg13g2_dfrbpq_1 _2756_ (.RESET_B(u_uart_core_timing_rst_ni),
    .D(_0012_),
    .Q(u_uart_core_nco_sum_q_4_),
    .CLK(clknet_leaf_12_clk_i));
 sg13g2_dfrbpq_1 _2757_ (.RESET_B(net1114),
    .D(_0013_),
    .Q(u_uart_core_nco_sum_q_5_),
    .CLK(clknet_leaf_11_clk_i));
 sg13g2_dfrbpq_1 _2758_ (.RESET_B(net1114),
    .D(_0014_),
    .Q(u_uart_core_nco_sum_q_6_),
    .CLK(clknet_leaf_15_clk_i));
 sg13g2_dfrbpq_1 _2759_ (.RESET_B(net1114),
    .D(_0015_),
    .Q(u_uart_core_nco_sum_q_7_),
    .CLK(clknet_leaf_15_clk_i));
 sg13g2_dfrbpq_1 _2760_ (.RESET_B(net1114),
    .D(_0016_),
    .Q(u_uart_core_nco_sum_q_8_),
    .CLK(clknet_leaf_16_clk_i));
 sg13g2_dfrbpq_1 _2761_ (.RESET_B(net1113),
    .D(_0017_),
    .Q(u_uart_core_nco_sum_q_9_),
    .CLK(clknet_leaf_16_clk_i));
 sg13g2_dfrbpq_1 _2762_ (.RESET_B(net1113),
    .D(_0003_),
    .Q(u_uart_core_nco_sum_q_10_),
    .CLK(clknet_leaf_17_clk_i));
 sg13g2_dfrbpq_1 _2763_ (.RESET_B(net1113),
    .D(_0004_),
    .Q(u_uart_core_nco_sum_q_11_),
    .CLK(clknet_leaf_18_clk_i));
 sg13g2_dfrbpq_1 _2764_ (.RESET_B(net1113),
    .D(_0005_),
    .Q(u_uart_core_nco_sum_q_12_),
    .CLK(clknet_leaf_18_clk_i));
 sg13g2_dfrbpq_1 _2765_ (.RESET_B(net1113),
    .D(_0006_),
    .Q(u_uart_core_nco_sum_q_13_),
    .CLK(clknet_leaf_18_clk_i));
 sg13g2_dfrbpq_1 _2766_ (.RESET_B(net1113),
    .D(_0007_),
    .Q(u_uart_core_nco_sum_q_14_),
    .CLK(clknet_leaf_18_clk_i));
 sg13g2_dfrbpq_1 _2767_ (.RESET_B(net1113),
    .D(_0008_),
    .Q(u_uart_core_nco_sum_q_15_),
    .CLK(clknet_leaf_18_clk_i));
 sg13g2_dfrbpq_1 _2768_ (.RESET_B(net1113),
    .D(_0001_),
    .Q(u_uart_core_nco_sum_q_16_),
    .CLK(clknet_leaf_19_clk_i));
 sg13g2_dfrbpq_1 _2769_ (.RESET_B(net622),
    .D(u_reg_reset_sync_intq),
    .Q(reg_rst_ni),
    .CLK(clknet_leaf_10_clk_i));
 sg13g2_dfrbpq_1 _2770_ (.RESET_B(net622),
    .D(net392),
    .Q(u_reg_reset_sync_intq),
    .CLK(clknet_leaf_10_clk_i));
 sg13g2_tiehi _2770__7 (.L_HI(net392));
 sg13g2_dfrbpq_1 _2771_ (.RESET_B(net622),
    .D(u_core_reset_sync_intq),
    .Q(core_rst_ni),
    .CLK(clknet_leaf_11_clk_i));
 sg13g2_dfrbpq_1 _2772_ (.RESET_B(net622),
    .D(net393),
    .Q(u_core_reset_sync_intq),
    .CLK(clknet_leaf_10_clk_i));
 sg13g2_tiehi _2772__8 (.L_HI(net393));
 sg13g2_dfrbpq_1 _2773_ (.RESET_B(net394),
    .D(_0314_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_63_),
    .CLK(clknet_leaf_32_clk_i));
 sg13g2_tiehi _2773__9 (.L_HI(net394));
 sg13g2_dfrbpq_1 _2774_ (.RESET_B(net395),
    .D(_0313_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_55_),
    .CLK(clknet_leaf_31_clk_i));
 sg13g2_tiehi _2774__10 (.L_HI(net395));
 sg13g2_dfrbpq_1 _2775_ (.RESET_B(net396),
    .D(_0312_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_47_),
    .CLK(clknet_leaf_31_clk_i));
 sg13g2_tiehi _2775__11 (.L_HI(net396));
 sg13g2_dfrbpq_1 _2776_ (.RESET_B(net397),
    .D(_0311_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_39_),
    .CLK(clknet_leaf_31_clk_i));
 sg13g2_tiehi _2776__12 (.L_HI(net397));
 sg13g2_dfrbpq_1 _2777_ (.RESET_B(net398),
    .D(_0310_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_31_),
    .CLK(clknet_leaf_31_clk_i));
 sg13g2_tiehi _2777__13 (.L_HI(net398));
 sg13g2_dfrbpq_1 _2778_ (.RESET_B(net399),
    .D(_0309_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_23_),
    .CLK(clknet_leaf_31_clk_i));
 sg13g2_tiehi _2778__14 (.L_HI(net399));
 sg13g2_dfrbpq_1 _2779_ (.RESET_B(net400),
    .D(_0308_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_15_),
    .CLK(clknet_leaf_28_clk_i));
 sg13g2_tiehi _2779__15 (.L_HI(net400));
 sg13g2_dfrbpq_1 _2780_ (.RESET_B(net401),
    .D(_0307_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_7_),
    .CLK(clknet_leaf_31_clk_i));
 sg13g2_tiehi _2780__16 (.L_HI(net401));
 sg13g2_dfrbpq_1 _2781_ (.RESET_B(net402),
    .D(_0304_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_79_),
    .CLK(clknet_leaf_39_clk_i));
 sg13g2_tiehi _2781__17 (.L_HI(net402));
 sg13g2_dfrbpq_1 _2782_ (.RESET_B(net403),
    .D(_0303_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_71_),
    .CLK(clknet_leaf_38_clk_i));
 sg13g2_tiehi _2782__18 (.L_HI(net403));
 sg13g2_dfrbpq_1 _2783_ (.RESET_B(net404),
    .D(_0302_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_63_),
    .CLK(clknet_leaf_2_clk_i));
 sg13g2_tiehi _2783__19 (.L_HI(net404));
 sg13g2_dfrbpq_1 _2784_ (.RESET_B(net405),
    .D(_0301_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_55_),
    .CLK(clknet_leaf_2_clk_i));
 sg13g2_tiehi _2784__20 (.L_HI(net405));
 sg13g2_dfrbpq_1 _2785_ (.RESET_B(net406),
    .D(_0300_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_47_),
    .CLK(clknet_leaf_1_clk_i));
 sg13g2_tiehi _2785__21 (.L_HI(net406));
 sg13g2_dfrbpq_1 _2786_ (.RESET_B(net407),
    .D(_0299_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_39_),
    .CLK(clknet_leaf_1_clk_i));
 sg13g2_tiehi _2786__22 (.L_HI(net407));
 sg13g2_dfrbpq_1 _2787_ (.RESET_B(net408),
    .D(_0298_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_31_),
    .CLK(clknet_leaf_2_clk_i));
 sg13g2_tiehi _2787__23 (.L_HI(net408));
 sg13g2_dfrbpq_1 _2788_ (.RESET_B(net409),
    .D(_0297_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_23_),
    .CLK(clknet_leaf_3_clk_i));
 sg13g2_tiehi _2788__24 (.L_HI(net409));
 sg13g2_dfrbpq_1 _2789_ (.RESET_B(net410),
    .D(_0296_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_15_),
    .CLK(clknet_leaf_1_clk_i));
 sg13g2_tiehi _2789__25 (.L_HI(net410));
 sg13g2_dfrbpq_1 _2790_ (.RESET_B(net411),
    .D(_0295_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_127_),
    .CLK(clknet_leaf_36_clk_i));
 sg13g2_tiehi _2790__26 (.L_HI(net411));
 sg13g2_dfrbpq_1 _2791_ (.RESET_B(net412),
    .D(_0294_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_119_),
    .CLK(clknet_leaf_36_clk_i));
 sg13g2_tiehi _2791__27 (.L_HI(net412));
 sg13g2_dfrbpq_1 _2792_ (.RESET_B(net413),
    .D(_0293_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_111_),
    .CLK(clknet_leaf_36_clk_i));
 sg13g2_tiehi _2792__28 (.L_HI(net413));
 sg13g2_dfrbpq_1 _2793_ (.RESET_B(net414),
    .D(_0292_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_103_),
    .CLK(clknet_leaf_36_clk_i));
 sg13g2_tiehi _2793__29 (.L_HI(net414));
 sg13g2_dfrbpq_1 _2794_ (.RESET_B(net415),
    .D(_0291_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_95_),
    .CLK(clknet_leaf_0_clk_i));
 sg13g2_tiehi _2794__30 (.L_HI(net415));
 sg13g2_dfrbpq_1 _2795_ (.RESET_B(net416),
    .D(_0290_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_87_),
    .CLK(clknet_leaf_0_clk_i));
 sg13g2_tiehi _2795__31 (.L_HI(net416));
 sg13g2_dfrbpq_1 _2796_ (.RESET_B(net417),
    .D(_0289_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_7_),
    .CLK(clknet_leaf_1_clk_i));
 sg13g2_tiehi _2796__32 (.L_HI(net417));
 sg13g2_dfrbpq_1 _2797_ (.RESET_B(net418),
    .D(_0273_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_0_),
    .CLK(clknet_leaf_8_clk_i));
 sg13g2_tiehi _2797__33 (.L_HI(net418));
 sg13g2_dfrbpq_1 _2798_ (.RESET_B(net419),
    .D(_0272_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_1_),
    .CLK(clknet_leaf_5_clk_i));
 sg13g2_tiehi _2798__34 (.L_HI(net419));
 sg13g2_dfrbpq_1 _2799_ (.RESET_B(net420),
    .D(_0271_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_2_),
    .CLK(clknet_leaf_7_clk_i));
 sg13g2_tiehi _2799__35 (.L_HI(net420));
 sg13g2_dfrbpq_1 _2800_ (.RESET_B(net421),
    .D(_0270_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_3_),
    .CLK(clknet_leaf_1_clk_i));
 sg13g2_tiehi _2800__36 (.L_HI(net421));
 sg13g2_dfrbpq_1 _2801_ (.RESET_B(net422),
    .D(_0269_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_4_),
    .CLK(clknet_leaf_7_clk_i));
 sg13g2_tiehi _2801__37 (.L_HI(net422));
 sg13g2_dfrbpq_1 _2802_ (.RESET_B(net423),
    .D(_0268_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_5_),
    .CLK(clknet_leaf_9_clk_i));
 sg13g2_tiehi _2802__38 (.L_HI(net423));
 sg13g2_dfrbpq_1 _2803_ (.RESET_B(net424),
    .D(_0267_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_6_),
    .CLK(clknet_leaf_6_clk_i));
 sg13g2_tiehi _2803__39 (.L_HI(net424));
 sg13g2_dfrbpq_1 _2804_ (.RESET_B(net425),
    .D(_0266_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_80_),
    .CLK(clknet_leaf_2_clk_i));
 sg13g2_tiehi _2804__40 (.L_HI(net425));
 sg13g2_dfrbpq_1 _2805_ (.RESET_B(net426),
    .D(_0265_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_81_),
    .CLK(clknet_leaf_32_clk_i));
 sg13g2_tiehi _2805__41 (.L_HI(net426));
 sg13g2_dfrbpq_1 _2806_ (.RESET_B(net427),
    .D(_0264_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_82_),
    .CLK(clknet_leaf_39_clk_i));
 sg13g2_tiehi _2806__42 (.L_HI(net427));
 sg13g2_dfrbpq_1 _2807_ (.RESET_B(net428),
    .D(_0263_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_83_),
    .CLK(clknet_leaf_32_clk_i));
 sg13g2_tiehi _2807__43 (.L_HI(net428));
 sg13g2_dfrbpq_1 _2808_ (.RESET_B(net429),
    .D(_0262_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_84_),
    .CLK(clknet_leaf_38_clk_i));
 sg13g2_tiehi _2808__44 (.L_HI(net429));
 sg13g2_dfrbpq_1 _2809_ (.RESET_B(net430),
    .D(_0261_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_85_),
    .CLK(clknet_leaf_32_clk_i));
 sg13g2_tiehi _2809__45 (.L_HI(net430));
 sg13g2_dfrbpq_1 _2810_ (.RESET_B(net431),
    .D(_0260_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_86_),
    .CLK(clknet_leaf_0_clk_i));
 sg13g2_tiehi _2810__46 (.L_HI(net431));
 sg13g2_dfrbpq_1 _2811_ (.RESET_B(net432),
    .D(_0259_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_88_),
    .CLK(clknet_leaf_3_clk_i));
 sg13g2_tiehi _2811__47 (.L_HI(net432));
 sg13g2_dfrbpq_1 _2812_ (.RESET_B(net433),
    .D(_0258_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_89_),
    .CLK(clknet_leaf_37_clk_i));
 sg13g2_tiehi _2812__48 (.L_HI(net433));
 sg13g2_dfrbpq_1 _2813_ (.RESET_B(net434),
    .D(_0257_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_90_),
    .CLK(clknet_leaf_0_clk_i));
 sg13g2_tiehi _2813__49 (.L_HI(net434));
 sg13g2_dfrbpq_1 _2814_ (.RESET_B(net435),
    .D(_0256_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_91_),
    .CLK(clknet_leaf_32_clk_i));
 sg13g2_tiehi _2814__50 (.L_HI(net435));
 sg13g2_dfrbpq_1 _2815_ (.RESET_B(net436),
    .D(_0255_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_92_),
    .CLK(clknet_leaf_38_clk_i));
 sg13g2_tiehi _2815__51 (.L_HI(net436));
 sg13g2_dfrbpq_1 _2816_ (.RESET_B(net437),
    .D(_0254_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_93_),
    .CLK(clknet_leaf_36_clk_i));
 sg13g2_tiehi _2816__52 (.L_HI(net437));
 sg13g2_dfrbpq_1 _2817_ (.RESET_B(net438),
    .D(_0253_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_94_),
    .CLK(clknet_leaf_0_clk_i));
 sg13g2_tiehi _2817__53 (.L_HI(net438));
 sg13g2_dfrbpq_1 _2818_ (.RESET_B(net439),
    .D(_0252_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_96_),
    .CLK(clknet_leaf_3_clk_i));
 sg13g2_tiehi _2818__54 (.L_HI(net439));
 sg13g2_dfrbpq_1 _2819_ (.RESET_B(net440),
    .D(_0251_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_97_),
    .CLK(clknet_leaf_34_clk_i));
 sg13g2_tiehi _2819__55 (.L_HI(net440));
 sg13g2_dfrbpq_1 _2820_ (.RESET_B(net441),
    .D(_0250_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_98_),
    .CLK(clknet_leaf_3_clk_i));
 sg13g2_tiehi _2820__56 (.L_HI(net441));
 sg13g2_dfrbpq_1 _2821_ (.RESET_B(net442),
    .D(_0249_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_99_),
    .CLK(clknet_leaf_34_clk_i));
 sg13g2_tiehi _2821__57 (.L_HI(net442));
 sg13g2_dfrbpq_1 _2822_ (.RESET_B(net443),
    .D(_0248_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_100_),
    .CLK(clknet_leaf_38_clk_i));
 sg13g2_tiehi _2822__58 (.L_HI(net443));
 sg13g2_dfrbpq_1 _2823_ (.RESET_B(net444),
    .D(_0247_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_101_),
    .CLK(clknet_leaf_35_clk_i));
 sg13g2_tiehi _2823__59 (.L_HI(net444));
 sg13g2_dfrbpq_1 _2824_ (.RESET_B(net445),
    .D(_0246_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_102_),
    .CLK(clknet_leaf_38_clk_i));
 sg13g2_tiehi _2824__60 (.L_HI(net445));
 sg13g2_dfrbpq_1 _2825_ (.RESET_B(net446),
    .D(_0245_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_104_),
    .CLK(clknet_leaf_3_clk_i));
 sg13g2_tiehi _2825__61 (.L_HI(net446));
 sg13g2_dfrbpq_1 _2826_ (.RESET_B(net447),
    .D(_0244_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_105_),
    .CLK(clknet_leaf_32_clk_i));
 sg13g2_tiehi _2826__62 (.L_HI(net447));
 sg13g2_dfrbpq_1 _2827_ (.RESET_B(net448),
    .D(_0243_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_106_),
    .CLK(clknet_leaf_36_clk_i));
 sg13g2_tiehi _2827__63 (.L_HI(net448));
 sg13g2_dfrbpq_1 _2828_ (.RESET_B(net449),
    .D(_0242_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_107_),
    .CLK(clknet_leaf_34_clk_i));
 sg13g2_tiehi _2828__64 (.L_HI(net449));
 sg13g2_dfrbpq_1 _2829_ (.RESET_B(net450),
    .D(_0241_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_108_),
    .CLK(clknet_leaf_38_clk_i));
 sg13g2_tiehi _2829__65 (.L_HI(net450));
 sg13g2_dfrbpq_1 _2830_ (.RESET_B(net451),
    .D(_0240_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_109_),
    .CLK(clknet_leaf_35_clk_i));
 sg13g2_tiehi _2830__66 (.L_HI(net451));
 sg13g2_dfrbpq_1 _2831_ (.RESET_B(net452),
    .D(_0239_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_110_),
    .CLK(clknet_leaf_2_clk_i));
 sg13g2_tiehi _2831__67 (.L_HI(net452));
 sg13g2_dfrbpq_1 _2832_ (.RESET_B(net453),
    .D(_0238_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_112_),
    .CLK(clknet_leaf_3_clk_i));
 sg13g2_tiehi _2832__68 (.L_HI(net453));
 sg13g2_dfrbpq_1 _2833_ (.RESET_B(net454),
    .D(_0237_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_113_),
    .CLK(clknet_leaf_35_clk_i));
 sg13g2_tiehi _2833__69 (.L_HI(net454));
 sg13g2_dfrbpq_1 _2834_ (.RESET_B(net455),
    .D(_0236_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_114_),
    .CLK(clknet_leaf_36_clk_i));
 sg13g2_tiehi _2834__70 (.L_HI(net455));
 sg13g2_dfrbpq_1 _2835_ (.RESET_B(net456),
    .D(_0235_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_115_),
    .CLK(clknet_leaf_35_clk_i));
 sg13g2_tiehi _2835__71 (.L_HI(net456));
 sg13g2_dfrbpq_1 _2836_ (.RESET_B(net457),
    .D(_0234_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_116_),
    .CLK(clknet_leaf_38_clk_i));
 sg13g2_tiehi _2836__72 (.L_HI(net457));
 sg13g2_dfrbpq_1 _2837_ (.RESET_B(net458),
    .D(_0233_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_117_),
    .CLK(clknet_leaf_35_clk_i));
 sg13g2_tiehi _2837__73 (.L_HI(net458));
 sg13g2_dfrbpq_1 _2838_ (.RESET_B(net459),
    .D(_0232_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_118_),
    .CLK(clknet_leaf_36_clk_i));
 sg13g2_tiehi _2838__74 (.L_HI(net459));
 sg13g2_dfrbpq_1 _2839_ (.RESET_B(net460),
    .D(_0231_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_120_),
    .CLK(clknet_leaf_2_clk_i));
 sg13g2_tiehi _2839__75 (.L_HI(net460));
 sg13g2_dfrbpq_1 _2840_ (.RESET_B(net461),
    .D(_0230_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_121_),
    .CLK(clknet_leaf_34_clk_i));
 sg13g2_tiehi _2840__76 (.L_HI(net461));
 sg13g2_dfrbpq_1 _2841_ (.RESET_B(net462),
    .D(_0229_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_122_),
    .CLK(clknet_leaf_35_clk_i));
 sg13g2_tiehi _2841__77 (.L_HI(net462));
 sg13g2_dfrbpq_1 _2842_ (.RESET_B(net463),
    .D(_0228_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_123_),
    .CLK(clknet_leaf_34_clk_i));
 sg13g2_tiehi _2842__78 (.L_HI(net463));
 sg13g2_dfrbpq_1 _2843_ (.RESET_B(net464),
    .D(_0227_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_124_),
    .CLK(clknet_leaf_38_clk_i));
 sg13g2_tiehi _2843__79 (.L_HI(net464));
 sg13g2_dfrbpq_1 _2844_ (.RESET_B(net465),
    .D(_0226_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_125_),
    .CLK(clknet_leaf_35_clk_i));
 sg13g2_tiehi _2844__80 (.L_HI(net465));
 sg13g2_dfrbpq_1 _2845_ (.RESET_B(net466),
    .D(_0225_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_126_),
    .CLK(clknet_leaf_0_clk_i));
 sg13g2_tiehi _2845__81 (.L_HI(net466));
 sg13g2_dfrbpq_1 _2846_ (.RESET_B(net467),
    .D(_0224_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_8_),
    .CLK(clknet_leaf_8_clk_i));
 sg13g2_tiehi _2846__82 (.L_HI(net467));
 sg13g2_dfrbpq_1 _2847_ (.RESET_B(net468),
    .D(_0223_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_9_),
    .CLK(clknet_leaf_1_clk_i));
 sg13g2_tiehi _2847__83 (.L_HI(net468));
 sg13g2_dfrbpq_1 _2848_ (.RESET_B(net469),
    .D(_0222_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_10_),
    .CLK(clknet_leaf_7_clk_i));
 sg13g2_tiehi _2848__84 (.L_HI(net469));
 sg13g2_dfrbpq_1 _2849_ (.RESET_B(net470),
    .D(_0221_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_11_),
    .CLK(clknet_leaf_1_clk_i));
 sg13g2_tiehi _2849__85 (.L_HI(net470));
 sg13g2_dfrbpq_1 _2850_ (.RESET_B(net471),
    .D(_0220_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_12_),
    .CLK(clknet_leaf_8_clk_i));
 sg13g2_tiehi _2850__86 (.L_HI(net471));
 sg13g2_dfrbpq_1 _2851_ (.RESET_B(net472),
    .D(_0219_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_13_),
    .CLK(clknet_leaf_9_clk_i));
 sg13g2_tiehi _2851__87 (.L_HI(net472));
 sg13g2_dfrbpq_1 _2852_ (.RESET_B(net473),
    .D(_0218_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_14_),
    .CLK(clknet_leaf_5_clk_i));
 sg13g2_tiehi _2852__88 (.L_HI(net473));
 sg13g2_dfrbpq_1 _2853_ (.RESET_B(net474),
    .D(_0217_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_16_),
    .CLK(clknet_leaf_10_clk_i));
 sg13g2_tiehi _2853__89 (.L_HI(net474));
 sg13g2_dfrbpq_1 _2854_ (.RESET_B(net475),
    .D(_0216_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_17_),
    .CLK(clknet_leaf_4_clk_i));
 sg13g2_tiehi _2854__90 (.L_HI(net475));
 sg13g2_dfrbpq_1 _2855_ (.RESET_B(net476),
    .D(_0215_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_18_),
    .CLK(clknet_leaf_12_clk_i));
 sg13g2_tiehi _2855__91 (.L_HI(net476));
 sg13g2_dfrbpq_1 _2856_ (.RESET_B(net477),
    .D(_0214_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_19_),
    .CLK(clknet_leaf_3_clk_i));
 sg13g2_tiehi _2856__92 (.L_HI(net477));
 sg13g2_dfrbpq_1 _2857_ (.RESET_B(net478),
    .D(_0213_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_20_),
    .CLK(clknet_leaf_12_clk_i));
 sg13g2_tiehi _2857__93 (.L_HI(net478));
 sg13g2_dfrbpq_1 _2858_ (.RESET_B(net479),
    .D(_0212_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_21_),
    .CLK(clknet_leaf_10_clk_i));
 sg13g2_tiehi _2858__94 (.L_HI(net479));
 sg13g2_dfrbpq_1 _2859_ (.RESET_B(net480),
    .D(_0211_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_22_),
    .CLK(clknet_leaf_4_clk_i));
 sg13g2_tiehi _2859__95 (.L_HI(net480));
 sg13g2_dfrbpq_1 _2860_ (.RESET_B(net481),
    .D(_0210_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_24_),
    .CLK(clknet_leaf_9_clk_i));
 sg13g2_tiehi _2860__96 (.L_HI(net481));
 sg13g2_dfrbpq_1 _2861_ (.RESET_B(net482),
    .D(_0209_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_25_),
    .CLK(clknet_leaf_4_clk_i));
 sg13g2_tiehi _2861__97 (.L_HI(net482));
 sg13g2_dfrbpq_1 _2862_ (.RESET_B(net483),
    .D(_0208_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_26_),
    .CLK(clknet_leaf_10_clk_i));
 sg13g2_tiehi _2862__98 (.L_HI(net483));
 sg13g2_dfrbpq_1 _2863_ (.RESET_B(net484),
    .D(_0207_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_27_),
    .CLK(clknet_leaf_5_clk_i));
 sg13g2_tiehi _2863__99 (.L_HI(net484));
 sg13g2_dfrbpq_1 _2864_ (.RESET_B(net485),
    .D(_0206_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_28_),
    .CLK(clknet_leaf_10_clk_i));
 sg13g2_tiehi _2864__100 (.L_HI(net485));
 sg13g2_dfrbpq_1 _2865_ (.RESET_B(net486),
    .D(_0205_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_29_),
    .CLK(clknet_leaf_10_clk_i));
 sg13g2_tiehi _2865__101 (.L_HI(net486));
 sg13g2_dfrbpq_1 _2866_ (.RESET_B(net487),
    .D(_0204_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_30_),
    .CLK(clknet_leaf_6_clk_i));
 sg13g2_tiehi _2866__102 (.L_HI(net487));
 sg13g2_dfrbpq_1 _2867_ (.RESET_B(net488),
    .D(_0203_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_32_),
    .CLK(clknet_leaf_8_clk_i));
 sg13g2_tiehi _2867__103 (.L_HI(net488));
 sg13g2_dfrbpq_1 _2868_ (.RESET_B(net489),
    .D(_0202_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_33_),
    .CLK(clknet_leaf_6_clk_i));
 sg13g2_tiehi _2868__104 (.L_HI(net489));
 sg13g2_dfrbpq_1 _2869_ (.RESET_B(net490),
    .D(_0201_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_34_),
    .CLK(clknet_leaf_7_clk_i));
 sg13g2_tiehi _2869__105 (.L_HI(net490));
 sg13g2_dfrbpq_1 _2870_ (.RESET_B(net491),
    .D(_0200_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_35_),
    .CLK(clknet_leaf_5_clk_i));
 sg13g2_tiehi _2870__106 (.L_HI(net491));
 sg13g2_dfrbpq_1 _2871_ (.RESET_B(net492),
    .D(_0199_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_36_),
    .CLK(clknet_leaf_8_clk_i));
 sg13g2_tiehi _2871__107 (.L_HI(net492));
 sg13g2_dfrbpq_1 _2872_ (.RESET_B(net493),
    .D(_0198_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_37_),
    .CLK(clknet_leaf_8_clk_i));
 sg13g2_tiehi _2872__108 (.L_HI(net493));
 sg13g2_dfrbpq_1 _2873_ (.RESET_B(net494),
    .D(_0197_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_38_),
    .CLK(clknet_leaf_5_clk_i));
 sg13g2_tiehi _2873__109 (.L_HI(net494));
 sg13g2_dfrbpq_1 _2874_ (.RESET_B(net495),
    .D(_0196_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_40_),
    .CLK(clknet_leaf_8_clk_i));
 sg13g2_tiehi _2874__110 (.L_HI(net495));
 sg13g2_dfrbpq_1 _2875_ (.RESET_B(net496),
    .D(_0195_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_41_),
    .CLK(clknet_leaf_6_clk_i));
 sg13g2_tiehi _2875__111 (.L_HI(net496));
 sg13g2_dfrbpq_1 _2876_ (.RESET_B(net497),
    .D(_0194_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_42_),
    .CLK(clknet_leaf_6_clk_i));
 sg13g2_tiehi _2876__112 (.L_HI(net497));
 sg13g2_dfrbpq_1 _2877_ (.RESET_B(net498),
    .D(_0193_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_43_),
    .CLK(clknet_leaf_5_clk_i));
 sg13g2_tiehi _2877__113 (.L_HI(net498));
 sg13g2_dfrbpq_1 _2878_ (.RESET_B(net499),
    .D(_0192_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_44_),
    .CLK(clknet_leaf_7_clk_i));
 sg13g2_tiehi _2878__114 (.L_HI(net499));
 sg13g2_dfrbpq_1 _2879_ (.RESET_B(net500),
    .D(_0191_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_45_),
    .CLK(clknet_leaf_8_clk_i));
 sg13g2_tiehi _2879__115 (.L_HI(net500));
 sg13g2_dfrbpq_1 _2880_ (.RESET_B(net501),
    .D(_0190_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_46_),
    .CLK(clknet_leaf_6_clk_i));
 sg13g2_tiehi _2880__116 (.L_HI(net501));
 sg13g2_dfrbpq_1 _2881_ (.RESET_B(net502),
    .D(_0189_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_48_),
    .CLK(clknet_leaf_9_clk_i));
 sg13g2_tiehi _2881__117 (.L_HI(net502));
 sg13g2_dfrbpq_1 _2882_ (.RESET_B(net503),
    .D(_0188_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_49_),
    .CLK(clknet_leaf_6_clk_i));
 sg13g2_tiehi _2882__118 (.L_HI(net503));
 sg13g2_dfrbpq_1 _2883_ (.RESET_B(net504),
    .D(_0187_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_50_),
    .CLK(clknet_leaf_7_clk_i));
 sg13g2_tiehi _2883__119 (.L_HI(net504));
 sg13g2_dfrbpq_1 _2884_ (.RESET_B(net505),
    .D(_0186_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_51_),
    .CLK(clknet_leaf_2_clk_i));
 sg13g2_tiehi _2884__120 (.L_HI(net505));
 sg13g2_dfrbpq_1 _2885_ (.RESET_B(net506),
    .D(_0185_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_52_),
    .CLK(clknet_leaf_9_clk_i));
 sg13g2_tiehi _2885__121 (.L_HI(net506));
 sg13g2_dfrbpq_1 _2886_ (.RESET_B(net507),
    .D(_0184_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_53_),
    .CLK(clknet_leaf_9_clk_i));
 sg13g2_tiehi _2886__122 (.L_HI(net507));
 sg13g2_dfrbpq_1 _2887_ (.RESET_B(net508),
    .D(_0183_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_54_),
    .CLK(clknet_leaf_5_clk_i));
 sg13g2_tiehi _2887__123 (.L_HI(net508));
 sg13g2_dfrbpq_1 _2888_ (.RESET_B(net509),
    .D(_0182_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_56_),
    .CLK(clknet_leaf_9_clk_i));
 sg13g2_tiehi _2888__124 (.L_HI(net509));
 sg13g2_dfrbpq_1 _2889_ (.RESET_B(net510),
    .D(_0181_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_57_),
    .CLK(clknet_leaf_6_clk_i));
 sg13g2_tiehi _2889__125 (.L_HI(net510));
 sg13g2_dfrbpq_1 _2890_ (.RESET_B(net511),
    .D(_0180_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_58_),
    .CLK(clknet_leaf_7_clk_i));
 sg13g2_tiehi _2890__126 (.L_HI(net511));
 sg13g2_dfrbpq_1 _2891_ (.RESET_B(net512),
    .D(_0179_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_59_),
    .CLK(clknet_leaf_1_clk_i));
 sg13g2_tiehi _2891__127 (.L_HI(net512));
 sg13g2_dfrbpq_1 _2892_ (.RESET_B(net513),
    .D(_0178_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_60_),
    .CLK(clknet_leaf_7_clk_i));
 sg13g2_tiehi _2892__128 (.L_HI(net513));
 sg13g2_dfrbpq_1 _2893_ (.RESET_B(net514),
    .D(_0177_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_61_),
    .CLK(clknet_leaf_9_clk_i));
 sg13g2_tiehi _2893__129 (.L_HI(net514));
 sg13g2_dfrbpq_1 _2894_ (.RESET_B(net515),
    .D(_0176_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_62_),
    .CLK(clknet_leaf_5_clk_i));
 sg13g2_tiehi _2894__130 (.L_HI(net515));
 sg13g2_dfrbpq_1 _2895_ (.RESET_B(net516),
    .D(_0175_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_64_),
    .CLK(clknet_leaf_2_clk_i));
 sg13g2_tiehi _2895__131 (.L_HI(net516));
 sg13g2_dfrbpq_1 _2896_ (.RESET_B(net517),
    .D(_0174_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_65_),
    .CLK(clknet_leaf_37_clk_i));
 sg13g2_tiehi _2896__132 (.L_HI(net517));
 sg13g2_dfrbpq_1 _2897_ (.RESET_B(net518),
    .D(_0173_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_66_),
    .CLK(clknet_leaf_39_clk_i));
 sg13g2_tiehi _2897__133 (.L_HI(net518));
 sg13g2_dfrbpq_1 _2898_ (.RESET_B(net519),
    .D(_0172_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_67_),
    .CLK(clknet_leaf_37_clk_i));
 sg13g2_tiehi _2898__134 (.L_HI(net519));
 sg13g2_dfrbpq_1 _2899_ (.RESET_B(net520),
    .D(_0171_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_68_),
    .CLK(clknet_leaf_37_clk_i));
 sg13g2_tiehi _2899__135 (.L_HI(net520));
 sg13g2_dfrbpq_1 _2900_ (.RESET_B(net521),
    .D(_0170_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_69_),
    .CLK(clknet_leaf_32_clk_i));
 sg13g2_tiehi _2900__136 (.L_HI(net521));
 sg13g2_dfrbpq_1 _2901_ (.RESET_B(net522),
    .D(_0169_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_70_),
    .CLK(clknet_leaf_39_clk_i));
 sg13g2_tiehi _2901__137 (.L_HI(net522));
 sg13g2_dfrbpq_1 _2902_ (.RESET_B(net523),
    .D(_0168_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_72_),
    .CLK(clknet_leaf_0_clk_i));
 sg13g2_tiehi _2902__138 (.L_HI(net523));
 sg13g2_dfrbpq_1 _2903_ (.RESET_B(net524),
    .D(_0167_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_73_),
    .CLK(clknet_leaf_37_clk_i));
 sg13g2_tiehi _2903__139 (.L_HI(net524));
 sg13g2_dfrbpq_1 _2904_ (.RESET_B(net525),
    .D(_0166_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_74_),
    .CLK(clknet_leaf_39_clk_i));
 sg13g2_tiehi _2904__140 (.L_HI(net525));
 sg13g2_dfrbpq_1 _2905_ (.RESET_B(net526),
    .D(_0165_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_75_),
    .CLK(clknet_leaf_37_clk_i));
 sg13g2_tiehi _2905__141 (.L_HI(net526));
 sg13g2_dfrbpq_1 _2906_ (.RESET_B(net527),
    .D(_0164_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_76_),
    .CLK(clknet_leaf_37_clk_i));
 sg13g2_tiehi _2906__142 (.L_HI(net527));
 sg13g2_dfrbpq_1 _2907_ (.RESET_B(net528),
    .D(_0163_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_77_),
    .CLK(clknet_leaf_37_clk_i));
 sg13g2_tiehi _2907__143 (.L_HI(net528));
 sg13g2_dfrbpq_1 _2908_ (.RESET_B(net529),
    .D(_0162_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_storage_78_),
    .CLK(clknet_leaf_0_clk_i));
 sg13g2_tiehi _2908__144 (.L_HI(net529));
 sg13g2_dfrbpq_1 _2909_ (.RESET_B(net530),
    .D(_0154_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_0_),
    .CLK(clknet_leaf_24_clk_i));
 sg13g2_tiehi _2909__145 (.L_HI(net530));
 sg13g2_dfrbpq_1 _2910_ (.RESET_B(net531),
    .D(_0153_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_1_),
    .CLK(clknet_leaf_33_clk_i));
 sg13g2_tiehi _2910__146 (.L_HI(net531));
 sg13g2_dfrbpq_1 _2911_ (.RESET_B(net532),
    .D(_0152_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_2_),
    .CLK(clknet_leaf_26_clk_i));
 sg13g2_tiehi _2911__147 (.L_HI(net532));
 sg13g2_dfrbpq_1 _2912_ (.RESET_B(net533),
    .D(_0151_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_3_),
    .CLK(clknet_leaf_27_clk_i));
 sg13g2_tiehi _2912__148 (.L_HI(net533));
 sg13g2_dfrbpq_1 _2913_ (.RESET_B(net534),
    .D(_0150_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_4_),
    .CLK(clknet_leaf_26_clk_i));
 sg13g2_tiehi _2913__149 (.L_HI(net534));
 sg13g2_dfrbpq_1 _2914_ (.RESET_B(net535),
    .D(_0149_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_5_),
    .CLK(clknet_leaf_26_clk_i));
 sg13g2_tiehi _2914__150 (.L_HI(net535));
 sg13g2_dfrbpq_1 _2915_ (.RESET_B(net536),
    .D(_0148_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_6_),
    .CLK(clknet_leaf_26_clk_i));
 sg13g2_tiehi _2915__151 (.L_HI(net536));
 sg13g2_dfrbpq_1 _2916_ (.RESET_B(net537),
    .D(_0147_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_8_),
    .CLK(clknet_leaf_25_clk_i));
 sg13g2_tiehi _2916__152 (.L_HI(net537));
 sg13g2_dfrbpq_1 _2917_ (.RESET_B(net538),
    .D(_0146_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_9_),
    .CLK(clknet_leaf_25_clk_i));
 sg13g2_tiehi _2917__153 (.L_HI(net538));
 sg13g2_dfrbpq_1 _2918_ (.RESET_B(net539),
    .D(_0145_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_10_),
    .CLK(clknet_leaf_27_clk_i));
 sg13g2_tiehi _2918__154 (.L_HI(net539));
 sg13g2_dfrbpq_1 _2919_ (.RESET_B(net540),
    .D(_0144_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_11_),
    .CLK(clknet_leaf_27_clk_i));
 sg13g2_tiehi _2919__155 (.L_HI(net540));
 sg13g2_dfrbpq_1 _2920_ (.RESET_B(net541),
    .D(_0143_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_12_),
    .CLK(clknet_leaf_27_clk_i));
 sg13g2_tiehi _2920__156 (.L_HI(net541));
 sg13g2_dfrbpq_1 _2921_ (.RESET_B(net542),
    .D(_0142_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_13_),
    .CLK(clknet_leaf_26_clk_i));
 sg13g2_tiehi _2921__157 (.L_HI(net542));
 sg13g2_dfrbpq_1 _2922_ (.RESET_B(net543),
    .D(_0141_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_14_),
    .CLK(clknet_leaf_26_clk_i));
 sg13g2_tiehi _2922__158 (.L_HI(net543));
 sg13g2_dfrbpq_1 _2923_ (.RESET_B(net544),
    .D(_0140_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_16_),
    .CLK(clknet_leaf_25_clk_i));
 sg13g2_tiehi _2923__159 (.L_HI(net544));
 sg13g2_dfrbpq_1 _2924_ (.RESET_B(net545),
    .D(_0139_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_17_),
    .CLK(clknet_leaf_33_clk_i));
 sg13g2_tiehi _2924__160 (.L_HI(net545));
 sg13g2_dfrbpq_1 _2925_ (.RESET_B(net546),
    .D(_0138_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_18_),
    .CLK(clknet_leaf_29_clk_i));
 sg13g2_tiehi _2925__161 (.L_HI(net546));
 sg13g2_dfrbpq_1 _2926_ (.RESET_B(net547),
    .D(_0137_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_19_),
    .CLK(clknet_leaf_29_clk_i));
 sg13g2_tiehi _2926__162 (.L_HI(net547));
 sg13g2_dfrbpq_1 _2927_ (.RESET_B(net548),
    .D(_0136_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_20_),
    .CLK(clknet_leaf_27_clk_i));
 sg13g2_tiehi _2927__163 (.L_HI(net548));
 sg13g2_dfrbpq_1 _2928_ (.RESET_B(net549),
    .D(_0135_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_21_),
    .CLK(clknet_leaf_25_clk_i));
 sg13g2_tiehi _2928__164 (.L_HI(net549));
 sg13g2_dfrbpq_1 _2929_ (.RESET_B(net550),
    .D(_0134_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_22_),
    .CLK(clknet_leaf_25_clk_i));
 sg13g2_tiehi _2929__165 (.L_HI(net550));
 sg13g2_dfrbpq_1 _2930_ (.RESET_B(net551),
    .D(_0133_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_24_),
    .CLK(clknet_leaf_25_clk_i));
 sg13g2_tiehi _2930__166 (.L_HI(net551));
 sg13g2_dfrbpq_1 _2931_ (.RESET_B(net552),
    .D(_0132_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_25_),
    .CLK(clknet_leaf_31_clk_i));
 sg13g2_tiehi _2931__167 (.L_HI(net552));
 sg13g2_dfrbpq_1 _2932_ (.RESET_B(net553),
    .D(_0131_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_26_),
    .CLK(clknet_leaf_28_clk_i));
 sg13g2_tiehi _2932__168 (.L_HI(net553));
 sg13g2_dfrbpq_1 _2933_ (.RESET_B(net554),
    .D(_0130_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_27_),
    .CLK(clknet_leaf_27_clk_i));
 sg13g2_tiehi _2933__169 (.L_HI(net554));
 sg13g2_dfrbpq_1 _2934_ (.RESET_B(net555),
    .D(_0129_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_28_),
    .CLK(clknet_leaf_27_clk_i));
 sg13g2_tiehi _2934__170 (.L_HI(net555));
 sg13g2_dfrbpq_1 _2935_ (.RESET_B(net556),
    .D(_0128_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_29_),
    .CLK(clknet_leaf_28_clk_i));
 sg13g2_tiehi _2935__171 (.L_HI(net556));
 sg13g2_dfrbpq_1 _2936_ (.RESET_B(net557),
    .D(_0127_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_30_),
    .CLK(clknet_leaf_25_clk_i));
 sg13g2_tiehi _2936__172 (.L_HI(net557));
 sg13g2_dfrbpq_1 _2937_ (.RESET_B(net558),
    .D(_0126_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_32_),
    .CLK(clknet_leaf_33_clk_i));
 sg13g2_tiehi _2937__173 (.L_HI(net558));
 sg13g2_dfrbpq_1 _2938_ (.RESET_B(net559),
    .D(_0125_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_33_),
    .CLK(clknet_leaf_33_clk_i));
 sg13g2_tiehi _2938__174 (.L_HI(net559));
 sg13g2_dfrbpq_1 _2939_ (.RESET_B(net560),
    .D(_0124_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_34_),
    .CLK(clknet_leaf_30_clk_i));
 sg13g2_tiehi _2939__175 (.L_HI(net560));
 sg13g2_dfrbpq_1 _2940_ (.RESET_B(net561),
    .D(_0123_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_35_),
    .CLK(clknet_leaf_30_clk_i));
 sg13g2_tiehi _2940__176 (.L_HI(net561));
 sg13g2_dfrbpq_1 _2941_ (.RESET_B(net562),
    .D(_0122_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_36_),
    .CLK(clknet_leaf_28_clk_i));
 sg13g2_tiehi _2941__177 (.L_HI(net562));
 sg13g2_dfrbpq_1 _2942_ (.RESET_B(net563),
    .D(_0121_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_37_),
    .CLK(clknet_leaf_28_clk_i));
 sg13g2_tiehi _2942__178 (.L_HI(net563));
 sg13g2_dfrbpq_1 _2943_ (.RESET_B(net564),
    .D(_0120_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_38_),
    .CLK(clknet_leaf_30_clk_i));
 sg13g2_tiehi _2943__179 (.L_HI(net564));
 sg13g2_dfrbpq_1 _2944_ (.RESET_B(net565),
    .D(_0119_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_40_),
    .CLK(clknet_leaf_34_clk_i));
 sg13g2_tiehi _2944__180 (.L_HI(net565));
 sg13g2_dfrbpq_1 _2945_ (.RESET_B(net566),
    .D(_0118_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_41_),
    .CLK(clknet_leaf_32_clk_i));
 sg13g2_tiehi _2945__181 (.L_HI(net566));
 sg13g2_dfrbpq_1 _2946_ (.RESET_B(net567),
    .D(_0117_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_42_),
    .CLK(clknet_leaf_30_clk_i));
 sg13g2_tiehi _2946__182 (.L_HI(net567));
 sg13g2_dfrbpq_1 _2947_ (.RESET_B(net568),
    .D(_0116_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_43_),
    .CLK(clknet_leaf_30_clk_i));
 sg13g2_tiehi _2947__183 (.L_HI(net568));
 sg13g2_dfrbpq_1 _2948_ (.RESET_B(net569),
    .D(_0115_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_44_),
    .CLK(clknet_leaf_29_clk_i));
 sg13g2_tiehi _2948__184 (.L_HI(net569));
 sg13g2_dfrbpq_1 _2949_ (.RESET_B(net570),
    .D(_0114_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_45_),
    .CLK(clknet_leaf_28_clk_i));
 sg13g2_tiehi _2949__185 (.L_HI(net570));
 sg13g2_dfrbpq_1 _2950_ (.RESET_B(net571),
    .D(_0113_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_46_),
    .CLK(clknet_leaf_30_clk_i));
 sg13g2_tiehi _2950__186 (.L_HI(net571));
 sg13g2_dfrbpq_1 _2951_ (.RESET_B(net572),
    .D(_0112_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_48_),
    .CLK(clknet_leaf_33_clk_i));
 sg13g2_tiehi _2951__187 (.L_HI(net572));
 sg13g2_dfrbpq_1 _2952_ (.RESET_B(net573),
    .D(_0111_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_49_),
    .CLK(clknet_leaf_33_clk_i));
 sg13g2_tiehi _2952__188 (.L_HI(net573));
 sg13g2_dfrbpq_1 _2953_ (.RESET_B(net574),
    .D(_0110_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_50_),
    .CLK(clknet_leaf_29_clk_i));
 sg13g2_tiehi _2953__189 (.L_HI(net574));
 sg13g2_dfrbpq_1 _2954_ (.RESET_B(net575),
    .D(_0109_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_51_),
    .CLK(clknet_leaf_30_clk_i));
 sg13g2_tiehi _2954__190 (.L_HI(net575));
 sg13g2_dfrbpq_1 _2955_ (.RESET_B(net576),
    .D(_0108_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_52_),
    .CLK(clknet_leaf_29_clk_i));
 sg13g2_tiehi _2955__191 (.L_HI(net576));
 sg13g2_dfrbpq_1 _2956_ (.RESET_B(net577),
    .D(_0107_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_53_),
    .CLK(clknet_leaf_28_clk_i));
 sg13g2_tiehi _2956__192 (.L_HI(net577));
 sg13g2_dfrbpq_1 _2957_ (.RESET_B(net578),
    .D(_0106_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_54_),
    .CLK(clknet_leaf_31_clk_i));
 sg13g2_tiehi _2957__193 (.L_HI(net578));
 sg13g2_dfrbpq_1 _2958_ (.RESET_B(net579),
    .D(_0105_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_56_),
    .CLK(clknet_leaf_33_clk_i));
 sg13g2_tiehi _2958__194 (.L_HI(net579));
 sg13g2_dfrbpq_1 _2959_ (.RESET_B(net580),
    .D(_0104_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_57_),
    .CLK(clknet_leaf_33_clk_i));
 sg13g2_tiehi _2959__195 (.L_HI(net580));
 sg13g2_dfrbpq_1 _2960_ (.RESET_B(net581),
    .D(_0103_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_58_),
    .CLK(clknet_leaf_28_clk_i));
 sg13g2_tiehi _2960__196 (.L_HI(net581));
 sg13g2_dfrbpq_1 _2961_ (.RESET_B(net582),
    .D(_0102_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_59_),
    .CLK(clknet_leaf_29_clk_i));
 sg13g2_tiehi _2961__197 (.L_HI(net582));
 sg13g2_dfrbpq_1 _2962_ (.RESET_B(net583),
    .D(_0101_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_60_),
    .CLK(clknet_leaf_29_clk_i));
 sg13g2_tiehi _2962__198 (.L_HI(net583));
 sg13g2_dfrbpq_1 _2963_ (.RESET_B(net584),
    .D(_0100_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_61_),
    .CLK(clknet_leaf_29_clk_i));
 sg13g2_tiehi _2963__199 (.L_HI(net584));
 sg13g2_dfrbpq_1 _2964_ (.RESET_B(net585),
    .D(_0099_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_storage_62_),
    .CLK(clknet_leaf_30_clk_i));
 sg13g2_tiehi _2964__200 (.L_HI(net585));
 sg13g2_dfrbpq_1 _2965_ (.RESET_B(net1117),
    .D(_0286_),
    .Q(_0037_),
    .CLK(clknet_leaf_21_clk_i));
 sg13g2_dfrbpq_1 _2966_ (.RESET_B(net1117),
    .D(_0285_),
    .Q(_0036_),
    .CLK(clknet_leaf_20_clk_i));
 sg13g2_dfrbpq_1 _2967_ (.RESET_B(net1116),
    .D(_0284_),
    .Q(_0035_),
    .CLK(clknet_leaf_21_clk_i));
 sg13g2_dfrbpq_1 _2968_ (.RESET_B(net1116),
    .D(_0283_),
    .Q(_0034_),
    .CLK(clknet_leaf_21_clk_i));
 sg13g2_dfrbpq_1 _2969_ (.RESET_B(net1116),
    .D(_0282_),
    .Q(_0033_),
    .CLK(clknet_leaf_21_clk_i));
 sg13g2_dfrbpq_1 _2970_ (.RESET_B(net1116),
    .D(_0281_),
    .Q(_0032_),
    .CLK(clknet_leaf_21_clk_i));
 sg13g2_dfrbpq_1 _2971_ (.RESET_B(net1116),
    .D(_0280_),
    .Q(_0031_),
    .CLK(clknet_leaf_22_clk_i));
 sg13g2_dfrbpq_1 _2972_ (.RESET_B(net1116),
    .D(_0279_),
    .Q(_0030_),
    .CLK(clknet_leaf_20_clk_i));
 sg13g2_dfrbpq_1 _2973_ (.RESET_B(net1116),
    .D(_0278_),
    .Q(_0029_),
    .CLK(clknet_leaf_22_clk_i));
 sg13g2_dfrbpq_1 _2974_ (.RESET_B(net1116),
    .D(_0287_),
    .Q(_0038_),
    .CLK(clknet_leaf_22_clk_i));
 sg13g2_dfrbpq_1 _2975_ (.RESET_B(net1110),
    .D(_0277_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_0_),
    .CLK(clknet_leaf_4_clk_i));
 sg13g2_dfrbpq_1 _2976_ (.RESET_B(net1110),
    .D(_0276_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .CLK(clknet_leaf_3_clk_i));
 sg13g2_dfrbpq_1 _2977_ (.RESET_B(net1111),
    .D(_0275_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .CLK(clknet_leaf_4_clk_i));
 sg13g2_dfrbpq_1 _2978_ (.RESET_B(net1110),
    .D(_0274_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_3_),
    .CLK(clknet_leaf_4_clk_i));
 sg13g2_dfrbpq_1 _2979_ (.RESET_B(net1110),
    .D(_0288_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_u_fifo_cnt_rptr_wrap_cnt_q_4_),
    .CLK(clknet_leaf_13_clk_i));
 sg13g2_dfrbpq_1 _2980_ (.RESET_B(net1111),
    .D(_0161_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_0_),
    .CLK(clknet_leaf_13_clk_i));
 sg13g2_dfrbpq_1 _2981_ (.RESET_B(net1111),
    .D(_0160_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_1_),
    .CLK(clknet_leaf_13_clk_i));
 sg13g2_dfrbpq_1 _2982_ (.RESET_B(net1111),
    .D(_0159_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_2_),
    .CLK(clknet_leaf_4_clk_i));
 sg13g2_dfrbpq_1 _2983_ (.RESET_B(net1111),
    .D(_0158_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_3_),
    .CLK(clknet_leaf_4_clk_i));
 sg13g2_dfrbpq_1 _2984_ (.RESET_B(net1110),
    .D(_0305_),
    .Q(u_uart_core_u_uart_rxfifo_gen_normal_fifo_u_fifo_cnt_wptr_wrap_cnt_q_4_),
    .CLK(clknet_leaf_13_clk_i));
 sg13g2_dfrbpq_1 _2985_ (.RESET_B(net1115),
    .D(_0157_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_0_),
    .CLK(clknet_leaf_23_clk_i));
 sg13g2_dfrbpq_1 _2986_ (.RESET_B(net1115),
    .D(_0156_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_1_),
    .CLK(clknet_leaf_23_clk_i));
 sg13g2_dfrbpq_1 _2987_ (.RESET_B(net1115),
    .D(_0155_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_2_),
    .CLK(clknet_leaf_24_clk_i));
 sg13g2_dfrbpq_1 _2988_ (.RESET_B(net1115),
    .D(_0306_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_u_fifo_cnt_rptr_wrap_cnt_q_3_),
    .CLK(clknet_leaf_24_clk_i));
 sg13g2_dfrbpq_1 _2989_ (.RESET_B(net1115),
    .D(_0098_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_0_),
    .CLK(clknet_leaf_14_clk_i));
 sg13g2_dfrbpq_1 _2990_ (.RESET_B(net1115),
    .D(_0097_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_1_),
    .CLK(clknet_leaf_24_clk_i));
 sg13g2_dfrbpq_1 _2991_ (.RESET_B(net1115),
    .D(_0096_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_wptr_2_),
    .CLK(clknet_leaf_24_clk_i));
 sg13g2_dfrbpq_1 _2992_ (.RESET_B(net1115),
    .D(_0315_),
    .Q(u_uart_core_u_uart_txfifo_gen_normal_fifo_u_fifo_cnt_wptr_wrap_cnt_q_3_),
    .CLK(clknet_leaf_24_clk_i));
 sg13g2_dfrbpq_1 _2993_ (.RESET_B(net1108),
    .D(_0095_),
    .Q(u_uart_core_uart_rx_baud_div_q_0_),
    .CLK(clknet_leaf_19_clk_i));
 sg13g2_dfrbpq_1 _2994_ (.RESET_B(net1108),
    .D(_0094_),
    .Q(u_uart_core_uart_rx_baud_div_q_1_),
    .CLK(clknet_leaf_19_clk_i));
 sg13g2_dfrbpq_1 _2995_ (.RESET_B(net1108),
    .D(_0093_),
    .Q(u_uart_core_uart_rx_baud_div_q_2_),
    .CLK(clknet_leaf_19_clk_i));
 sg13g2_dfrbpq_1 _2996_ (.RESET_B(net1108),
    .D(_0316_),
    .Q(u_uart_core_uart_rx_baud_div_q_3_),
    .CLK(clknet_leaf_17_clk_i));
 sg13g2_dfrbpq_1 _2997_ (.RESET_B(net1109),
    .D(_0092_),
    .Q(u_uart_core_uart_rx_bit_cnt_q_0_),
    .CLK(clknet_leaf_23_clk_i));
 sg13g2_dfrbpq_1 _2998_ (.RESET_B(net1109),
    .D(_0091_),
    .Q(u_uart_core_uart_rx_bit_cnt_q_1_),
    .CLK(clknet_leaf_15_clk_i));
 sg13g2_dfrbpq_1 _2999_ (.RESET_B(net1109),
    .D(_0090_),
    .Q(u_uart_core_uart_rx_bit_cnt_q_2_),
    .CLK(clknet_leaf_14_clk_i));
 sg13g2_dfrbpq_1 _3000_ (.RESET_B(net1109),
    .D(_0317_),
    .Q(u_uart_core_uart_rx_bit_cnt_q_3_),
    .CLK(clknet_leaf_15_clk_i));
 sg13g2_dfrbpq_1 _3001_ (.RESET_B(net1109),
    .D(_0318_),
    .Q(_0046_),
    .CLK(clknet_leaf_15_clk_i));
 sg13g2_dfrbpq_1 _3002_ (.RESET_B(net1112),
    .D(_0089_),
    .Q(u_uart_core_uart_rx_sreg_q_1_),
    .CLK(clknet_leaf_14_clk_i));
 sg13g2_dfrbpq_1 _3003_ (.RESET_B(net1112),
    .D(_0088_),
    .Q(u_uart_core_uart_rx_sreg_q_2_),
    .CLK(clknet_leaf_14_clk_i));
 sg13g2_dfrbpq_1 _3004_ (.RESET_B(net1112),
    .D(_0087_),
    .Q(u_uart_core_uart_rx_sreg_q_3_),
    .CLK(clknet_leaf_14_clk_i));
 sg13g2_dfrbpq_1 _3005_ (.RESET_B(net1112),
    .D(_0086_),
    .Q(u_uart_core_uart_rx_sreg_q_4_),
    .CLK(clknet_leaf_34_clk_i));
 sg13g2_dfrbpq_1 _3006_ (.RESET_B(net1112),
    .D(_0085_),
    .Q(u_uart_core_uart_rx_sreg_q_5_),
    .CLK(clknet_leaf_35_clk_i));
 sg13g2_dfrbpq_1 _3007_ (.RESET_B(net1112),
    .D(_0084_),
    .Q(u_uart_core_uart_rx_sreg_q_6_),
    .CLK(clknet_leaf_34_clk_i));
 sg13g2_dfrbpq_1 _3008_ (.RESET_B(net1112),
    .D(_0083_),
    .Q(u_uart_core_uart_rx_sreg_q_7_),
    .CLK(clknet_leaf_24_clk_i));
 sg13g2_dfrbpq_1 _3009_ (.RESET_B(net1112),
    .D(_0082_),
    .Q(u_uart_core_uart_rx_sreg_q_8_),
    .CLK(clknet_leaf_14_clk_i));
 sg13g2_dfrbpq_1 _3010_ (.RESET_B(u_uart_core_rx_rst_ni),
    .D(_0081_),
    .Q(u_uart_core_uart_rx_sreg_q_9_),
    .CLK(clknet_leaf_13_clk_i));
 sg13g2_dfrbpq_1 _3011_ (.RESET_B(u_uart_core_rx_rst_ni),
    .D(_0319_),
    .Q(u_uart_core_uart_rx_sreg_q_10_),
    .CLK(clknet_leaf_13_clk_i));
 sg13g2_dfrbpq_1 _3012_ (.RESET_B(net1118),
    .D(_0080_),
    .Q(u_uart_core_uart_tx_baud_div_q_0_),
    .CLK(clknet_leaf_19_clk_i));
 sg13g2_dfrbpq_1 _3013_ (.RESET_B(net1118),
    .D(_0079_),
    .Q(u_uart_core_uart_tx_baud_div_q_1_),
    .CLK(clknet_leaf_18_clk_i));
 sg13g2_dfrbpq_1 _3014_ (.RESET_B(net1118),
    .D(_0078_),
    .Q(u_uart_core_uart_tx_baud_div_q_2_),
    .CLK(clknet_leaf_21_clk_i));
 sg13g2_dfrbpq_1 _3015_ (.RESET_B(net1118),
    .D(_0320_),
    .Q(u_uart_core_uart_tx_baud_div_q_3_),
    .CLK(clknet_leaf_19_clk_i));
 sg13g2_dfrbpq_1 _3016_ (.RESET_B(net1117),
    .D(_0077_),
    .Q(u_uart_core_uart_tx_bit_cnt_q_0_),
    .CLK(clknet_leaf_22_clk_i));
 sg13g2_dfrbpq_1 _3017_ (.RESET_B(net1117),
    .D(_0076_),
    .Q(u_uart_core_uart_tx_bit_cnt_q_1_),
    .CLK(clknet_leaf_20_clk_i));
 sg13g2_dfrbpq_1 _3018_ (.RESET_B(net1117),
    .D(_0075_),
    .Q(u_uart_core_uart_tx_bit_cnt_q_2_),
    .CLK(clknet_leaf_21_clk_i));
 sg13g2_dfrbpq_1 _3019_ (.RESET_B(net1117),
    .D(_0321_),
    .Q(u_uart_core_uart_tx_bit_cnt_q_3_),
    .CLK(clknet_leaf_20_clk_i));
 sg13g2_tiehi _3021__201 (.L_HI(reg_rsp_o[0]));
 ...
 sg13g2_buf_16 clkbuf_leaf_9_clk_i (.X(clknet_leaf_9_clk_i),
    .A(clknet_3_2__leaf_clk_i));
 sg13g2_buf_8 clkload0 (.A(clknet_leaf_39_clk_i));
 sg13g2_dlygate4sd3_1 hold750 (.A(rx_i),
    .X(net1128));
 sg13g2_dlygate4sd3_1 hold751 (.A(net623),
    .X(net1129));
 sg13g2_dlygate4sd3_1 hold752 (.A(reg_req_i[33]),
    .X(net1130));
 sg13g2_dlygate4sd3_1 hold753 (.A(reg_req_i[30]),
    .X(net1131));
 sg13g2_dlygate4sd3_1 hold754 (.A(reg_req_i[32]),
    .X(net1132));
 sg13g2_dlygate4sd3_1 hold755 (.A(reg_req_i[27]),
    .X(net1133));
 sg13g2_dlygate4sd3_1 hold756 (.A(reg_req_i[31]),
    .X(net1134));
 sg13g2_dlygate4sd3_1 hold757 (.A(reg_req_i[35]),
    .X(net1135));
 sg13g2_dlygate4sd3_1 hold758 (.A(_0324_),
    .X(net1136));
 sg13g2_dlygate4sd3_1 hold759 (.A(reg_req_i[34]),
    .X(net1137));
 sg13g2_dlygate4sd3_1 hold760 (.A(reg_req_i[28]),
    .X(net1138));
 sg13g2_dlygate4sd3_1 hold761 (.A(_0066_),
    .X(net1139));
 sg13g2_dlygate4sd3_1 hold762 (.A(reg_req_i[25]),
    .X(net1140));
 sg13g2_dlygate4sd3_1 hold763 (.A(reg_req_i[29]),
    .X(net1141));
 sg13g2_dlygate4sd3_1 hold764 (.A(_0065_),
    .X(net1142));
 sg13g2_dlygate4sd3_1 hold765 (.A(reg_req_i[21]),
    .X(net1143));
 sg13g2_dlygate4sd3_1 hold766 (.A(reg_req_i[7]),
    .X(net1144));
 sg13g2_dlygate4sd3_1 hold767 (.A(reg_req_i[24]),
    .X(net1145));
 sg13g2_dlygate4sd3_1 hold768 (.A(reg_req_i[26]),
    .X(net1146));
 sg13g2_dlygate4sd3_1 hold769 (.A(reg_req_i[11]),
    .X(net1147));
 sg13g2_dlygate4sd3_1 hold770 (.A(reg_req_i[42]),
    .X(net1148));
 sg13g2_dlygate4sd3_1 hold771 (.A(_1334_),
    .X(net1149));
 sg13g2_dlygate4sd3_1 hold772 (.A(_1345_),
    .X(net1150));
 sg13g2_dlygate4sd3_1 hold773 (.A(reg_req_i[23]),
    .X(net1151));
 sg13g2_dlygate4sd3_1 hold774 (.A(reg_req_i[22]),
    .X(net1152));
 sg13g2_dlygate4sd3_1 hold775 (.A(reg_req_i[20]),
    .X(net1153));
 sg13g2_dlygate4sd3_1 hold776 (.A(reg_req_i[10]),
    .X(net1154));
 sg13g2_dlygate4sd3_1 hold777 (.A(reg_req_i[8]),
    .X(net1155));
 sg13g2_dlygate4sd3_1 hold778 (.A(reg_req_i[5]),
    .X(net1156));
 sg13g2_dlygate4sd3_1 hold779 (.A(_0946_),
    .X(net1157));
 sg13g2_dlygate4sd3_1 hold780 (.A(_0332_),
    .X(net1158));
 sg13g2_dlygate4sd3_1 hold781 (.A(reg_req_i[6]),
    .X(net1159));
 sg13g2_dlygate4sd3_1 hold782 (.A(rst_ni),
    .X(net1160));
 sg13g2_dlygate4sd3_1 hold783 (.A(reg_req_i[4]),
    .X(net1161));
 sg13g2_dlygate4sd3_1 hold784 (.A(_0945_),
    .X(net1162));
 sg13g2_dlygate4sd3_1 hold785 (.A(_0331_),
    .X(net1163));
 sg13g2_dlygate4sd3_1 hold786 (.A(reg_req_i[40]),
    .X(net1164));
 sg13g2_dlygate4sd3_1 hold787 (.A(_1336_),
    .X(net1165));
 sg13g2_dlygate4sd3_1 hold788 (.A(u_uart_reg_u_reg_core_fifo_ctrl_flds_we_0_),
    .X(net1166));
 sg13g2_dlygate4sd3_1 hold789 (.A(reg_req_i[41]),
    .X(net1167));
 sg13g2_dlygate4sd3_1 hold790 (.A(reg_req_i[9]),
    .X(net1168));
 sg13g2_dlygate4sd3_1 hold791 (.A(reg_req_i[39]),
    .X(net1169));
 sg13g2_dlygate4sd3_1 hold792 (.A(_1096_),
    .X(net1170));
 sg13g2_dlygate4sd3_1 hold793 (.A(_1343_),
    .X(net1171));
 sg13g2_buf_1 input202 (.A(reg_req_i[0]),
    .X(net587));
 sg13g2_buf_1 input203 (.A(net1154),
    .X(net588));
 sg13g2_buf_1 input204 (.A(net1147),
    .X(net589));
 sg13g2_buf_1 input205 (.A(reg_req_i[1]),
    .X(net590));
 sg13g2_buf_1 input206 (.A(net1153),
    .X(net591));
 sg13g2_buf_1 input207 (.A(net1143),
    .X(net592));
 sg13g2_buf_1 input208 (.A(net1152),
    .X(net593));
 sg13g2_buf_1 input209 (.A(net1151),
    .X(net594));
 sg13g2_buf_1 input210 (.A(net1145),
    .X(net595));
 sg13g2_buf_1 input211 (.A(net1140),
    .X(net596));
 sg13g2_buf_1 input212 (.A(net1146),
    .X(net597));
 sg13g2_buf_1 input213 (.A(net1133),
    .X(net598));
 sg13g2_buf_1 input214 (.A(net1138),
    .X(net599));
 sg13g2_buf_1 input215 (.A(net1141),
    .X(net600));
 sg13g2_buf_1 input216 (.A(reg_req_i[2]),
    .X(net601));
 sg13g2_buf_1 input217 (.A(net1131),
    .X(net602));
 sg13g2_buf_1 input218 (.A(net1134),
    .X(net603));
 sg13g2_buf_1 input219 (.A(net1132),
    .X(net604));
 sg13g2_buf_1 input220 (.A(net1130),
    .X(net605));
 sg13g2_buf_1 input221 (.A(net1137),
    .X(net606));
 sg13g2_buf_1 input222 (.A(net1135),
    .X(net607));
 sg13g2_buf_1 input223 (.A(reg_req_i[36]),
    .X(net608));
 sg13g2_buf_1 input224 (.A(reg_req_i[37]),
    .X(net609));
 sg13g2_buf_1 input225 (.A(reg_req_i[38]),
    .X(net610));
 sg13g2_buf_1 input226 (.A(net1169),
    .X(net611));
 sg13g2_buf_1 input227 (.A(reg_req_i[3]),
    .X(net612));
 sg13g2_buf_1 input228 (.A(net1164),
    .X(net613));
 sg13g2_buf_1 input229 (.A(net1167),
    .X(net614));
 sg13g2_buf_1 input230 (.A(net1148),
    .X(net615));
 sg13g2_buf_1 input231 (.A(net1161),
    .X(net616));
 sg13g2_buf_1 input232 (.A(net1156),
    .X(net617));
 sg13g2_buf_1 input233 (.A(net1159),
    .X(net618));
 sg13g2_buf_1 input234 (.A(net1144),
    .X(net619));
 sg13g2_buf_1 input235 (.A(net1155),
    .X(net620));
 sg13g2_buf_1 input236 (.A(net1168),
    .X(net621));
 sg13g2_buf_1 input237 (.A(net1160),
    .X(net622));
 sg13g2_buf_1 input238 (.A(net1128),
    .X(net623));
 sg13g2_buf_1 output239 (.A(net1055),
    .X(reg_rsp_o[10]));
 sg13g2_buf_1 output240 (.A(net1055),
    .X(reg_rsp_o[11]));
 sg13g2_buf_1 output241 (.A(net1055),
    .X(reg_rsp_o[12]));
 sg13g2_buf_1 output242 (.A(net1055),
    .X(reg_rsp_o[13]));
 sg13g2_buf_1 output243 (.A(net1055),
    .X(reg_rsp_o[14]));
 sg13g2_buf_1 output244 (.A(net1055),
    .X(reg_rsp_o[15]));
 sg13g2_buf_1 output245 (.A(net1055),
    .X(reg_rsp_o[16]));
 sg13g2_buf_1 output246 (.A(net1055),
    .X(reg_rsp_o[17]));
 sg13g2_buf_1 output247 (.A(net625),
    .X(reg_rsp_o[18]));
 sg13g2_buf_1 output248 (.A(net626),
    .X(reg_rsp_o[19]));
 sg13g2_buf_1 output249 (.A(net627),
    .X(reg_rsp_o[1]));
 sg13g2_buf_1 output250 (.A(net628),
    .X(reg_rsp_o[20]));
 sg13g2_buf_1 output251 (.A(net629),
    .X(reg_rsp_o[21]));
 sg13g2_buf_1 output252 (.A(net630),
    .X(reg_rsp_o[22]));
 sg13g2_buf_1 output253 (.A(net631),
    .X(reg_rsp_o[23]));
 sg13g2_buf_1 output254 (.A(net632),
    .X(reg_rsp_o[24]));
 sg13g2_buf_1 output255 (.A(net633),
    .X(reg_rsp_o[25]));
 sg13g2_buf_1 output256 (.A(net634),
    .X(reg_rsp_o[26]));
 sg13g2_buf_1 output257 (.A(net635),
    .X(reg_rsp_o[27]));
 sg13g2_buf_1 output258 (.A(net636),
    .X(reg_rsp_o[28]));
 sg13g2_buf_1 output259 (.A(net637),
    .X(reg_rsp_o[29]));
 sg13g2_buf_1 output260 (.A(net638),
    .X(reg_rsp_o[2]));
 sg13g2_buf_1 output261 (.A(net639),
    .X(reg_rsp_o[30]));
 sg13g2_buf_1 output262 (.A(net640),
    .X(reg_rsp_o[31]));
 sg13g2_buf_1 output263 (.A(net641),
    .X(reg_rsp_o[32]));
 sg13g2_buf_1 output264 (.A(net642),
    .X(reg_rsp_o[33]));
 sg13g2_buf_1 output265 (.A(net643),
    .X(reg_rsp_o[3]));
 sg13g2_buf_1 output266 (.A(net644),
    .X(reg_rsp_o[4]));
 sg13g2_buf_1 output267 (.A(net645),
    .X(reg_rsp_o[5]));
 sg13g2_buf_1 output268 (.A(net646),
    .X(reg_rsp_o[6]));
 sg13g2_buf_1 output269 (.A(net647),
    .X(reg_rsp_o[7]));
 sg13g2_buf_1 output270 (.A(net648),
    .X(reg_rsp_o[8]));
 sg13g2_buf_1 output271 (.A(net649),
    .X(reg_rsp_o[9]));
 sg13g2_buf_1 output272 (.A(net650),
    .X(tx_o));
 sg13g2_buf_1 place599 (.A(_0608_),
    .X(net977));
 sg13g2_buf_1 place600 (.A(_0608_),
    .X(net978));
 sg13g2_buf_1 place601 (.A(net980),
    .X(net979));
 sg13g2_buf_1 place602 (.A(_0556_),
    .X(net980));
 sg13g2_buf_1 place603 (.A(net982),
    .X(net981));
 sg13g2_buf_1 place604 (.A(_0706_),
    .X(net982));
 sg13g2_buf_1 place605 (.A(net984),
    .X(net983));
 sg13g2_buf_1 place606 (.A(_0688_),
    .X(net984));
 sg13g2_buf_1 place607 (.A(_0663_),
    .X(net985));
 sg13g2_buf_1 place608 (.A(_0663_),
    .X(net986));
 sg13g2_buf_1 place609 (.A(_0645_),
    .X(net987));
 sg13g2_buf_1 place610 (.A(_0645_),
    .X(net988));
 sg13g2_buf_1 place611 (.A(net990),
    .X(net989));
 sg13g2_buf_1 place612 (.A(_0627_),
    .X(net990));
 sg13g2_buf_1 place613 (.A(net992),
    .X(net991));
 sg13g2_buf_1 place614 (.A(_0568_),
    .X(net992));
 sg13g2_buf_1 place615 (.A(net994),
    .X(net993));
 sg13g2_buf_1 place616 (.A(_0724_),
    .X(net994));
 sg13g2_buf_1 place617 (.A(_0715_),
    .X(net995));
 sg13g2_buf_1 place618 (.A(_0715_),
    .X(net996));
 sg13g2_buf_1 place619 (.A(_0697_),
    .X(net997));
 sg13g2_buf_1 place620 (.A(_0697_),
    .X(net998));
 sg13g2_buf_1 place621 (.A(net1000),
    .X(net999));
 sg13g2_buf_1 place622 (.A(_0679_),
    .X(net1000));
 sg13g2_buf_1 place623 (.A(_0654_),
    .X(net1001));
 sg13g2_buf_1 place624 (.A(_0654_),
    .X(net1002));
 sg13g2_buf_1 place625 (.A(net1004),
    .X(net1003));
 sg13g2_buf_1 place626 (.A(_0636_),
    .X(net1004));
 sg13g2_buf_1 place627 (.A(_0618_),
    .X(net1005));
 sg13g2_buf_1 place628 (.A(_0618_),
    .X(net1006));
 sg13g2_buf_1 place629 (.A(net1008),
    .X(net1007));
 sg13g2_buf_1 place630 (.A(_0599_),
    .X(net1008));
 sg13g2_buf_1 place631 (.A(_0492_),
    .X(net1009));
 sg13g2_buf_1 place632 (.A(_0474_),
    .X(net1010));
 sg13g2_buf_1 place633 (.A(net1012),
    .X(net1011));
 sg13g2_buf_1 place634 (.A(_0451_),
    .X(net1012));
 sg13g2_buf_1 place635 (.A(_0365_),
    .X(net1013));
 sg13g2_buf_1 place636 (.A(_0530_),
    .X(net1014));
 sg13g2_buf_1 place637 (.A(_0515_),
    .X(net1015));
 sg13g2_buf_1 place638 (.A(_0515_),
    .X(net1016));
 sg13g2_buf_1 place639 (.A(_0511_),
    .X(net1017));
 sg13g2_buf_1 place640 (.A(net1019),
    .X(net1018));
 sg13g2_buf_1 place641 (.A(_0496_),
    .X(net1019));
 sg13g2_buf_1 place642 (.A(net1021),
    .X(net1020));
 sg13g2_buf_1 place643 (.A(_0477_),
    .X(net1021));
 sg13g2_buf_1 place644 (.A(_0400_),
    .X(net1022));
 sg13g2_buf_1 place645 (.A(net1150),
    .X(net1023));
 sg13g2_buf_1 place646 (.A(net1025),
    .X(net1024));
 sg13g2_buf_1 place647 (.A(_1345_),
    .X(net1025));
 sg13g2_buf_1 place648 (.A(net1027),
    .X(net1026));
 sg13g2_buf_1 place649 (.A(net1150),
    .X(net1027));
 sg13g2_buf_1 place650 (.A(net1029),
    .X(net1028));
 sg13g2_buf_1 place651 (.A(_1345_),
    .X(net1029));
 sg13g2_buf_1 place652 (.A(_1343_),
    .X(net1030));
 sg13g2_buf_1 place653 (.A(_0403_),
    .X(net1031));
 sg13g2_buf_1 place654 (.A(_0360_),
    .X(net1032));
 sg13g2_buf_1 place655 (.A(net1034),
    .X(net1033));
 sg13g2_buf_1 place656 (.A(_1099_),
    .X(net1034));
 sg13g2_buf_1 place657 (.A(_0894_),
    .X(net1035));
 sg13g2_buf_1 place658 (.A(_0894_),
    .X(net1036));
 sg13g2_buf_1 place659 (.A(_0595_),
    .X(net1037));
 sg13g2_buf_1 place660 (.A(_0595_),
    .X(net1038));
 sg13g2_buf_1 place661 (.A(_0591_),
    .X(net1039));
 sg13g2_buf_1 place662 (.A(_0591_),
    .X(net1040));
 sg13g2_buf_1 place663 (.A(_0587_),
    .X(net1041));
 sg13g2_buf_1 place664 (.A(_0587_),
    .X(net1042));
 sg13g2_buf_1 place665 (.A(_0583_),
    .X(net1043));
 sg13g2_buf_1 place666 (.A(_0583_),
    .X(net1044));
 sg13g2_buf_1 place667 (.A(_0579_),
    .X(net1045));
 sg13g2_buf_1 place668 (.A(_0579_),
    .X(net1046));
 sg13g2_buf_1 place669 (.A(_0575_),
    .X(net1047));
 sg13g2_buf_1 place670 (.A(_0575_),
    .X(net1048));
 sg13g2_buf_1 place671 (.A(_0571_),
    .X(net1049));
 sg13g2_buf_1 place672 (.A(_0571_),
    .X(net1050));
 sg13g2_buf_1 place673 (.A(net1052),
    .X(net1051));
 sg13g2_buf_1 place674 (.A(_1238_),
    .X(net1052));
 sg13g2_buf_1 place675 (.A(net1054),
    .X(net1053));
 sg13g2_buf_1 place676 (.A(_1234_),
    .X(net1054));
 sg13g2_buf_1 place677 (.A(net1056),
    .X(net1055));
 sg13g2_buf_1 place678 (.A(net624),
    .X(net1056));
 sg13g2_buf_1 place679 (.A(net1058),
    .X(net1057));
 sg13g2_buf_1 place680 (.A(_1093_),
    .X(net1058));
 sg13g2_buf_1 place681 (.A(net1060),
    .X(net1059));
 sg13g2_buf_1 place682 (.A(_1236_),
    .X(net1060));
 sg13g2_buf_1 place683 (.A(_1232_),
    .X(net1061));
 sg13g2_buf_1 place684 (.A(_1232_),
    .X(net1062));
 sg13g2_buf_1 place685 (.A(_1091_),
    .X(net1063));
 sg13g2_buf_1 place686 (.A(_0756_),
    .X(net1064));
 sg13g2_buf_1 place687 (.A(_0756_),
    .X(net1065));
 sg13g2_buf_1 place688 (.A(_1265_),
    .X(net1066));
 sg13g2_buf_1 place689 (.A(_1223_),
    .X(net1067));
 sg13g2_buf_1 place690 (.A(net1069),
    .X(net1068));
 sg13g2_buf_1 place691 (.A(_1223_),
    .X(net1069));
 sg13g2_buf_1 place692 (.A(_1201_),
    .X(net1070));
 sg13g2_buf_1 place693 (.A(_1201_),
    .X(net1071));
 sg13g2_buf_1 place694 (.A(_1201_),
    .X(net1072));
 sg13g2_buf_1 place695 (.A(_1200_),
    .X(net1073));
 sg13g2_buf_1 place696 (.A(_1200_),
    .X(net1074));
 sg13g2_buf_1 place697 (.A(_1195_),
    .X(net1075));
 sg13g2_buf_1 place698 (.A(_1186_),
    .X(net1076));
 sg13g2_buf_1 place699 (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_2_),
    .X(net1077));
 sg13g2_buf_1 place700 (.A(net1079),
    .X(net1078));
 sg13g2_buf_1 place701 (.A(net1080),
    .X(net1079));
 sg13g2_buf_1 place702 (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_1_),
    .X(net1080));
 sg13g2_buf_1 place703 (.A(net1084),
    .X(net1081));
 sg13g2_buf_1 place704 (.A(net1084),
    .X(net1082));
 sg13g2_buf_1 place705 (.A(net1084),
    .X(net1083));
 sg13g2_buf_1 place706 (.A(net1089),
    .X(net1084));
 sg13g2_buf_1 place707 (.A(net1088),
    .X(net1085));
 sg13g2_buf_1 place708 (.A(net1088),
    .X(net1086));
 sg13g2_buf_1 place709 (.A(net1088),
    .X(net1087));
 sg13g2_buf_1 place710 (.A(net1089),
    .X(net1088));
 sg13g2_buf_1 place711 (.A(net1090),
    .X(net1089));
 sg13g2_buf_1 place712 (.A(u_uart_core_u_uart_txfifo_gen_normal_fifo_fifo_rptr_0_),
    .X(net1090));
 sg13g2_buf_1 place713 (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_3_),
    .X(net1091));
 sg13g2_buf_1 place714 (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_wptr_2_),
    .X(net1092));
 sg13g2_buf_1 place715 (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_3_),
    .X(net1093));
 sg13g2_buf_1 place716 (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .X(net1094));
 sg13g2_buf_1 place717 (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_2_),
    .X(net1095));
 sg13g2_buf_1 place718 (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_1_),
    .X(net1096));
 sg13g2_buf_1 place719 (.A(net1099),
    .X(net1097));
 sg13g2_buf_1 place720 (.A(net1099),
    .X(net1098));
 sg13g2_buf_1 place721 (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_0_),
    .X(net1099));
 sg13g2_buf_1 place722 (.A(net1101),
    .X(net1100));
 sg13g2_buf_1 place723 (.A(net1102),
    .X(net1101));
 sg13g2_buf_1 place724 (.A(u_uart_core_u_uart_rxfifo_gen_normal_fifo_fifo_rptr_0_),
    .X(net1102));
 sg13g2_buf_1 place725 (.A(net1107),
    .X(net1103));
 sg13g2_buf_1 place726 (.A(net1106),
    .X(net1104));
 sg13g2_buf_1 place727 (.A(net1106),
    .X(net1105));
 sg13g2_buf_1 place728 (.A(net1107),
    .X(net1106));
 sg13g2_buf_1 place729 (.A(reg_rst_ni),
    .X(net1107));
 sg13g2_buf_1 place730 (.A(u_uart_core_rx_rst_ni),
    .X(net1108));
 sg13g2_buf_1 place731 (.A(u_uart_core_rx_rst_ni),
    .X(net1109));
 sg13g2_buf_1 place732 (.A(net1111),
    .X(net1110));
 sg13g2_buf_1 place733 (.A(u_uart_core_rx_rst_ni),
    .X(net1111));
 sg13g2_buf_1 place734 (.A(u_uart_core_rx_rst_ni),
    .X(net1112));
 sg13g2_buf_1 place735 (.A(net1114),
    .X(net1113));
 sg13g2_buf_1 place736 (.A(u_uart_core_timing_rst_ni),
    .X(net1114));
 sg13g2_buf_1 place737 (.A(u_uart_core_tx_rst_ni),
    .X(net1115));
 sg13g2_buf_1 place738 (.A(net1117),
    .X(net1116));
 sg13g2_buf_1 place739 (.A(net1118),
    .X(net1117));
 sg13g2_buf_1 place740 (.A(u_uart_core_tx_rst_ni),
    .X(net1118));
 sg13g2_buf_1 place741 (.A(reg2hw_11_),
    .X(net1119));
 sg13g2_buf_1 place742 (.A(reg2hw_10_),
    .X(net1120));
 sg13g2_buf_1 place743 (.A(reg2hw_9_),
    .X(net1121));
 sg13g2_buf_1 place744 (.A(reg2hw_8_),
    .X(net1122));
 sg13g2_buf_1 place745 (.A(reg2hw_7_),
    .X(net1123));
 sg13g2_buf_1 place746 (.A(reg2hw_6_),
    .X(net1124));
 sg13g2_buf_1 place747 (.A(reg2hw_5_),
    .X(net1125));
 sg13g2_buf_1 place748 (.A(net1127),
    .X(net1126));
 sg13g2_buf_1 place749 (.A(reg2hw_39_),
    .X(net1127));
endmodule
