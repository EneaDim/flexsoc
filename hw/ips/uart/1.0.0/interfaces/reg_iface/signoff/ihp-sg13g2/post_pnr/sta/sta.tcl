...
#   GLS report    : not used
#   Report dir    : /tmp/flexsoc-ip-release/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/post_pnr/sta/template_reports
#
# Limitations:
...
set report_dir {/tmp/flexsoc-ip-release/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/post_pnr/sta/template_reports}
...
puts $fp "analysis=sta corner=tt mode=setup stage=post_route"
...
puts $fp "clock_network=propagated"
puts $fp "interconnect=spef"
close $fp
