...
#   Netlist       : /tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/syn/ihp-sg13g2/uart_synth.v
#   SDC           : /tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/constraints/uart.sdc
#   SPEF          : not used
#   VCD or SAIF   : /tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/power/activity/ACTIVITY_REQUIRED.vcd
#   Activity scope: DUT_SCOPE_REQUIRED
#   GLS report    : /tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/power/activity/GLS_REPORT_REQUIRED.json
#   Report dir    : /tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/power/analysis/template_reports
#
# Limitations:
...
set report_dir {/tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/power/analysis/template_reports}
...
set macro_liberties {}
set netlist {/tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/syn/ihp-sg13g2/uart_synth.v}
set sdc {/tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/constraints/uart.sdc}
set spef {}
set top {uart}
set stage {post_syn}
...
set activity_file {/tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/power/activity/ACTIVITY_REQUIRED.vcd}
...
puts $fp "gls_report=/tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/power/activity/GLS_REPORT_REQUIRED.json"
puts $fp "activity_file=/tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/power/activity/ACTIVITY_REQUIRED.vcd"
