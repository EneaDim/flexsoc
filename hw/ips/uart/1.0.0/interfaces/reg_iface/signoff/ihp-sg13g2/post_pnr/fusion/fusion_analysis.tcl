...
#   Report dir    : /tmp/flexsoc-ip-release/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/post_pnr/fusion/template_reports
#
# Limitations:
...
set report_dir {/tmp/flexsoc-ip-release/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/post_pnr/fusion/template_reports}
...
puts $fp "analysis=fusion_analysis corner=tt mode=setup stage=post_route"
