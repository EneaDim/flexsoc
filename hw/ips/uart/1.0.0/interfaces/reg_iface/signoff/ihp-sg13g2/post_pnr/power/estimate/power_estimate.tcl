...
#   GLS report    : not used
#   Report dir    : /tmp/flexsoc-ip-release/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/post_pnr/power/estimate/template_reports
#
# Limitations:
...
set report_dir {/tmp/flexsoc-ip-release/uart-reg_iface/runs/uart/release/signoff/ihp-sg13g2/post_pnr/power/estimate/template_reports}
...
puts $fp "duty=0.5"
puts $fp "corner=tt stage=post_route"
