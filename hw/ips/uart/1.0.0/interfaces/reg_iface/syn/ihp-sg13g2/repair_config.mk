...
export SYNTH_NETLIST_FILES := /tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/syn/ihp-sg13g2/uart_synth_raw.v
export SDC_FILE             := /tmp/flexsoc-ip-v1-release-20260914/uart-reg_iface/runs/uart/release/constraints/uart.sdc
