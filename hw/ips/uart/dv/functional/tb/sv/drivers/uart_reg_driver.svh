...
function automatic bit tb_lookup_reg_addr(input string reg_key, output logic [31:0] addr);
  case (reg_key)
    ...
    "clk_i.RDATA": begin addr = 32'h00000008; return 1'b1; end
    "RDATA": begin addr = 32'h00000008; return 1'b1; end
    "clk_i.WDATA": begin addr = 32'h0000000c; return 1'b1; end
    "WDATA": begin addr = 32'h0000000c; return 1'b1; end
    "clk_i.FIFO_CTRL": begin addr = 32'h00000010; return 1'b1; end
    "FIFO_CTRL": begin addr = 32'h00000010; return 1'b1; end
    "clk_i.FIFO_STATUS": begin addr = 32'h00000014; return 1'b1; end
    "FIFO_STATUS": begin addr = 32'h00000014; return 1'b1; end
    default: begin end
  endcase
