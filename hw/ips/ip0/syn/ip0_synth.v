...
(* top =  1  *)
(* src = "../workspace/runs/ip0/dev/rtl/ip0.sv:4.8" *)
module ip0(clk_i, rst_ni, tl_i, tl_o, port_i, port_o);
  (* hdlname = "clk_i" *)
  (* src = "../workspace/runs/ip0/dev/rtl/ip0.sv:8.10" *)
  input clk_i;
  wire clk_i;
  (* hdlname = "rst_ni" *)
  (* src = "../workspace/runs/ip0/dev/rtl/ip0.sv:9.10" *)
  input rst_ni;
  wire rst_ni;
  (* hdlname = "tl_i" *)
  (* src = "../workspace/runs/ip0/dev/rtl/ip0.sv:12.29" *)
  input [108:0] tl_i;
  wire [108:0] tl_i;
  (* hdlname = "tl_o" *)
  (* src = "../workspace/runs/ip0/dev/rtl/ip0.sv:13.29" *)
  output [65:0] tl_o;
  wire [65:0] tl_o;
  (* hdlname = "port_i" *)
  (* src = "../workspace/runs/ip0/dev/rtl/ip0.sv:16.16" *)
  input port_i;
  wire port_i;
  (* hdlname = "port_o" *)
  (* src = "../workspace/runs/ip0/dev/rtl/ip0.sv:17.16" *)
  output port_o;
  wire port_o;
  wire _000_;
  wire _001_;
  ...
  wire _124_;
  (* hdlname = "reg2hw" *)
  (* src = "../workspace/runs/ip0/dev/rtl/ip0.sv:20.16" *)
  wire [39:0] reg2hw;
  (* hdlname = "u_ip0_core u_sync_name intq" *)
  (* src = "../hw/ips/prim/prim_ff_2sync.sv:12.21" *)
  wire \u_ip0_core.u_sync_name.intq ;
  ...
  sky130_fd_sc_hd__dfrtp_1 _301_ (
    .CLK(clk_i),
    .D(port_i),
    .Q(\u_ip0_core.u_sync_name.intq ),
    .RESET_B(rst_ni)
  );
  (* src = "../hw/ips/prim_opentitan/prim_flop.sv:17.3" *)
  sky130_fd_sc_hd__dfrtp_1 _302_ (
    .CLK(clk_i),
    .D(\u_ip0_core.u_sync_name.intq ),
    .Q(port_o),
    .RESET_B(rst_ni)
  );
  (* src = "../hw/ips/tlul/tlul_adapter_reg.sv:100.3" *)
