...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , __PVT__top_pkg{vlSymsp->TOP.__PVT__top_pkg}
    , __PVT__prim_secded_pkg{vlSymsp->TOP.__PVT__prim_secded_pkg}
    , __PVT__prim_alert_pkg{vlSymsp->TOP.__PVT__prim_alert_pkg}
    , __PVT__cordic_lut_pkg{vlSymsp->TOP.__PVT__cordic_lut_pkg}
    , __PVT__cordic_reg_pkg{vlSymsp->TOP.__PVT__cordic_reg_pkg}
    , __PVT__prim_mubi_pkg{vlSymsp->TOP.__PVT__prim_mubi_pkg}
    , __PVT__tlul_pkg{vlSymsp->TOP.__PVT__tlul_pkg}
    , rootp{&(vlSymsp->TOP)}
{
