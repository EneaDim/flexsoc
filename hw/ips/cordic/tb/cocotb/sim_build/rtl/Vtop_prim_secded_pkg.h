...
class alignas(VL_CACHE_LINE_BYTES) Vtop_prim_secded_pkg final {
  public:
    ...
    static constexpr VlWide<3>/*71:0*/ Secded7264ZeroWord = VlWide<3>{{0x00000000, 0x00000000, 0x00000000}};
    static constexpr IData/*21:0*/ SecdedHamming2216ZeroWord = 0U;
    static constexpr VlWide<3>/*71:0*/ SecdedHamming7264ZeroWord = VlWide<3>{{0x00000000, 0x00000000, 0x00000000}};
    static constexpr VlWide<3>/*75:0*/ SecdedHamming7668ZeroWord = VlWide<3>{{0x00000000, 0x00000000, 0x00000000}};
    ...
    static constexpr VlWide<3>/*71:0*/ SecdedInv7264ZeroWord = VlWide<3>{{0x00000000, 0x00000000, 0x000000aa}};
    static constexpr IData/*21:0*/ SecdedInvHamming2216ZeroWord = 0x002a0000U;
    static constexpr VlWide<3>/*71:0*/ SecdedInvHamming7264ZeroWord = VlWide<3>{{0x00000000, 0x00000000, 0x000000aa}};
    static constexpr VlWide<3>/*75:0*/ SecdedInvHamming7668ZeroWord = VlWide<3>{{0x00000000, 0x00000000, 0x00000aa0}};
