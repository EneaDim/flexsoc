...
#   Netlist       : /tmp/flexsoc-repack/cordic/runs/cordic/dev/syn/ihp-sg13g2/cordic_synth.v
#   SDC           : /tmp/flexsoc-repack/cordic/runs/cordic/dev/constraints/cordic.sdc
#   SPEF          : not used
#   VCD or SAIF   : /tmp/flexsoc-repack/cordic/runs/cordic/dev/signoff/ihp-sg13g2/power/activity/ACTIVITY_REQUIRED.vcd
#   Activity scope: DUT_SCOPE_REQUIRED
#   GLS report    : /tmp/flexsoc-repack/cordic/runs/cordic/dev/signoff/ihp-sg13g2/power/activity/GLS_REPORT_REQUIRED.json
#   Report dir    : /tmp/flexsoc-repack/cordic/runs/cordic/dev/signoff/ihp-sg13g2/power/analysis/template_reports
#
# Limitations:
...
set report_dir {/tmp/flexsoc-repack/cordic/runs/cordic/dev/signoff/ihp-sg13g2/power/analysis/template_reports}
...
set macro_liberties {}
set netlist {/tmp/flexsoc-repack/cordic/runs/cordic/dev/syn/ihp-sg13g2/cordic_synth.v}
...
set activity_file {/tmp/flexsoc-repack/cordic/runs/cordic/dev/signoff/ihp-sg13g2/power/activity/ACTIVITY_REQUIRED.vcd}
...
puts $fp "gls_report=/tmp/flexsoc-repack/cordic/runs/cordic/dev/signoff/ihp-sg13g2/power/activity/GLS_REPORT_REQUIRED.json"
puts $fp "activity_file=/tmp/flexsoc-repack/cordic/runs/cordic/dev/signoff/ihp-sg13g2/power/activity/ACTIVITY_REQUIRED.vcd"
