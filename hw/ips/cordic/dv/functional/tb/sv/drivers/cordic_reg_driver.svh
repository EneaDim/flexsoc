...
function automatic logic [32:0] tb_lookup_reg_addr(input string reg_key);
  ...
  case (reg_key)
    ...
    "clk_i.STATUS": begin addr = 32'h00000004; found = 1'b1; end
    "STATUS": begin addr = 32'h00000004; found = 1'b1; end
    "clk_i.X_IN": begin addr = 32'h00000008; found = 1'b1; end
    "X_IN": begin addr = 32'h00000008; found = 1'b1; end
    "clk_i.Y_IN": begin addr = 32'h0000000c; found = 1'b1; end
    "Y_IN": begin addr = 32'h0000000c; found = 1'b1; end
    "clk_i.Z_IN": begin addr = 32'h00000010; found = 1'b1; end
    "Z_IN": begin addr = 32'h00000010; found = 1'b1; end
    "clk_i.X_OUT": begin addr = 32'h00000014; found = 1'b1; end
    "X_OUT": begin addr = 32'h00000014; found = 1'b1; end
    "clk_i.Y_OUT": begin addr = 32'h00000018; found = 1'b1; end
    "Y_OUT": begin addr = 32'h00000018; found = 1'b1; end
    "clk_i.Z_OUT": begin addr = 32'h0000001c; found = 1'b1; end
    "Z_OUT": begin addr = 32'h0000001c; found = 1'b1; end
    "clk_i.CFG": begin addr = 32'h00000020; found = 1'b1; end
    "CFG": begin addr = 32'h00000020; found = 1'b1; end
    default: begin end
  endcase
