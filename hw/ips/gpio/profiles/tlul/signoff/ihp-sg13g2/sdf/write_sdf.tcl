...
#   GLS report    : not used
#   Report dir    : /tmp/flexsoc-repack/gpio/runs/gpio/dev/signoff/ihp-sg13g2/sdf/template_reports
#
# Limitations:
...
set report_dir {/tmp/flexsoc-repack/gpio/runs/gpio/dev/signoff/ihp-sg13g2/sdf/template_reports}
...
set sdf_file {/tmp/flexsoc-repack/gpio/runs/gpio/dev/signoff/ihp-sg13g2/sdf/template_reports/gpio_tt.sdf}
puts "sdf=$sdf_file"
