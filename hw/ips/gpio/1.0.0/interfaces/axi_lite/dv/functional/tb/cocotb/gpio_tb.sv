...
module gpio_tb;
  ...
  logic [gpio_reg_pkg::AW-1:0] axi_aw_addr_i;
  logic [2:0] axi_aw_prot_i;
  logic axi_aw_valid_i;
  logic axi_aw_ready_o;
  logic [gpio_reg_pkg::DW-1:0] axi_w_data_i;
  logic [gpio_reg_pkg::DBW-1:0] axi_w_strb_i;
  logic axi_w_valid_i;
  logic axi_w_ready_o;
  logic [1:0] axi_b_resp_o;
  logic axi_b_valid_o;
  logic axi_b_ready_i;
  logic [gpio_reg_pkg::AW-1:0] axi_ar_addr_i;
  logic [2:0] axi_ar_prot_i;
  logic axi_ar_valid_i;
  logic axi_ar_ready_o;
  logic [gpio_reg_pkg::DW-1:0] axi_r_data_o;
  ...
  `ifdef FLEXSOC_ENABLE_SDF
    ...
    initial begin
      ...
      if (sdf_path != "") $sdf_annotate(sdf_path, u_gpio);
    end
  `endif
  gpio u_gpio (.*);
endmodule
