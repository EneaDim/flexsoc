// Auto-generated AXI4-Lite testbench helper.
...
task automatic axi_lite_write(
    input logic [gpio_reg_pkg::AW-1:0] addr,
    input logic [gpio_reg_pkg::DW-1:0] data,
    input logic [gpio_reg_pkg::DBW-1:0] strb);
  int guard;
  bit aw_done;
  bit w_done;
...
task automatic axi_lite_read(
    input logic [gpio_reg_pkg::AW-1:0] addr,
    output logic [gpio_reg_pkg::DW-1:0] data);
  int guard;
