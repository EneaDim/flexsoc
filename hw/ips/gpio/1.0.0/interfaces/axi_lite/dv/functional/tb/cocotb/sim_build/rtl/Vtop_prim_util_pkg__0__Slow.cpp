...
VL_ATTR_COLD void Vtop_prim_util_pkg___configure_coverage(Vtop_prim_util_pkg* vlSelf, bool first) {
    ...
    vlSelf->__vlCoverInsert(vlSymsp->__Vcoverage + 5946, first, false, "/home/eneadim/github/flexsoc/hw/ips/pkgs/prim_util_pkg.sv", 34, 5, "", "v_line/prim_util_pkg", "block", "34-35", "", "", "", "");
}
