`ifdef VERILATOR
// Auto-generated register helper for gpio.
//
// Config format:
...
function automatic logic [32:0] tb_lookup_reg_addr(input string reg_key);
  ...
  found = 1'b0;
  case (reg_key)
    "clk_i.DATA_IN": begin addr = 32'h00000000; found = 1'b1; end
    "DATA_IN": begin addr = 32'h00000000; found = 1'b1; end
    "clk_i.DIRECT": begin addr = 32'h00000004; found = 1'b1; end
    "DIRECT": begin addr = 32'h00000004; found = 1'b1; end
    "clk_i.INTR_CTRL": begin addr = 32'h00000008; found = 1'b1; end
    "INTR_CTRL": begin addr = 32'h00000008; found = 1'b1; end
    default: begin end
  endcase
...
task automatic tb_reg_write_addr(
  ...
  axi_lite_write(addr[gpio_reg_pkg::AW-1:0], data, mask[gpio_reg_pkg::DBW-1:0]);
...
task automatic tb_reg_read_addr(
  ...
  axi_lite_read(addr[gpio_reg_pkg::AW-1:0], data);
