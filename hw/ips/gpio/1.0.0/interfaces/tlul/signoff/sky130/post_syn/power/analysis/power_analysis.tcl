...
#   Netlist       : /tmp/flexsoc-ip-release/gpio-tlul/runs/gpio/release/syn/sky130/gpio_synth.v
#   SDC           : /tmp/flexsoc-ip-release/gpio-tlul/runs/gpio/release/constraints/gpio.sdc
#   SPEF          : not used
#   VCD or SAIF   : /tmp/flexsoc-ip-release/gpio-tlul/runs/gpio/release/signoff/sky130/power/activity/ACTIVITY_REQUIRED.vcd
#   Activity scope: DUT_SCOPE_REQUIRED
#   GLS report    : /tmp/flexsoc-ip-release/gpio-tlul/runs/gpio/release/signoff/sky130/power/activity/GLS_REPORT_REQUIRED.json
#   Report dir    : /tmp/flexsoc-ip-release/gpio-tlul/runs/gpio/release/signoff/sky130/power/analysis/template_reports
#
# Limitations:
...
set report_dir {/tmp/flexsoc-ip-release/gpio-tlul/runs/gpio/release/signoff/sky130/power/analysis/template_reports}
...
set macro_liberties {}
set netlist {/tmp/flexsoc-ip-release/gpio-tlul/runs/gpio/release/syn/sky130/gpio_synth.v}
...
set activity_file {/tmp/flexsoc-ip-release/gpio-tlul/runs/gpio/release/signoff/sky130/power/activity/ACTIVITY_REQUIRED.vcd}
...
puts $fp "gls_report=/tmp/flexsoc-ip-release/gpio-tlul/runs/gpio/release/signoff/sky130/power/activity/GLS_REPORT_REQUIRED.json"
puts $fp "activity_file=/tmp/flexsoc-ip-release/gpio-tlul/runs/gpio/release/signoff/sky130/power/activity/ACTIVITY_REQUIRED.vcd"
