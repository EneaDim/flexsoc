...
#   GLS report    : not used
#   Report dir    : /tmp/flexsoc-ip-v1-release-20260914/gpio-tlul/runs/gpio/release/signoff/ihp-sg13g2/sdf/template_reports
#
# Limitations:
...
set report_dir {/tmp/flexsoc-ip-v1-release-20260914/gpio-tlul/runs/gpio/release/signoff/ihp-sg13g2/sdf/template_reports}
...
set sdf_file {/tmp/flexsoc-ip-v1-release-20260914/gpio-tlul/runs/gpio/release/signoff/ihp-sg13g2/sdf/template_reports/gpio_tt.sdf}
puts "sdf=$sdf_file"
