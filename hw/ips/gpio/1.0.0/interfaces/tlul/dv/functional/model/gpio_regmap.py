"""Generated model-side CSR map for gpio.

HJSON source(s): gpio.hjson.
Regenerate with ``fx regmap_py --force``. Behavioral code belongs in
``gpio_model.py`` and test scenarios belong in ``gpio_tests.py``.
"""
    ...
    'clk_i': RegisterDomain(
        ...
        registers=(
            Register(
                ...
                mask=0x0000000f,
                fields=(
                    Field(name='GPIO_IN', lsb=0, msb=3, swaccess='ro', hwaccess='hwo', reset=0),
                ),
            ),
            Register(
                domain='clk_i',
                ...
                mask=0x000000ff,
                fields=(
                    Field(name='GPIO_O', lsb=0, msb=3, swaccess='rw', hwaccess='hrw', reset=None),
                    Field(name='GPIO_OE', lsb=4, msb=7, swaccess='rw', hwaccess='hrw', reset=None),
                ),
            ),
            Register(
                domain='clk_i',
                ...
                mask=0x000fffff,
                fields=(
                    Field(name='EN_RISING', lsb=0, msb=3, swaccess='rw', hwaccess='hro', reset=0),
                    Field(name='EN_FALLING', lsb=4, msb=7, swaccess='rw', hwaccess='hro', reset=0),
                    Field(name='EN_LVLHIGH', lsb=8, msb=11, swaccess='rw', hwaccess='hro', reset=0),
                    Field(name='EN_LVLLOW', lsb=12, msb=15, swaccess='rw', hwaccess='hro', reset=0),
                    Field(name='EN_INPUT_FILTER', lsb=16, msb=19, swaccess='rw', hwaccess='hro', reset=0),
                ),
            ),
        ),
    ),
