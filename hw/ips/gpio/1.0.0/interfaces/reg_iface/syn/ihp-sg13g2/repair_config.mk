...
export SYNTH_NETLIST_FILES := /tmp/flexsoc-ip-v1-release-20260914/gpio-reg_iface/runs/gpio/release/syn/ihp-sg13g2/gpio_synth_raw.v
export SDC_FILE             := /tmp/flexsoc-ip-v1-release-20260914/gpio-reg_iface/runs/gpio/release/constraints/gpio.sdc
