...
export SYNTH_NETLIST_FILES := /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/syn/ihp-sg13g2/gpio_synth.v
export SDC_FILE             := /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/constraints/gpio.sdc
