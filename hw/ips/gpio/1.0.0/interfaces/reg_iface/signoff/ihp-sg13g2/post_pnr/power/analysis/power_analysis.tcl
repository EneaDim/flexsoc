...
#   Netlist       : /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/impl/ihp-sg13g2/results/ihp-sg13g2/gpio/base/6_final.v
#   SDC           : /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/constraints/gpio.sdc
#   SPEF          : /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/impl/ihp-sg13g2/results/ihp-sg13g2/gpio/base/6_final.spef
#   VCD or SAIF   : /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/post_pnr/power/activity/ACTIVITY_REQUIRED.vcd
#   Activity scope: DUT_SCOPE_REQUIRED
#   GLS report    : /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/post_pnr/power/activity/GLS_REPORT_REQUIRED.json
#   Report dir    : /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/post_pnr/power/analysis/template_reports
#
# Limitations:
...
set report_dir {/tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/post_pnr/power/analysis/template_reports}
...
set macro_liberties {}
set netlist {/tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/impl/ihp-sg13g2/results/ihp-sg13g2/gpio/base/6_final.v}
set sdc {/tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/constraints/gpio.sdc}
set spef {/tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/impl/ihp-sg13g2/results/ihp-sg13g2/gpio/base/6_final.spef}
set top {gpio}
...
set activity_file {/tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/post_pnr/power/activity/ACTIVITY_REQUIRED.vcd}
...
puts $fp "gls_report=/tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/post_pnr/power/activity/GLS_REPORT_REQUIRED.json"
puts $fp "activity_file=/tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/post_pnr/power/activity/ACTIVITY_REQUIRED.vcd"
