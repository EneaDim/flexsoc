...
#   Netlist       : /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/syn/ihp-sg13g2/gpio_synth.v
#   SDC           : /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/constraints/gpio.sdc
#   SPEF          : not used
#   VCD or SAIF   : /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/power/activity/ACTIVITY_REQUIRED.vcd
#   Activity scope: DUT_SCOPE_REQUIRED
#   GLS report    : /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/power/activity/GLS_REPORT_REQUIRED.json
#   Report dir    : /tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/power/analysis/template_reports
#
# Limitations:
...
set report_dir {/tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/power/analysis/template_reports}
...
set macro_liberties {}
set netlist {/tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/syn/ihp-sg13g2/gpio_synth.v}
...
set activity_file {/tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/power/activity/ACTIVITY_REQUIRED.vcd}
...
puts $fp "gls_report=/tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/power/activity/GLS_REPORT_REQUIRED.json"
puts $fp "activity_file=/tmp/flexsoc-ip-release/gpio-reg_iface/runs/gpio/release/signoff/ihp-sg13g2/power/activity/ACTIVITY_REQUIRED.vcd"
