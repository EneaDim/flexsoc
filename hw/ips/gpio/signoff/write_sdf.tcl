...
puts "==========================================================================="
puts ""
puts "read_verilog syn/gpio_synth.v"
puts "link_design gpio"
read_verilog syn/gpio_synth.v
link_design gpio
...
puts "==========================================================================="
puts ""
puts "read_sdc ors/gpio.sdc"
read_sdc ors/gpio.sdc
puts ""
...
puts "==========================================================================="
puts ""
puts "write_sdf -corner Typical -divider . -include_typ signoff/sdf/gpio_tt.sdf"
write_sdf -corner Typical -divider . -include_typ signoff/sdf/gpio_tt.sdf
puts "write_sdf -corner Slowest -divider . -include_typ signoff/sdf/gpio_ss.sdf"
write_sdf -corner Slowest -divider . -include_typ signoff/sdf/gpio_ss.sdf
puts "write_sdf -corner Fastest -divider . -include_typ signoff/sdf/gpio_ff.sdf"
write_sdf -corner Fastest -divider . -include_typ signoff/sdf/gpio_ff.sdf
