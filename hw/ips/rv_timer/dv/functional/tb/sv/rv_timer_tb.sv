...
module rv_timer_tb;
  ...
  `include "drivers/rv_timer_reg_driver.svh"
  `include "drivers/rv_timer_vec_monitor.svh"
  `include "drivers/rv_timer_vec_driver.svh"
    ...
    initial begin
      ...
      if (sdf_path != "") begin
        `ifdef FLEXSOC_SDF_MIN
          ...
          $sdf_annotate(sdf_path, rv_timer_tb.u_rv_timer);
