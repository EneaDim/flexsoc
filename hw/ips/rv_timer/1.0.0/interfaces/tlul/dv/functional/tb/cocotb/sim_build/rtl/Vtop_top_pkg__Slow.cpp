...
Vtop_top_pkg::Vtop_top_pkg() = default;
Vtop_top_pkg::~Vtop_top_pkg() = default;
...
void Vtop_top_pkg___configure_coverage(Vtop_top_pkg* vlSelf, bool first);

void Vtop_top_pkg::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    Vtop_top_pkg___configure_coverage(this, first);
}
...
// Coverage
void Vtop_top_pkg::__vlCoverInsert(uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
...
// Toggle Coverage
void Vtop_top_pkg::__vlCoverToggleInsert(int begin, int end, bool ranged, uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
