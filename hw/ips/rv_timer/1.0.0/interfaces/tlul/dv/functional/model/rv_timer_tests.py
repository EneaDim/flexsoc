...
def interrupt_test():
    """Exercise software interrupt injection and rw1c state clear."""

    return (
        base_config(compare=0xFFFF_FFFF, irq=1),
        [
            drive(0, 0),
            CSR.INTR_TEST0.vector_write(8, 1),
            CSR.INTR_STATE0.vector_write(28, 1),
        ],
        [
            check_irq(20, 1),
            CSR.INTR_STATE0.vector_read(20, 1),
            check_irq(40, 0),
            CSR.INTR_STATE0.vector_read(40, 0),
        ],
    )
