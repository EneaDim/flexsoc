...
(* top =  1  *)
(* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:1.8" *)
module pwm_ramp(clk_i, rst_ni, enable_i, reverse_i, step_i, lvds_i, pwm_o, adc_value_o, adc_valid_o);
  (* hdlname = "clk_i" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:5.28" *)
  input clk_i;
  wire clk_i;
  (* hdlname = "rst_ni" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:6.28" *)
  input rst_ni;
  wire rst_ni;
  (* hdlname = "enable_i" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:7.28" *)
  input enable_i;
  wire enable_i;
  (* hdlname = "reverse_i" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:8.28" *)
  input reverse_i;
  wire reverse_i;
  (* hdlname = "step_i" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:9.28" *)
  input [7:0] step_i;
  wire [7:0] step_i;
  (* hdlname = "lvds_i" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:10.28" *)
  input lvds_i;
  wire lvds_i;
  (* hdlname = "pwm_o" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:11.28" *)
  output pwm_o;
  wire pwm_o;
  (* hdlname = "adc_value_o" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:12.28" *)
  output [7:0] adc_value_o;
  wire [7:0] adc_value_o;
  (* hdlname = "adc_valid_o" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:13.28" *)
  output adc_valid_o;
  wire adc_valid_o;
  wire _000_;
  wire _001_;
  ...
  wire _167_;
  (* hdlname = "clear" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:23.9" *)
  wire clear;
  (* hdlname = "counter" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:21.21" *)
  wire [7:0] counter;
  (* hdlname = "duty_cycle" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:20.21" *)
  wire [7:0] duty_cycle;
  (* hdlname = "lvds" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:27.9" *)
  wire lvds;
  (* hdlname = "lvds_rise" *)
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:27.15" *)
  wire lvds_rise;
  (* hdlname = "u_prim_deglitch count_q" *)
  (* src = "../hw/ips/prim/prim_deglitch.sv:20.27" *)
  wire [1:0] \u_prim_deglitch.count_q ;
  (* hdlname = "u_prim_deglitch d_s" *)
  (* src = "../hw/ips/prim/prim_deglitch.sv:21.9" *)
  ...
  (* src = "../hw/ips/prim/prim_deglitch.sv:40.3" *)
  ...
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:71.3" *)
  ...
  (* src = "../workspace/runs/pwm_ramp/dev/rtl/pwm_ramp.sv:51.3" *)
