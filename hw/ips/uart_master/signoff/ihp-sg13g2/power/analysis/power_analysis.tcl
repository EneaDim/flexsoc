...
#   SPEF          : not used
#   VCD or SAIF   : /tmp/flexsoc-repack/uart_master/runs/uart_master/dev/signoff/ihp-sg13g2/power/activity/ACTIVITY_REQUIRED.vcd
#   Activity scope: DUT_SCOPE_REQUIRED
#   GLS report    : /tmp/flexsoc-repack/uart_master/runs/uart_master/dev/signoff/ihp-sg13g2/power/activity/GLS_REPORT_REQUIRED.json
#   Report dir    : /tmp/flexsoc-repack/uart_master/runs/uart_master/dev/signoff/ihp-sg13g2/power/analysis/template_reports
#
# Limitations:
...
set report_dir {/tmp/flexsoc-repack/uart_master/runs/uart_master/dev/signoff/ihp-sg13g2/power/analysis/template_reports}
...
set activity_file {/tmp/flexsoc-repack/uart_master/runs/uart_master/dev/signoff/ihp-sg13g2/power/activity/ACTIVITY_REQUIRED.vcd}
...
puts $fp "gls_report=/tmp/flexsoc-repack/uart_master/runs/uart_master/dev/signoff/ihp-sg13g2/power/activity/GLS_REPORT_REQUIRED.json"
puts $fp "activity_file=/tmp/flexsoc-repack/uart_master/runs/uart_master/dev/signoff/ihp-sg13g2/power/activity/ACTIVITY_REQUIRED.vcd"
