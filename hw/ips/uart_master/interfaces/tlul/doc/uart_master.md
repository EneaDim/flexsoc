...
|:------------------------------------------|:---------|---------:|:---------------------------|
| uart_master.[`CTRL`](#ctrl)               | 0x0      |        4 | UART control register      |
| uart_master.[`STATUS`](#status)           | 0x4      |        4 | UART live status register  |
| uart_master.[`RDATA`](#rdata)             | 0x8      |        4 | UART read data             |
| uart_master.[`WDATA`](#wdata)             | 0xc      |        4 | UART write data            |
| uart_master.[`FIFO_CTRL`](#fifo_ctrl)     | 0x10     |        4 | UART FIFO control register |
| uart_master.[`FIFO_STATUS`](#fifo_status) | 0x14     |        4 | UART FIFO status register  |
