`ifdef VERILATOR
// Auto-generated vector monitor for uart_master.
...
function automatic logic [32:0] tb_read_output(input string name);
  ...
  else if (name == "req_o") begin
    actual = req_o;
    known = 1'b1;
  end
  else if (name == "addr_o") begin
    actual = addr_o;
    known = 1'b1;
  end
  else if (name == "we_o") begin
    actual = we_o;
    known = 1'b1;
  end
  else if (name == "wdata_o") begin
    actual = wdata_o;
    known = 1'b1;
  end
  else if (name == "be_o") begin
    actual = be_o;
    known = 1'b1;
  end
