...
(
  ...
  always_comb begin
    addr_hit = '0;
    addr_hit[0] = (reg_addr == MY_IP_CTRL_OFFSET);
    addr_hit[1] = (reg_addr == MY_IP_STATUS_OFFSET);
    addr_hit[2] = (reg_addr == MY_IP_RDATA_OFFSET);
    addr_hit[3] = (reg_addr == MY_IP_WDATA_OFFSET);
  end
