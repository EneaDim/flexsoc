...
def render_hjson(top: str, itf: str) -> str:
    ...
    return templates.render(
        ...
        top=top, protocol=reggen_interface(itf),
    )
...
def write_hjson(top: str, itf: str, output: str | Path = ".", *, force: bool = False) -> Path:
    ...
    return templates.write(
        ...
        force=force, top=top, protocol=reggen_interface(itf),
    )
...
def generic_hjson(top: str, regmap: str, itf: str = "tlul") -> str:
    ...
    return templates.render(
        ...
        top=top, regmap=regmap, protocol=reggen_interface(itf),
    )
...
class RegsFlow:
    ...
    def init_hjson(
        ...
        *,
        ...
        if clocks is not None and clocks.multiclock:
            ...
            protocol = reggen_interface(interface)
            specs = (
    ...
    def flow(
        ...
        *,
        ...
        self.setup_driver(data_dir / f"{top}.hjson", driver_dir, on=on)
