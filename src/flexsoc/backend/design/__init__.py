...
class Design:
    """Own editable design scaffolds and generated design collateral."""
    ...
    def __post_init__(self) -> None:
        ...
        self.soc = SocFlow(root, self.runner)
...
__all__ = ["Design", "RegsFlow", "RtlFlow", "ModelFlow", "SocFlow", "FsmFlow"]
