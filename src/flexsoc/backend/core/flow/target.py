...
SIGNOFF_TARGETS: dict[str, Target] = {
    ...
    "signoff_post_impl.setup": Target("signoff_post_impl.setup", "setup", "post_impl"),
    ...
    "sdf_post_impl": Target("sdf_post_impl", "sdf", "post_impl", ("signoff_post_impl.setup",), quiet=True),
    "sta_post_impl": Target(
        "sta_post_impl", "sta", "post_impl", ("signoff_post_impl.setup",),
        debug="sta", show="sta_post_impl",
    ),
    "power_estimate_post_impl": Target(
        "power_estimate_post_impl", "power_estimate", "post_impl", ("signoff_post_impl.setup",),
        debug="power_estimate", show="power_estimate_post_impl",
    ),
    "power_analysis_post_impl": Target(
        "power_analysis_post_impl", "power_activity", "post_impl", ("signoff_post_impl.setup",),
        debug="power_activity", show="power_post_impl", quiet=True,
    ),
    "power_analysis_post_impl_all": Target(
        "power_analysis_post_impl_all", "power_activity_all", "post_impl", ("signoff_post_impl.setup",),
        debug="power_activity", show="power_post_impl", stream=True,
    ),
    "fusion_analysis_post_impl": Target(
        "fusion_analysis_post_impl", "fusion", "post_impl", ("signoff_post_impl.setup",),
        debug="fusion", show="fusion_post_impl", stream=True,
    ),
    "fusion_analysis_post_impl_all": Target(
        "fusion_analysis_post_impl_all", "fusion_all", "post_impl", ("signoff_post_impl.setup",),
        debug="fusion", show="fusion_post_impl", stream=True,
    ),
    "compile_post_impl": Target("compile_post_impl", "gls_compile", "post_impl", quiet=True),
    "sim_post_impl": Target("sim_post_impl", "gls", "post_impl", debug="gls", quiet=True),
    "sim_post_impl_all": Target("sim_post_impl_all", "gls_all", "post_impl", debug="gls", show="gls_post_impl", stream=True),
    "signoff_post_impl": Target(
        "signoff_post_impl", stage="post_impl", setup=("signoff_post_impl.setup",),
        sequence=(
            "sdf_post_impl", "sta_post_impl", "sim_post_impl_all",
            "power_estimate_post_impl", "power_analysis_post_impl_all",
