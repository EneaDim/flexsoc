...
from .provenance import Provenance, provenance_summary
...
STAGE_CONTRACTS: dict[str, StageContract] = {
    ...
    "sta_post_pnr": StageContract(("TOP", "PDK"), ("signoff_post_pnr.setup", "pnr"), ("signoff/{pdk}/post_pnr/sta/summary.json",), scope="pdk", tools=("OPENSTA",)),
    "power_estimate_post_pnr": StageContract(("TOP", "PDK"), ("signoff_post_pnr.setup", "pnr"), ("signoff/{pdk}/post_pnr/power/estimate/summary.json",), scope="pdk", tools=("OPENSTA",)),
    "sim_post_pnr_all": StageContract(
        ("TOP", "PDK", "GLS_BACKEND", "TIMING_MODES", "TEST_NAMES", "SDF_STRICT"),
        ("tb.setup", "pnr", "sdf_post_pnr"), ("dv/functional/sim/post_pnr/{pdk}/summary_sv.json",),
        scope="pdk", tools=("IVERILOG", "VERILATOR"),
    ),
    "power_analysis_post_pnr_all": StageContract(
        ("TOP", "PDK", "POWER_TEST_NAMES", "POWER_GLS_BACKENDS", "POWER_TIMING_MODES"),
        ("signoff_post_pnr.setup", "sim_post_pnr_all"), ("signoff/{pdk}/post_pnr/power/analysis/summary.json",),
        scope="pdk", tools=("OPENSTA",),
    ),
    "fusion_analysis_post_pnr_all": StageContract(
        ("TOP", "PDK", "POWER_TEST_NAMES", "POWER_GLS_BACKENDS", "POWER_TIMING_MODES"),
        ("power_analysis_post_pnr_all",), ("signoff/{pdk}/post_pnr/fusion/summary.json",),
        scope="pdk", tools=("OPENSTA",),
    ),
}
...
class Lifecycle:
    ...
    def tools(self, stage: str) -> dict[str, dict[str, str]]:
        ...
        if not prefixes:
            return {}
        lock = load_toolchain_lock(self.project_root)
