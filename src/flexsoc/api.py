...
TARGETS: dict[str, TargetSpec] = {
    ...
    "setup_model_multi": ("Multi-clock", "Generate multi-clock Python model scaffold", SIM),
    "tests_gen_multi": ("Multi-clock", "Generate all multi-clock vector tests from the model", SIM),
    ...
    "setup_model": ("Simulation", "Generate Python model, CSR regmap, and test scaffolds", SIM),
    "regmap_py": ("Simulation", "Regenerate only <top>_regmap.py from HJSON", SIM),
    "tests_gen": ("Simulation", "Generate all vector tests from <top>_tests.py", SIM),
