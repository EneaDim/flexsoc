...
VL_ATTR_COLD void Vspi_host_tb___024unit___ctor_var_reset(Vspi_host_tb___024unit* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vspi_host_tb___024unit___ctor_var_reset\n"); );
