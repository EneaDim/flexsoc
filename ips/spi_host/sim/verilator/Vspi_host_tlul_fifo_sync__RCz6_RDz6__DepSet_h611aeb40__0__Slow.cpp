...
VL_ATTR_COLD void Vspi_host_tlul_fifo_sync__RCz6_RDz6___ctor_var_reset(Vspi_host_tlul_fifo_sync__RCz6_RDz6* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vspi_host_tlul_fifo_sync__RCz6_RDz6___ctor_var_reset\n"); );
