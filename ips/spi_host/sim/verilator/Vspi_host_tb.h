...
#ifndef VERILATED_VSPI_HOST_TB_H_
#define VERILATED_VSPI_HOST_TB_H_  // guard

#include "verilated.h"
#include "svdpi.h"

class Vspi_host_tb__Syms;
class Vspi_host_tb___024root;
class VerilatedVcdC;
...
class alignas(VL_CACHE_LINE_BYTES) Vspi_host_tb VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vspi_host_tb_spi_host_tb* const spi_host_tb;
    Vspi_host_tb___024unit* const __PVT____024unit;
    Vspi_host_tb_spi_host_reg_pkg* const __PVT__spi_host_reg_pkg;
    Vspi_host_tb_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_1n__DOT__gen_dfifo__BRA__0__KET____DOT__fifo_d;
    Vspi_host_tb_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_1n__DOT__gen_dfifo__BRA__1__KET____DOT__fifo_d;
    Vspi_host_tb_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_1n__DOT__gen_dfifo__BRA__2__KET____DOT__fifo_d;
    Vspi_host_tb_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_1n__DOT__gen_dfifo__BRA__3__KET____DOT__fifo_d;
    Vspi_host_tb_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_m1__DOT__gen_host_fifo__BRA__0__KET____DOT__u_hostfifo;
    Vspi_host_tb_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_m1__DOT__gen_host_fifo__BRA__1__KET____DOT__u_hostfifo;
    Vspi_host_tb_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_m1__DOT__gen_host_fifo__BRA__2__KET____DOT__u_hostfifo;
    Vspi_host_tb_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_m1__DOT__gen_host_fifo__BRA__3__KET____DOT__u_hostfifo;
    Vspi_host_tb___024unit__03a__03atlul_utils__Vclpkg* const __024unit__03a__03atlul_utils__Vclpkg;

    // Root instance pointer to allow access to model internals,
    // including inlined /* verilator public_flat_* */ items.
    Vspi_host_tb___024root* const rootp;
    ...
    explicit Vspi_host_tb(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vspi_host_tb(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vspi_host_tb();
  private:
    VL_UNCOPYABLE(Vspi_host_tb);  ///< Copying not allowed
