...
#ifndef VERILATED_VSPI_HOST_TB_TLUL_FIFO_SYNC__RCZ6_RDZ6_H_
#define VERILATED_VSPI_HOST_TB_TLUL_FIFO_SYNC__RCZ6_RDZ6_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vspi_host_tb_tlul_fifo_sync__RCz6_RDz6 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vspi_host_tb_tlul_fifo_sync__RCz6_RDz6(Vspi_host_tb__Syms* symsp, const char* v__name);
    ~Vspi_host_tb_tlul_fifo_sync__RCz6_RDz6();
    VL_UNCOPYABLE(Vspi_host_tb_tlul_fifo_sync__RCz6_RDz6);
