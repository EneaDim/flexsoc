...
package gpio_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    gpio_reg2hw_intr_state_reg_t intr_state; // [68:65]
    gpio_reg2hw_intr_enable_reg_t intr_enable; // [64:61]
    gpio_reg2hw_intr_test_reg_t intr_test; // [60:56]
    gpio_reg2hw_alert_test_reg_t alert_test; // [55:54]
  ...
  parameter logic [3:0] GPIO_PERMIT [16] = '{
    ...
    4'b 0001, // index[ 4] GPIO_DATA_IN
    4'b 0001, // index[ 5] GPIO_DIRECT_OUT
    4'b 0001, // index[ 6] GPIO_MASKED_OUT_LOWER
    4'b 0001, // index[ 7] GPIO_MASKED_OUT_UPPER
    4'b 0001, // index[ 8] GPIO_DIRECT_OE
    4'b 0001, // index[ 9] GPIO_MASKED_OE_LOWER
    4'b 0001, // index[10] GPIO_MASKED_OE_UPPER
    4'b 0001, // index[11] GPIO_INTR_CTRL_EN_RISING
    4'b 0001, // index[12] GPIO_INTR_CTRL_EN_FALLING
    4'b 0001, // index[13] GPIO_INTR_CTRL_EN_LVLHIGH
    4'b 0001, // index[14] GPIO_INTR_CTRL_EN_LVLLOW
    4'b 0001  // index[15] GPIO_CTRL_EN_INPUT_FILTER
  };
