...
module xbar_main (
  ...
  // Host interfaces
  input  tlul_pkg::tl_h2d_t tl_uart_host_i,
  output tlul_pkg::tl_d2h_t tl_uart_host_o,
  ...
  tl_h2d_t tl_s1n_5_ds_h2d [3];
  tl_d2h_t tl_s1n_5_ds_d2h [3];

  // Create steering signal
  logic [1:0] dev_sel_s1n_5;
  ...
  assign tl_pwm_o = tl_s1n_5_ds_h2d[1];
  assign tl_s1n_5_ds_d2h[1] = tl_pwm_i;

  assign tl_spi_host_o = tl_s1n_5_ds_h2d[2];
  assign tl_s1n_5_ds_d2h[2] = tl_spi_host_i;

  assign tl_s1n_5_us_h2d = tl_uart_host_i;
  assign tl_uart_host_o = tl_s1n_5_us_d2h;
