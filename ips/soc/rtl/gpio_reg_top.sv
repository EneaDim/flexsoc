...
(
  ...
  logic direct_out_re;
  logic direct_out_we;
  logic [3:0] direct_out_qs;
  logic [3:0] direct_out_wd;
  logic masked_out_lower_re;
  logic masked_out_lower_we;
  logic [1:0] masked_out_lower_data_qs;
  logic [1:0] masked_out_lower_data_wd;
  logic [1:0] masked_out_lower_mask_wd;
  logic masked_out_upper_re;
  logic masked_out_upper_we;
  logic [1:0] masked_out_upper_data_qs;
  logic [1:0] masked_out_upper_data_wd;
  logic [1:0] masked_out_upper_mask_wd;
  logic direct_oe_re;
  logic direct_oe_we;
  logic [3:0] direct_oe_qs;
  logic [3:0] direct_oe_wd;
  logic masked_oe_lower_re;
  logic masked_oe_lower_we;
  logic [1:0] masked_oe_lower_data_qs;
  logic [1:0] masked_oe_lower_data_wd;
  logic [1:0] masked_oe_lower_mask_qs;
  logic [1:0] masked_oe_lower_mask_wd;
  logic masked_oe_upper_re;
  logic masked_oe_upper_we;
  logic [1:0] masked_oe_upper_data_qs;
  logic [1:0] masked_oe_upper_data_wd;
  logic [1:0] masked_oe_upper_mask_qs;
  logic [1:0] masked_oe_upper_mask_wd;
  ...
  assign intr_ctrl_en_falling_wd = reg_wdata[3:0];
  assign intr_ctrl_en_lvlhigh_we = addr_hit[13] & reg_we & !reg_error;

  assign intr_ctrl_en_lvlhigh_wd = reg_wdata[3:0];
  assign intr_ctrl_en_lvllow_we = addr_hit[14] & reg_we & !reg_error;

  assign intr_ctrl_en_lvllow_wd = reg_wdata[3:0];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[5]: begin
        reg_rdata_next[3:0] = direct_out_qs;
      end

      addr_hit[6]: begin
        reg_rdata_next[1:0] = masked_out_lower_data_qs;
        reg_rdata_next[3:2] = '0;
      end

      addr_hit[7]: begin
        reg_rdata_next[1:0] = masked_out_upper_data_qs;
        reg_rdata_next[3:2] = '0;
      end

      addr_hit[8]: begin
        reg_rdata_next[3:0] = direct_oe_qs;
      end

      addr_hit[9]: begin
        reg_rdata_next[1:0] = masked_oe_lower_data_qs;
        reg_rdata_next[3:2] = masked_oe_lower_mask_qs;
      end

      addr_hit[10]: begin
        reg_rdata_next[1:0] = masked_oe_upper_data_qs;
        reg_rdata_next[3:2] = masked_oe_upper_mask_qs;
      end
      ...
      addr_hit[12]: begin
        reg_rdata_next[3:0] = intr_ctrl_en_falling_qs;
      end

      addr_hit[13]: begin
        reg_rdata_next[3:0] = intr_ctrl_en_lvlhigh_qs;
      end

      addr_hit[14]: begin
        reg_rdata_next[3:0] = intr_ctrl_en_lvllow_qs;
      end
