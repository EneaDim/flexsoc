...
puts "==========================================================================="
puts ""
puts "read_verilog syn/soc_synth.v"
puts "link_design soc"
read_verilog syn/soc_synth.v
link_design soc
puts ""
puts "==========================================================================="
puts "Read SDC"
puts "==========================================================================="
puts ""
puts "read_sdc ors/soc.sdc"
read_sdc ors/soc.sdc
puts ""
puts "==========================================================================="
puts "Write SDF files for each corner"
puts "==========================================================================="
puts ""
puts "write_sdf -corner Typical -divider . -include_typ signoff/sdf/soc_tt.sdf"
puts "write_sdf -corner Slowest -divider . -include_typ signoff/sdf/soc_ss.sdf"
puts "write_sdf -corner Fastest -divider . -include_typ signoff/sdf/soc_ff.sdf"
puts ""
write_sdf -corner Typical -divider . -include_typ signoff/sdf/soc_tt.sdf
write_sdf -corner Slowest -divider . -include_typ signoff/sdf/soc_ss.sdf
write_sdf -corner Fastest -divider . -include_typ signoff/sdf/soc_ff.sdf
