...
package gpio_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    gpio_reg2hw_intr_state_reg_t intr_state; // [38:37]
    gpio_reg2hw_intr_enable_reg_t intr_enable; // [36:35]
    gpio_reg2hw_intr_test_reg_t intr_test; // [34:32]
    gpio_reg2hw_direct_out_reg_t direct_out; // [31:29]
    gpio_reg2hw_masked_out_lower_reg_t masked_out_lower; // [28:25]
    gpio_reg2hw_masked_out_upper_reg_t masked_out_upper; // [24:21]
    gpio_reg2hw_direct_oe_reg_t direct_oe; // [20:18]
    gpio_reg2hw_masked_oe_lower_reg_t masked_oe_lower; // [17:14]
    gpio_reg2hw_masked_oe_upper_reg_t masked_oe_upper; // [13:10]
    gpio_reg2hw_intr_ctrl_en_rising_reg_t intr_ctrl_en_rising; // [9:8]
    gpio_reg2hw_intr_ctrl_en_falling_reg_t intr_ctrl_en_falling; // [7:6]
    gpio_reg2hw_intr_ctrl_en_lvlhigh_reg_t intr_ctrl_en_lvlhigh; // [5:4]
    gpio_reg2hw_intr_ctrl_en_lvllow_reg_t intr_ctrl_en_lvllow; // [3:2]
    gpio_reg2hw_ctrl_en_input_filter_reg_t ctrl_en_input_filter; // [1:0]
  } gpio_reg2hw_t;

  // HW -> register type
  typedef struct packed {
    gpio_hw2reg_intr_state_reg_t intr_state; // [17:15]
    gpio_hw2reg_data_in_reg_t data_in; // [14:12]
    gpio_hw2reg_direct_out_reg_t direct_out; // [11:10]
    gpio_hw2reg_masked_out_lower_reg_t masked_out_lower; // [9:8]
    gpio_hw2reg_masked_out_upper_reg_t masked_out_upper; // [7:6]
    gpio_hw2reg_direct_oe_reg_t direct_oe; // [5:4]
    gpio_hw2reg_masked_oe_lower_reg_t masked_oe_lower; // [3:2]
    gpio_hw2reg_masked_oe_upper_reg_t masked_oe_upper; // [1:0]
  } gpio_hw2reg_t;
  ...
  parameter logic [1:0] GPIO_DIRECT_OUT_RESVAL = 2'h 0;
  parameter logic [1:0] GPIO_MASKED_OUT_LOWER_RESVAL = 2'h 0;
  parameter logic [1:0] GPIO_MASKED_OUT_UPPER_RESVAL = 2'h 0;
  parameter logic [1:0] GPIO_DIRECT_OE_RESVAL = 2'h 0;
  parameter logic [1:0] GPIO_MASKED_OE_LOWER_RESVAL = 2'h 0;
  parameter logic [1:0] GPIO_MASKED_OE_UPPER_RESVAL = 2'h 0;
