...
(
  ...
  always_comb begin
    ...
    addr_hit[1] = (reg_addr == RV_TIMER_INTR_ENABLE0_OFFSET);
  ...
  assign intr_state0_we = addr_hit[2] & reg_we & !reg_error;

  assign intr_state0_wd = reg_wdata[0];
  assign intr_test0_we = addr_hit[3] & reg_we & !reg_error;

  assign intr_test0_wd = reg_wdata[0];
  assign cfg0_we = addr_hit[4] & reg_we & !reg_error;
