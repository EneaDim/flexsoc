...
| pwm.[`RAMP`](#ramp)           | 0xc      |        4 | Configuration register                |
| pwm.[`ADC_VALUE`](#adc_value) | 0x10     |        4 | ADC value                             |
...
```wavejson
{"reg": [{"name": "PWM_RAMP_EN", "bits": 1, "attr": ["rw"], "rotate": -90}, {"name": "PWM_RAMP_STEP", "bits": 3, "attr": ["rw"], "rotate": -90}, {"bits": 28}], "config": {"lanes": 1, "fontsize": 10, "vspace": 150}}
```

|  Bits  |  Type  |  Reset  | Name          | Description             |
|:------:|:------:|:-------:|:--------------|:------------------------|
|  31:4  |        |         |               | Reserved                |
|  3:1   |   rw   |   0x1   | PWM_RAMP_STEP | Ramp step.              |
|   0    |   rw   |   0x0   | PWM_RAMP_EN   | Ramp generation enable. |
...
```wavejson
{"reg": [{"name": "ADC_VALUE", "bits": 8, "attr": ["ro"], "rotate": 0}, {"bits": 24}], "config": {"lanes": 1, "fontsize": 10, "vspace": 80}}
```

|  Bits  |  Type  |  Reset  | Name      | Description   |
|:------:|:------:|:-------:|:----------|:--------------|
|  31:8  |        |         |           | Reserved      |
|  7:0   |   ro   |   0x0   | ADC_VALUE | ADC value     |
