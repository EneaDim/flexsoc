...
module soc_tb;
  ...
  localparam logic [31:0] PWM_RAMP_CFG  = 32'h0000_000C;  // Blink/heartbeat parametri
  localparam logic [31:0] PWM_RAMP_VAL  = 32'h0000_0010;  // Blink/heartbeat parametri
  //////////////////////////////////////////////////////////////////////////////////////////
  ...
  initial begin
    ...
    uart_write32(PWM_BASE + PWM_RAMP_CFG,  32'h00000003);
    #(CLK_PERIOD*2000);
    drive_sine_wave(0.3, 0.5, 1_000.0, 3000.0, 10.0);   // 1 kHz sine, 3 ms duration, 10 ns step 
    #(CLK_PERIOD*2000);
    uart_read32(PWM_BASE + PWM_RAMP_VAL);
    #(CLK_PERIOD*2000);
