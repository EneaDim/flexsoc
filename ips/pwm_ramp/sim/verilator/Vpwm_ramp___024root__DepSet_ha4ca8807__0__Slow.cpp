...
VL_ATTR_COLD void Vpwm_ramp___024root___eval_triggers__stl(Vpwm_ramp___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpwm_ramp___024root___eval_triggers__stl\n"); );
...
VL_ATTR_COLD void Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_1n__DOT__gen_dfifo__BRA__0__KET____DOT__fifo_d__0(Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* vlSelf);
VL_ATTR_COLD void Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_1n__DOT__gen_dfifo__BRA__1__KET____DOT__fifo_d__0(Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* vlSelf);
VL_ATTR_COLD void Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_1n__DOT__gen_dfifo__BRA__2__KET____DOT__fifo_d__0(Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* vlSelf);
VL_ATTR_COLD void Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_1n__DOT__gen_dfifo__BRA__3__KET____DOT__fifo_d__0(Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* vlSelf);
VL_ATTR_COLD void Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_m1__DOT__gen_host_fifo__BRA__0__KET____DOT__u_hostfifo__0(Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* vlSelf);
VL_ATTR_COLD void Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_m1__DOT__gen_host_fifo__BRA__1__KET____DOT__u_hostfifo__0(Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* vlSelf);
VL_ATTR_COLD void Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_m1__DOT__gen_host_fifo__BRA__2__KET____DOT__u_hostfifo__0(Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* vlSelf);
VL_ATTR_COLD void Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_m1__DOT__gen_host_fifo__BRA__3__KET____DOT__u_hostfifo__0(Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* vlSelf);
VL_ATTR_COLD void Vpwm_ramp___024root___stl_sequent__TOP__1(Vpwm_ramp___024root* vlSelf);
...
VL_ATTR_COLD void Vpwm_ramp___024root___eval_stl(Vpwm_ramp___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpwm_ramp___024root___eval_stl\n"); );
    Vpwm_ramp__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vpwm_ramp___024root___stl_sequent__TOP__0(vlSelf);
        Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_1n__DOT__gen_dfifo__BRA__0__KET____DOT__fifo_d__0((&vlSymsp->TOP__tlul_socket_1n__DOT__gen_dfifo__BRA__0__KET____DOT__fifo_d));
        Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_1n__DOT__gen_dfifo__BRA__1__KET____DOT__fifo_d__0((&vlSymsp->TOP__tlul_socket_1n__DOT__gen_dfifo__BRA__1__KET____DOT__fifo_d));
        Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_1n__DOT__gen_dfifo__BRA__2__KET____DOT__fifo_d__0((&vlSymsp->TOP__tlul_socket_1n__DOT__gen_dfifo__BRA__2__KET____DOT__fifo_d));
        Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_1n__DOT__gen_dfifo__BRA__3__KET____DOT__fifo_d__0((&vlSymsp->TOP__tlul_socket_1n__DOT__gen_dfifo__BRA__3__KET____DOT__fifo_d));
        Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_m1__DOT__gen_host_fifo__BRA__0__KET____DOT__u_hostfifo__0((&vlSymsp->TOP__tlul_socket_m1__DOT__gen_host_fifo__BRA__0__KET____DOT__u_hostfifo));
        Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_m1__DOT__gen_host_fifo__BRA__1__KET____DOT__u_hostfifo__0((&vlSymsp->TOP__tlul_socket_m1__DOT__gen_host_fifo__BRA__1__KET____DOT__u_hostfifo));
        Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_m1__DOT__gen_host_fifo__BRA__2__KET____DOT__u_hostfifo__0((&vlSymsp->TOP__tlul_socket_m1__DOT__gen_host_fifo__BRA__2__KET____DOT__u_hostfifo));
        Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6___stl_sequent__TOP__tlul_socket_m1__DOT__gen_host_fifo__BRA__3__KET____DOT__u_hostfifo__0((&vlSymsp->TOP__tlul_socket_m1__DOT__gen_host_fifo__BRA__3__KET____DOT__u_hostfifo));
        Vpwm_ramp___024root___stl_sequent__TOP__1(vlSelf);
...
VL_ATTR_COLD void Vpwm_ramp___024root___stl_sequent__TOP__1(Vpwm_ramp___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpwm_ramp___024root___stl_sequent__TOP__1\n"); );
    Vpwm_ramp__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
