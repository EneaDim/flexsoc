...
#ifndef VERILATED_VPWM_RAMP_H_
#define VERILATED_VPWM_RAMP_H_  // guard

#include "verilated.h"

class Vpwm_ramp__Syms;
class Vpwm_ramp___024root;
class Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6;


// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vpwm_ramp VL_NOT_FINAL : public VerilatedModel {
  private:
    // Symbol table holding complete model state (owned by this class)
    Vpwm_ramp__Syms* const vlSymsp;
  ...
  public:
    ...
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_1n__DOT__gen_dfifo__BRA__0__KET____DOT__fifo_d;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_1n__DOT__gen_dfifo__BRA__1__KET____DOT__fifo_d;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_1n__DOT__gen_dfifo__BRA__2__KET____DOT__fifo_d;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_1n__DOT__gen_dfifo__BRA__3__KET____DOT__fifo_d;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_m1__DOT__gen_host_fifo__BRA__0__KET____DOT__u_hostfifo;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_m1__DOT__gen_host_fifo__BRA__1__KET____DOT__u_hostfifo;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_m1__DOT__gen_host_fifo__BRA__2__KET____DOT__u_hostfifo;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* const __PVT__tlul_socket_m1__DOT__gen_host_fifo__BRA__3__KET____DOT__u_hostfifo;

    // Root instance pointer to allow access to model internals,
    // including inlined /* verilator public_flat_* */ items.
    Vpwm_ramp___024root* const rootp;
    ...
    explicit Vpwm_ramp(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vpwm_ramp(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vpwm_ramp();
  private:
    VL_UNCOPYABLE(Vpwm_ramp);  ///< Copying not allowed
