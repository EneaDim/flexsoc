...
#ifndef VERILATED_VPWM_RAMP_TLUL_FIFO_SYNC__RCZ6_RDZ6_H_
#define VERILATED_VPWM_RAMP_TLUL_FIFO_SYNC__RCZ6_RDZ6_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6(Vpwm_ramp__Syms* symsp, const char* v__name);
    ~Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6();
    VL_UNCOPYABLE(Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6);
