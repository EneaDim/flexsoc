...
#ifndef VERILATED_VPWM_RAMP___024ROOT_H_
#define VERILATED_VPWM_RAMP___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vpwm_ramp___024root final : public VerilatedModule {
  public:
    // CELLS
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* __PVT__tlul_socket_1n__DOT__gen_dfifo__BRA__0__KET____DOT__fifo_d;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* __PVT__tlul_socket_1n__DOT__gen_dfifo__BRA__1__KET____DOT__fifo_d;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* __PVT__tlul_socket_1n__DOT__gen_dfifo__BRA__2__KET____DOT__fifo_d;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* __PVT__tlul_socket_1n__DOT__gen_dfifo__BRA__3__KET____DOT__fifo_d;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* __PVT__tlul_socket_m1__DOT__gen_host_fifo__BRA__0__KET____DOT__u_hostfifo;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* __PVT__tlul_socket_m1__DOT__gen_host_fifo__BRA__1__KET____DOT__u_hostfifo;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* __PVT__tlul_socket_m1__DOT__gen_host_fifo__BRA__2__KET____DOT__u_hostfifo;
    Vpwm_ramp_tlul_fifo_sync__RCz6_RDz6* __PVT__tlul_socket_m1__DOT__gen_host_fifo__BRA__3__KET____DOT__u_hostfifo;
    ...
    // CONSTRUCTORS
    Vpwm_ramp___024root(Vpwm_ramp__Syms* symsp, const char* v__name);
    ~Vpwm_ramp___024root();
    VL_UNCOPYABLE(Vpwm_ramp___024root);
